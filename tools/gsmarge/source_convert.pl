...
@GS_TO_WB_REPLACE	= (
	...
	[ "pokemon_gs/include/common.h", "gflib/include/ui.h" ],
	[ "pokemon_gs/include/system/keytouch_status.h", "gflib/include/ui.h" ],
	...
	["APP_END_KEY","GFL_APP_END_KEY"],
	["APP_END_TOUCH","GFL_APP_END_TOUCH"],
	["APP_KTST_KEY","GFL_APP_KTST_KEY"],
	["APP_KTST_TOUCH","GFL_APP_KTST_TOUCH"],
	["PAD_BUTTON_KTST_CHG","GFL_PAD_BUTTON_KTST_CHG"],
	["extern int  KeyTouchStatus_CheckTouchOrKey(KEYTOUCH_STATUS * kt_status);", "extern int  GFL_UI_CheckTouchOrKey(void);"],
	["extern void KeyTouchStatus_SetTouchOrKey(KEYTOUCH_STATUS * kt_status, int param);","extern void GFL_UI_SetTouchOrKey(int param);"],
	["extern STRBUF* STRBUF_Create( u32 size, u32 heapID );","extern STRBUF* GFL_STR_CreateBuffer( u32 size, HEAPID heapID );"],
	["extern void STRBUF_Delete( STRBUF* strbuf );","extern void GFL_STR_DeleteBuffer( STRBUF* strbuf );"],
	["extern void STRBUF_Clear( STRBUF* strbuf );","extern void GFL_STR_ClearBuffer( STRBUF* strbuf );"],
	["extern void STRBUF_Copy( STRBUF* dst, const STRBUF* src );","extern void GFL_STR_CopyBuffer( STRBUF* dst, const STRBUF* src );"],
	["extern STRBUF* STRBUF_CreateBufferCopy( const STRBUF* origin, u32 heapID );","extern STRBUF* GFL_STR_CreateCopyBuffer( const STRBUF* origin, HEAPID heapID );"],
	["extern int STRBUF_Compare( const STRBUF* str1, const STRBUF* str2 );","extern BOOL GFL_STR_CompareBuffer( const STRBUF* str1, const STRBUF* str2 );"],
	["extern u32 STRBUF_GetLen( const STRBUF* strbuf );","extern u32 GFL_STR_GetBufferLength( const STRBUF* str );"],
	["NUMBER_DISPTYPE","StrNumberDispType"],
	["NUMBER_DISPTYPE_LEFT","STR_NUM_DISP_LEFT"],
	["NUMBER_DISPTYPE_SPACE","STR_NUM_DISP_SPACE"],
	["NUMBER_DISPTYPE_ZERO","STR_NUM_DISP_ZERO"],
	["NUMBER_CODETYPE","StrNumberCodeType"],
	["NUMBER_CODETYPE_ZENKAKU","STR_NUM_CODE_ZENKAKU"],
	["NUMBER_CODETYPE_HANKAKU","STR_NUM_CODE_HANKAKU"],
	["NUMBER_CODETYPE_DEFAULT","STR_NUM_CODE_DEFAULT"],
	["extern void STRBUF_SetNumber( STRBUF* dst, int number, u32 keta, NUMBER_DISPTYPE dispType, NUMBER_CODETYPE codeType );","extern void STRTOOL_SetNumber( STRBUF* dst, int number, u32 keta, StrNumberDispType dispType, StrNumberCodeType codeType );"],
	["GF_BGL_MAIN_DISP","GFL_BG_MAIN_DISP"],
	["GF_BGL_SUB_DISP","GFL_BG_SUB_DISP"],
	["GF_BGL_MODE_TEXT","GFL_BG_MODE_TEXT"],
	["GF_BGL_MODE_AFFINE","GFL_BG_MODE_AFFINE"],
	["GF_BGL_MODE_256X16","GFL_BG_MODE_256X16"],
	["GF_BGL_FRAME0_M","GFL_BG_FRAME0_M"],
	["GF_BGL_FRAME1_M","GFL_BG_FRAME1_M"],
	["GF_BGL_FRAME2_M","GFL_BG_FRAME2_M"],
	["GF_BGL_FRAME3_M","GFL_BG_FRAME3_M"],
	["GF_BGL_FRAME0_S","GFL_BG_FRAME0_S"],
	["GF_BGL_FRAME1_S","GFL_BG_FRAME1_S"],
	["GF_BGL_FRAME2_S","GFL_BG_FRAME2_S"],
	["GF_BGL_FRAME3_S","GFL_BG_FRAME3_S"],
	["GF_BGL_SCRSIZ_128x128","GFL_BG_SCRSIZ_128x128"],
	["GF_BGL_SCRSIZ_256x256","GFL_BG_SCRSIZ_256x256"],
	["GF_BGL_SCRSIZ_256x512","GFL_BG_SCRSIZ_256x512"],
	["GF_BGL_SCRSIZ_512x256","GFL_BG_SCRSIZ_512x256"],
	["GF_BGL_SCRSIZ_512x512","GFL_BG_SCRSIZ_512x512"],
	["GF_BGL_SCRSIZ_1024x1024","GFL_BG_SCRSIZ_1024x1024"],
	["GF_BGL_DATA_LZH","GFL_BG_DATA_LZH"],
	["GF_BGL_SCROLL_X_SET","GFL_BG_SCROLL_X_SET"],
	["GF_BGL_SCROLL_X_INC","GFL_BG_SCROLL_X_INC"],
	["GF_BGL_SCROLL_X_DEC","GFL_BG_SCROLL_X_DEC"],
	["GF_BGL_SCROLL_Y_SET","GFL_BG_SCROLL_Y_SET"],
	["GF_BGL_SCROLL_Y_INC","GFL_BG_SCROLL_Y_INC"],
	["GF_BGL_SCROLL_Y_DEC","GFL_BG_SCROLL_Y_DEC"],
	["GF_BGL_RADION_SET","GFL_BG_RADION_SET"],
	["GF_BGL_RADION_INC","GFL_BG_RADION_INC"],
	["GF_BGL_RADION_DEC","GFL_BG_RADION_DEC"],
	["GF_BGL_SCALE_X_SET","GFL_BG_SCALE_X_SET"],
	["GF_BGL_SCALE_X_INC","GFL_BG_SCALE_X_INC"],
	["GF_BGL_SCALE_X_DEC","GFL_BG_SCALE_X_DEC"],
	["GF_BGL_SCALE_Y_SET","GFL_BG_SCALE_Y_SET"],
	["GF_BGL_SCALE_Y_INC","GFL_BG_SCALE_Y_INC"],
	["GF_BGL_SCALE_Y_DEC","GFL_BG_SCALE_Y_DEC"],
	["GF_BGL_CENTER_X_SET","GFL_BG_CENTER_X_SET"],
	["GF_BGL_CENTER_X_INC","GFL_BG_CENTER_X_INC"],
	["GF_BGL_CENTER_X_DEC","GFL_BG_CENTER_X_DEC"],
	["GF_BGL_CENTER_Y_SET","GFL_BG_CENTER_Y_SET"],
	["GF_BGL_CENTER_Y_INC","GFL_BG_CENTER_Y_INC"],
	["GF_BGL_CENTER_Y_DEC","GFL_BG_CENTER_Y_DEC"],
	["GF_BGL_SCRWRT_PALNL","GFL_BG_SCRWRT_PALNL"],
	["GF_BGL_SCRWRT_PALIN","GFL_BG_SCRWRT_PALIN"],
	["GF_BGL_MODE_1DBUF","GFL_BG_MODE_1DBUF"],
	["GF_BGL_MODE_2DBUF","GFL_BG_MODE_2DBUF"],
	["BmpTalkWinClear","BmpWinFrame_Clear"],
	["BmpTalkWinWrite","BmpWinFrame_Write"],
	["MSGMAN_TYPE","GflMsgLoadType"],
	["MSGMAN_TYPE_NORMAL","GFL_MSG_LOAD_FAST"],
	["MSGMAN_TYPE_DIRECT","GFL_MSG_LOAD_NORMAL"],
	["MSGDATA_MANAGER","GFL_MSGDATA"],
	["extern MSGDATA_MANAGER*  MSGMAN_Create( MSGMAN_TYPE type, u32 arcID, u32 datID, u32 heapID );","extern GFL_MSGDATA* GFL_MSG_Create( GflMsgLoadType loadType, u16 ArcID, u16 datID, HEAPID heapID );"],
	["extern void MSGMAN_Delete( MSGDATA_MANAGER* man );","extern void GFL_MSG_Delete( GFL_MSGDATA* handle );"],
	["extern void MSGMAN_GetString( const MSGDATA_MANAGER* man, u32 strID, STRBUF* dst );","extern void GFL_MSG_GetString( const GFL_MSGDATA* handle, u32 strID, STRBUF* dst );"],
	["extern	STRBUF* MSGMAN_AllocString( const MSGDATA_MANAGER* man, u32 strID );","extern STRBUF* GFL_MSG_CreateString( const GFL_MSGDATA* handle, u32 strID );"],
	["extern u32 MSGMAN_GetMessageCount( const MSGDATA_MANAGER* man );","extern u32 GFL_MSG_GetStrCount( const GFL_MSGDATA* handle );"],
);
