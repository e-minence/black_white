...
del we_000.bin
ruby c:\home\pokemon_wb\resource\musical\script\eescmk.rb c:\home\pokemon_wb\prog\src\musical\stage\script\musical_script_command.h we_test.esf c:/home/pokemon_wb/ we_ on
