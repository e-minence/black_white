...
#データテーブル
  ...
  read_data.size.times {|i|
    ...
    if other_form == 1
      ...
      if split_data[ PARA::FORM_NAME ] == ""
	    ...
	    fp_gra.printf( "\"pfwb_%s%s_m.NCGR\"\n",   split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%s%s_f.NCGR\"\n",   split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%sc%s_m.NCBR\"\n",  split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%sc%s_f.NCBR\"\n",  split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%s%s.NCER\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%s%s.NANR\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%s%s.NMCR\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%s%s.NMAR\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pfwb_%s%s.NCEC\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%s%s_m.NCGR\"\n",   split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%s%s_f.NCGR\"\n",   split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%sc%s_m.NCBR\"\n",  split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%sc%s_f.NCBR\"\n",  split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%s%s.NCER\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%s%s.NANR\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%s%s.NMCR\"\n",     split_data[ PARA::GRA_NO ], form_name )
	    fp_gra.printf( "\"pbwb_%s%s.NMAR\"\n",     split_data[ PARA::GRA_NO ], form_name )
  ...
  #タマゴは独自の持ち方をする
  fp_gra.print( "\"pmwb_egg_normal.NCGR\"\n" )
	fp_gra.print( "\"pmwb_eggc_normal.NCBR\"\n" )
	fp_gra.print( "\"pmwb_egg_normal.NCER\"\n" )
	fp_gra.print( "\"pmwb_egg_normal.NANR\"\n" )
  ...
  fp_gra.print( "\"pmwb_egg_manafi.NCGR\"\n" )
	...
	fp_gra.print( "\"pmwb_egg_manafi.NANR\"\n" )
  ...
  fp_monsno.print( "//MAKEを通すために旧名称定義も暫定でいれておく" )
  fp_monsno.print( "#define		MONSNO_PINBOO				( 494 )\n" )
  fp_monsno.print( "#define		MONSNO_MOGURYUU			( 495 )\n" )
  fp_monsno.print( "#define		MONSNO_GORIDARUMA		( 496 )\n" )
  fp_monsno.print( "#define		MONSNO_WANIGURASU		( 497 )\n" )
  fp_monsno.print( "#define		MONSNO_SANDAIRU			( 498 )\n" )
  fp_monsno.print( "#define		MONSNO_REIBAAN			( 499 )\n" )
  fp_monsno.print( "#define		MONSNO_KURUMIRU			( 500 )\n" )
  fp_monsno.print( "#define		MONSNO_HAHAKOMORI		( 501 )\n" )
  fp_monsno.print( "#define		MONSNO_ONOKKUSU			( 502 )\n" )
  fp_monsno.print( "#define		MONSNO_KAAMENTO			( 503 )\n" )
  fp_monsno.print( "#define		MONSNO_BANBIINA			( 504 )\n" )
  fp_monsno.print( "#define		MONSNO_KENHOROU			( 505 )\n" )
  fp_monsno.print( "#define		MONSNO_PURUNSU			( 506 )\n" )
  fp_monsno.print( "#define		MONSNO_MAMEPATO			( 507 )\n" )
  fp_monsno.print( "#define		MONSNO_RAIBURA			( 508 )\n" )
  fp_monsno.print( "#define		MONSNO_YUMEBAKURA		( 509 )\n" )
  fp_monsno.print( "#define		MONSNO_TYURINE			( 510 )\n" )
  fp_monsno.print( "#define		MONSNO_HATOOBOO			( 511 )\n" )
  fp_monsno.print( "#define		MONSNO_DOREDHIA			( 512 )\n" )
  fp_monsno.print( "#define		MONSNO_MOKOUMORI		( 513 )\n" )
  fp_monsno.print( "#define		MONSNO_MOKOTTO			( 514 )\n" )
  fp_monsno.print( "#define		MONSNO_MERIKOTTO		( 515 )\n" )
  fp_monsno.print( "#define		MONSNO_SABOTTEN			( 516 )\n" )
  fp_monsno.print( "#define		MONSNO_KURUMAYU			( 517 )\n" )
  fp_monsno.print( "#define		MONSNO_GUROKKEN			( 518 )\n" )
  fp_monsno.print( "#define		MONSNO_KAAOKEN			( 519 )\n" )
  fp_monsno.print( "#define		MONSNO_SIKIZIKA			( 520 )\n" )
  fp_monsno.print( "#define		MONSNO_HIDARUMA			( 521 )\n" )
  fp_monsno.print( "#define		MONSNO_ZOROA				( 522 )\n" )
  fp_monsno.print( "#define		MONSNO_ZOROAAKU			( 523 )\n" )
  fp_monsno.print( "#define		MONSNO_SIROBEA			( 524 )\n" )
  fp_monsno.print( "#define		MONSNO_SYAABEA			( 525 )\n" )
  fp_monsno.print( "#define		MONSNO_KABITTI			( 526 )\n" )
  fp_monsno.print( "#define		MONSNO_KABIINI			( 527 )\n" )
  fp_monsno.print( "#define		MONSNO_DOGOUMORI		( 528 )\n" )
  fp_monsno.print( "#define		MONSNO_PURUKINGU		( 529 )\n" )
  fp_monsno.print( "#define		MONSNO_TYAAKU				( 530 )\n" )
  fp_monsno.print( "#define		MONSNO_DOTYAKKU			( 531 )\n" )
  fp_monsno.print( "#define		MONSNO_NASUKADORI		( 532 )\n" )
  fp_monsno.print( "#define		MONSNO_MUZYAZYA			( 533 )\n" )
  fp_monsno.print( "\n" )
