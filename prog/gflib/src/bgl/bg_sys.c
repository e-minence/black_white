...
struct _GFL_BG_INI {
	...
	u32			CharVramSize[GFL_BG_FRAME_MAX];		//VRAMサイズを格納
};
 ...
 * @param	size		確保するサイズ
 * @param	dir			確保する方向（GFL_BG_CHRAREA_GET_F:前方確保　GFL_BG_CHRAREA_GET_B:後方確保）
 * 
 ...
 */
//--------------------------------------------------------------------------------------------
void	GFL_BG_ClearFrame( u8 frmnum )
{
	GFL_BG_ClearCharacter( frmnum );
	GFL_BG_ClearScreen( frmnum );
}
 ...
 */
//--------------------------------------------------------------------------------------------
void	GFL_BG_ClearCharacter( u8 frmnum )
{
	GFL_BG_SetClearCharacter(frmnum, bgl->CharVramSize[frmnum], 0, bgl->heapID );
}
