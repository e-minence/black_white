...
#define ITEM_IIKIZUGUSURI		( 18 )		// いいキズぐすり
#define ITEM_SUGOIKIZUGUSURI		( 19 )		// すごいキズぐすり
#define ITEM_MANTANNOKUSURI		( 20 )		// まんたんのくすり
#define ITEM_KAIHUKUNOKUSURI		( 21 )		// かいふくのくすり
#define ITEM_GENKINOKAKERA		( 22 )		// げんきのかけら
#define ITEM_GENKINOKATAMARI		( 23 )		// げんきのかたまり
#define ITEM_KINOMIZYUUSU		( 24 )		// きのみジュース
#define ITEM_HAATOSUIITU		( 25 )		// ハートスイーツ
...
#define ITEM_HUKKATUSOU		( 32 )		// ふっかつそう
#define ITEM_SEINARUHAI		( 33 )		// せいなるはい
#define ITEM_DOKUKESI		( 34 )		// どくけし
#define ITEM_MAHINAOSI		( 35 )		// まひなおし
#define ITEM_YAKEDONAOSI		( 36 )		// やけどなおし
#define ITEM_KOORINAOSI		( 37 )		// こおりなおし
#define ITEM_NEMUKEZAMASI		( 38 )		// ねむけざまし
#define ITEM_NANDEMONAOSI		( 39 )		// なんでもなおし
#define ITEM_BANNOUGONA		( 40 )		// ばんのうごな
#define ITEM_HUENSENBEI		( 41 )		// フエンせんべい
#define ITEM_MORINOYOUKAN		( 42 )		// もりのヨウカン
#define ITEM_HIUNAISU		( 43 )		// ヒウンアイス
#define ITEM_IKARIMANZYUU		( 44 )		// いかりまんじゅう
#define ITEM_PIIPIIEIDO		( 45 )		// ピーピーエイド
#define ITEM_PIIPIIRIKABAA		( 46 )		// ピーピーリカバー
#define ITEM_PIIPIIEIDAA		( 47 )		// ピーピーエイダー
#define ITEM_PIIPIIMAKKUSU		( 48 )		// ピーピーマックス
#define ITEM_MAKKUSUAPPU		( 49 )		// マックスアップ
#define ITEM_TAURIN		( 50 )		// タウリン
#define ITEM_BUROMUHEKISIN		( 51 )		// ブロムヘキシン
#define ITEM_RIZOTIUMU		( 52 )		// リゾチウム
#define ITEM_KITOSAN		( 53 )		// キトサン
#define ITEM_INDOMETASIN		( 54 )		// インドメタシン
...
#define ITEM_TAIRYOKUNOHANE		( 126 )		// たいりょくのハネ
#define ITEM_KINRYOKUNOHANE		( 134 )		// きんりょくのハネ
...
#define ITEM_TEIKOUNOHANE		( 504 )		// ていこうのハネ
...
#define ITEM_TIRYOKUNOHANE		( 565 )		// ちりょくのハネ
#define ITEM_SEISINNOHANE		( 566 )		// せいしんのハネ
#define ITEM_SYUNPATUNOHANE		( 567 )		// しゅんぱつのハネ
#define ITEM_POINTOAPPU		( 568 )		// ポイントアップ
#define ITEM_POINTOMAKKUSU		( 569 )		// ポイントマックス
...
#define ITEM_HUSIGINAAME		( 591 )		// ふしぎなアメ
