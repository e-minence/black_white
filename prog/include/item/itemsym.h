...
#define ITEM_TONNERUMEERU		( 124 )		// トンネルメール
#define ITEM_SUTIIRUMEERU		( 125 )		// スチールメール
#define ITEM_RABURABUMEERU		( 126 )		// ラブラブメール
#define ITEM_BURIZAADOMEERU		( 127 )		// ブリザードメール
#define ITEM_SUPEESUMEERU		( 128 )		// スペースメール
#define ITEM_EAMEERU		( 129 )		// エアメール
#define ITEM_MOZAIKUMEERU		( 130 )		// モザイクメール
#define ITEM_BURIKKUMEERU		( 131 )		// ブリックメール
...
#define ITEM_KODAINOGINKA		( 630 )		// こだいのぎんか
#define ITEM_KODAINOKINKA		( 631 )		// こだいのきんか
#define ITEM_KODAINOTUBO		( 632 )		// こだいのツボ
#define ITEM_KODAINOUDEWA		( 633 )		// こだいのうでわ
#define ITEM_KODAINOSEKIZOU		( 634 )		// こだいのせきぞう
#define ITEM_KODAINOOUKAN		( 635 )		// こだいのおうかん
#define ITEM_HIUNAISU		( 636 )		// ヒウンアイス
