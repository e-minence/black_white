...
#define ITEM_KIREINAUROKO		( 577 )		// キレイなウロコ
#define ITEM_POKEZYARASI		( 578 )		// ポケじゃらし
#define ITEM_GUZZUKEESU		( 579 )		// グッズケース
#define ITEM_DORAGONNOHONE		( 580 )		// ドラゴンのホネ
#define ITEM_KAORUKINOKO		( 581 )		// かおるキノコ
#define ITEM_DEKAIKINNOTAMA		( 582 )		// でかいきんのたま
#define ITEM_ODANGOSINZYU		( 583 )		// おだんごしんじゅ
#define ITEM_SUISEINOKAKERA		( 584 )		// すいせいのかけら
#define ITEM_KODAINODOUKA		( 585 )		// こだいのどうか
#define ITEM_KODAINOGINKA		( 586 )		// こだいのぎんか
#define ITEM_KODAINOKINKA		( 587 )		// こだいのきんか
#define ITEM_KODAINOTUBO		( 588 )		// こだいのツボ
#define ITEM_KODAINOUDEWA		( 589 )		// こだいのうでわ
#define ITEM_KODAINOSEKIZOU		( 590 )		// こだいのせきぞう
#define ITEM_KODAINOOUKAN		( 591 )		// こだいのおうかん
#define ITEM_HIUNAISU		( 592 )		// ヒウンアイス
#define ITEM_KURITHIKATTO2		( 593 )		// クリティカット２
#define ITEM_SUPIIDAA2		( 594 )		// スピーダー２
#define ITEM_spAPPU2		( 595 )		// ＳＰアップ２
#define ITEM_spGAADO2		( 596 )		// ＳＰガード２
#define ITEM_DHIFENDAA2		( 597 )		// ディフェンダー２
#define ITEM_PURASUPAWAA2		( 598 )		// プラスパワー２
#define ITEM_YOKUATAARU2		( 599 )		// ヨクアタール２
#define ITEM_SUPIIDAA3		( 600 )		// スピーダー３
#define ITEM_spAPPU3		( 601 )		// ＳＰアップ３
#define ITEM_spGAADO3		( 602 )		// ＳＰガード３
#define ITEM_DHIFENDAA3		( 603 )		// ディフェンダー３
#define ITEM_PURASUPAWAA3		( 604 )		// プラスパワー３
#define ITEM_YOKUATAARU3		( 605 )		// ヨクアタール３
#define ITEM_SUPIIDAA6		( 606 )		// スピーダー６
#define ITEM_spAPPU6		( 607 )		// ＳＰアップ６
#define ITEM_spGAADO6		( 608 )		// ＳＰガード６
#define ITEM_DHIFENDAA6		( 609 )		// ディフェンダー６
#define ITEM_PURASUPAWAA6		( 610 )		// プラスパワー６
#define ITEM_YOKUATAARU6		( 611 )		// ヨクアタール６
#define ITEM_SUKIRUKOORU		( 612 )		// スキルコール
#define ITEM_AITEMUDOROPPU		( 613 )		// アイテムドロップ
#define ITEM_AITEMUKOORU		( 614 )		// アイテムコール
#define ITEM_HURATTOKOORU		( 615 )		// フラットコール
#define ITEM_KURITHIKATTO3		( 616 )		// クリティカット３
#define ITEM_RAITOSUTOON		( 617 )		// ライトストーン
#define ITEM_DAAKUSUTOON		( 618 )		// ダークストーン
#define ITEM_WAZAMASIN93		( 619 )		// わざマシン９３
#define ITEM_WAZAMASIN94		( 620 )		// わざマシン９４
#define ITEM_WAZAMASIN95		( 621 )		// わざマシン９５
#define ITEM_WAZAMASIN96		( 622 )		// わざマシン９６
#define ITEM_WAZAMASIN97		( 623 )		// わざマシン９７
#define ITEM_WAZAMASIN98		( 624 )		// わざマシン９８
#define ITEM_WAZAMASIN99		( 625 )		// わざマシン９９
#define ITEM_WAZAMASIN100		( 626 )		// わざマシン１００
#define ITEM_WAZAMASIN101		( 627 )		// わざマシン１０１
#define ITEM_RAIBUKYASUTAA		( 628 )		// ライブキャスター
#define ITEM_GODDOSUTOON		( 629 )		// ゴッドストーン
#define ITEM_HAITATUBUTU1		( 630 )		// はいたつぶつ１
#define ITEM_HAITATUBUTU2		( 631 )		// はいたつぶつ２
#define ITEM_HAITATUBUTU3		( 632 )		// はいたつぶつ３

#define ITEM_DATA_MAX		( 632 )		// アイテム最大数
