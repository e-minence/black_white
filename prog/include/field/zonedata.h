...
// レールオンリーのマップかどうかチェック
//------------------------------------------------------------------
extern BOOL ZONEDATA_IsRailOnlyMap(u16 zone_id);
...
//  サブウェイマップかどうかのチェック
//------------------------------------------------------------------
extern BOOL ZONEDATA_IsSubway(u16 zone_id);
...
//------------------------------------------------------------------
/// ビーコンサーチ禁止マップかどうかのチェック
//------------------------------------------------------------------
extern BOOL ZONEDATA_IsFieldBeaconNG(u16 zone_id);
...
//------------------------------------------------------------------
extern BOOL ZONEDATA_IsPalaceFieldNoBingo(u16 zone_id);
...
//------------------------------------------------------------------
//  フィールド技が使えるゾーンかどうかのチェック
//------------------------------------------------------------------
extern BOOL ZONEDATA_CheckFieldSkillUse(u16 zone_id);
...
// 海底神殿　ダンジョンマップか？
//------------------------------------------------------------------
extern BOOL ZONEDATA_IsSeaTemple( u16 zone_id );
...
// ゾーン名データの取得
//------------------------------------------------------------------
extern u8 ZONEDATA_GetMvMdlID(u16 zone_id);


//------------------------------------------------------------------
// D09チャンピオンロード関係のZONEか？
//------------------------------------------------------------------
extern BOOL ZONEDATA_IsChampionLord(u16 zone_id);

//------------------------------------------------------------------
//  バトルサブウェイ関連のマップか
//------------------------------------------------------------------
extern BOOL ZONEDATA_IsBattleSubway( u16 zone_id );
