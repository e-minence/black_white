...
//
//==============================================================================================
//定義有効で、"自転車でゲート通過、サイクリングロードBGM対処"
//"SYS_FLAG_CYCLINGROAD"	//POSイベントでR206に行く前にセットしておく必要がある！
//#define SND_BICYCLE_070208

//定義有効で、"ウェイト指定鳴き声再生、鳴き声を2つ同時再生"
#define SND_PV_070213

//定義有効で、"ユニオンルームに入る時のサウンドロード処理の流れ変更"
#define SND_UNION_070215
...
#define BGM_VOL_BR			(BGM_VOL_MAX / 3)				//バトルレコーダー画面BGMのボリューム
#define BGM_VOL_HIROBA_APP	(BGM_VOL_MAX / 3)				//広場のアプリ画面BGMのボリューム

//ボイスチャット終了後に音量をセット(sound_data_bgm.sarcで変更がかかったら対応)
#define BGM_WIFILOBBY_VOL		(120)
#define BGM_WIFILOBBY_START_VOL	(120/5)

//wifiクラブからポケセンに出る時に曲がSEQ_PC_01,02で変わらないので音量を元に戻す
#define BGM_POKECEN_VOL		(120)
...
//#define SE_DEPT_DOOR_OPEN		(SEQ_SE_PL_DOOR_OPEN2)		//●ドアを開ける
#define SE_DEPT_DOOR_OPEN		(SEQ_SE_PL_DOOR_OPEN5)		//●ドアを開ける
//#define SE_DEPT_DOOR_CLOSE	(SEQ_SE_PL_DOOR_OPEN2)		//●ドアを閉める
#define SE_DEPT_DOOR_CLOSE		(0)							//●ドアを閉める
...
//
//============================================================================================
#define SE_YABURETA_JUMP					(SEQ_SE_DP_DANSA)
...
//	ME定義
//
//	試しにBPゲット、CPゲットを逆にしてみた
//
//============================================================================================
#if 1	//0で、BPゲット、CPゲットを逆になる(frontier/scriptをmake cleanしないと反映しない)

#define ME_BP_GET							(SEQ_PL_POINTGET3)
#define ME_CP_GET							(SEQ_PL_FRO)

#else

#define ME_BP_GET							(SEQ_PL_FRO)
#define ME_CP_GET							(SEQ_PL_POINTGET3)

#endif

#define ME_ROULETTE_BP_GET					(SEQ_PL_DON2)
