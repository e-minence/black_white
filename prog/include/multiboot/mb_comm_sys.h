...
typedef enum
{
  ...
  MCCS_END_GAME_ERROR_BACKUP_LOAD,      //バックアップ不良
  MCCS_END_GAME_ERROR_ANOTHER_COUNTRY,  //国違い
  MCCS_CANCEL_BOX,
...
extern POKEMON_PASO_PARAM* MB_COMM_GetPostPokeData( MB_COMM_WORK* commWork , const u8 idx );
