...
typedef enum{
  ...
  GAME_COMM_SBIT_WIFI_ALL           = GAME_COMM_STATUS_BIT_WIFI | GAME_COMM_STATUS_BIT_WIFI_ZONE | GAME_COMM_STATUS_BIT_WIFI_FREE | GAME_COMM_STATUS_BIT_WIFI_LOCK, //@todo makeが通らないので
}GAME_COMM_STATUS_BIT;

#define GAME_COMM_STATUS_BIT_WIFI_ALL (GAME_COMM_STATUS_BIT_WIFI|GAME_COMM_STATUS_BIT_WIFI_ZONE|GAME_COMM_STATUS_BIT_WIFI_FREE|GAME_COMM_STATUS_BIT_WIFI_LOCK)
