...
#define	FORM_NO_NONE		( 0	)		//別フォルムなし

//能力値
#define	ABILITY_HP			(0)	///<体力
#define	ABILITY_POW			(1)	///<攻撃力
#define	ABILITY_DEF			(2)	///<防御力
#define	ABILITY_AGI			(3)	///<素早さ
#define	ABILITY_SPEPOW		(4)	///<特攻
#define	ABILITY_SPEDEF		(5)	///<特防
#define	ABILITY_HIT			(6)	///<命中率
#define	ABILITY_AVOID		(7)	///<回避率
#define	ABILITY_MAX			(8)	///<
