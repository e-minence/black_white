...
#include "gflib/tcb.h" //GFL_TCB*のため
/*↑[GS_CONVERT_TAG]*/
...
extern VINTR_WIRELESS_ICON *AddWirelessIconOAM(u32 objVRAM, u32 HeapId, int x, int y, BOOL bWifi, const VOamAnm *tbl[], int vramType);
...
extern void WirelessIconEasyDisp(int vramtype);
extern void WirelessIconEasyXY(int x,int y, BOOL bWifi, int vramtype);
...
extern void * WirelessIconPlttResGet( u32 heap_id );

extern void WirelessIconOAM_Trans( void );
