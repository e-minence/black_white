 ...
 */
//==============================================================================
extern int mydwc_startConnect(SAVE_CONTROL_WORK * pSaveData, int heapid, int heapSize ,int maxConnectNum);
...
extern BOOL mydwc_checkMyGSID(SAVE_CONTROL_WORK* pSV);
