...
enum{
	...
	COMMSTATE_WIFIP2P_CONNECT_MATCHWAIT,	// 接続待ち
	COMMSTATE_WIFIP2P_CONNECT_MATCH,		// 接続完了
	COMMSTATE_WIFIP2P_CONNECT_DISCONNECT,	// 切断中
};
...
#define COMM_ERRORTYPE_ARESET_WIFI (5)  // Aボタンでリセット(Wi-Fi接続時)
#define COMM_ERRORTYPE_TITLE_WIFI (6)  // Aボタンでリセット タイトル戻し(Wi-Fi接続時)
