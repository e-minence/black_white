...
#define	SCORE_ID_FACTORY_ROUND			38			///<スコア：ファクトリー一周勝ち抜き
#define	SCORE_ID_CASTLE_ROUND			39			///<スコア：キャッスル一周勝ち抜き
#define	SCORE_ID_STAGE_ROUND			40			///<スコア：ステージ一周勝ち抜き
#define	SCORE_ID_ROULETTE_ROUND			41			///<スコア：ルーレット一周勝ち抜き
#define	SCORE_ID_FRONTIER_CONQUER		42			///<スコア：フロンティア制覇
#define	SCORE_ID_FRONTIER_COMM			43			///<スコア：フロンティア通信で遊んだ
#define	SCORE_ID_LOBBY_LOGIN			44			///<スコア：WIFI広場に参加
#define	SCORE_ID_GURUGURU				45			///<スコア：ぐるぐる交換
#define	SCORE_ID_GDS_VIDEO_UPLOAD		46			///<スコア：GDSビデオをアップロード
#define	SCORE_ID_GDS_DRESS_UPLOAD		47			///<スコア：GDSドレスをアップロード
#define	SCORE_ID_GDS_BOX_UPLOAD			48			///<スコア：GDSボックスをアップロード
#define	SCORE_ID_VACATION_HOUSE_COMPLETE	49			///<スコア：別荘コンプリート
#define	SCORE_ID_CLUB_MINIGAME			50			///<スコア：WIFIクラブでミニゲームを遊んだ
