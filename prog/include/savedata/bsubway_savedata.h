...
typedef enum
{
  ...
  BSWAY_SCOREDATA_FLAG_BOSS_CLEAR_SINGLE_S,///<ボスクリアフラグ Sシングル
  BSWAY_SCOREDATA_FLAG_BOSS_CLEAR_DOUBLE_S,///<ボスクリアフラグ Sダブル
  BSWAY_SCOREDATA_FLAG_BOSS_CLEAR_MULTI_S,///<ボスクリアフラグ Sマルチ
