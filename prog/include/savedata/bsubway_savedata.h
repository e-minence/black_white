...
//======================================================================
//--------------------------------------------------------------
///    バトルサブウェイ　プレイデータ構造体への不完全型ポインタ
///  中身は見えませんがポインタ経由で参照できます
//--------------------------------------------------------------
typedef struct _BSUBWAY_PLAYWORK  BSUBWAY_PLAYWORK;

//--------------------------------------------------------------
///    バトルサブウェイ　スコアデータ構造体への不完全型ポインタ
///  中身は見えませんがポインタ経由で参照できます
//--------------------------------------------------------------
typedef struct _BSUBWAY_SCOREWORK  BSUBWAY_SCOREWORK;

//--------------------------------------------------------------
/// バトルサブウェイ プレイヤーメッセージデータ構造体への不完全型ポインタ
/// 中身は見えませんがポインタ経由で参照できます
//--------------------------------------------------------------
...
//--------------------------------------------------------------
///   @biref  サブウェイAIマルチペアの保存が必要なポケモンパラメータ
///   battle/b_tower_data.hを必要な箇所以外では
///   includeしないで済むように定義しておく
//--------------------------------------------------------------
...
//--------------------------------------------------------------
///     サブウェイ　プレイヤースコアデータサイズ
//--------------------------------------------------------------
extern int  BSUBWAY_SocreData_GetWorkSize(void);
