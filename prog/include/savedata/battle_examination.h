...
extern void BATTLE_EXAMINATION_SAVE_SetActiveBit(BATTLE_EXAMINATION_SAVEDATA* pBattleEx, const u32 inBitNo);
extern u8 BATTLE_EXAMINATION_SAVE_GetActiveBit(BATTLE_EXAMINATION_SAVEDATA* pBattleEx, const u32 inBitNo);
