...
extern void LIVEMATCH_DATA_SetMyParam( const LIVEMATCH_DATA *cp_wk, LIVEMATCH_MYDATA_PARAM param, int data );
extern void LIVEMATCH_DATA_AddMyParam( const LIVEMATCH_DATA *cp_wk, LIVEMATCH_MYDATA_PARAM param, int data );
...
//設定
extern void LIVEMATCH_DATA_SetFoeMacAddr( const LIVEMATCH_DATA *cp_wk, u32 index, const u8* cp_mac_addr );
extern void LIVEMATCH_DATA_SetFoeParam( const LIVEMATCH_DATA *cp_wk, u32 index, LIVEMATCH_FOEDATA_PARAM param, int data );
