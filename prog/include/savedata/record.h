...
//以下は、4バイトのカウンタを持つ
#define RECID_REPORT_COUNT_EX   (LARGE_REC_START+0) ///<仮データなんでもいい
...
//2byte: WBで追加
#define RECID_TRIALHOUSE_SCORE      (SMALL_REC_START+49)  ///< トライアルハウスのスコア最大値
#define RECID_TRIALHOUSE_RANK     (SMALL_REC_START+50)  ///< トライアルハウスの最高ランク



#define SMALL_REC_NUM (51+26) //26箇所分余り
