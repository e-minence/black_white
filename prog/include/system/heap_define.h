...
//===================================================================
  ...
  HEAP_DEFINE( HEAPID_EXTRA ) //特殊ヒープ
  ...
  HEAP_DEFINE( HEAPID_DENDOU_DEMO )			//140
  HEAP_DEFINE( HEAPID_STAFF_ROLL )
  HEAP_DEFINE( HEAPID_EGG_DEMO )
  HEAP_DEFINE( HEAPID_MANUAL )
  HEAP_DEFINE( HEAPID_POKEMONTRADE_STATIC )
  HEAP_DEFINE( HEAPID_WEATHER )
  HEAP_DEFINE( HEAPID_PLACE_NAME )
  HEAP_DEFINE( HEAPID_SHINKA_DEMO_SYS )
  HEAP_DEFINE( HEAPID_ZUKAN_DETAIL )
  HEAP_DEFINE( HEAPID_ZUKAN_DETAIL_COMMON )
  HEAP_DEFINE( HEAPID_ZUKAN_DETAIL_SYS )  //150
