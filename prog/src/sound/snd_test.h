 ...
 */
//==============================================================================================
#include "sound/sound_data.h"	//サウンドの種類ごとのスタートナンバー定義
...
//#define SND_TEST_BG_FRAME		(GFL_BG_FRAME1_M)
#define SND_TEST_BG_FRAME		(GFL_BG_FRAME3_M)

//BMPウィンドウ
enum{
	SND_TEST_BMPWIN_FRAME	= GFL_BG_FRAME1_M,
