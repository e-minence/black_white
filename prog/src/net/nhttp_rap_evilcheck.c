...
バイト位置               サイズ(byte)                  説明
0                        1                             ステータスコード(成功=0)
１                       4                             ポケモン1の認証結果コード(ネットワークバイトオーダー)
5                        4                             ポケモン2の認証結果コード(ネットワークバイトオーダー)

1+4*(n-1)                4                            ポケモンnの認証結果コード(ネットワークバイトオーダー)
...
{ 
  ...
  GF_ASSERT_MSG_HEAVY( s_heapID != NHTTP_RAP_HEAPID_NONE, "heapIDを設定してください\n" );
