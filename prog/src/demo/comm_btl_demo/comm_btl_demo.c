...
{ 
  ...
  NORMAL_POSID0_BALL_PY = 21*8,
  NORMAL_POSID1_BALL_PY = 7*8,
  ...
  POKENUM_POSID0_PY = NORMAL_POSID0_BALL_PY-16,
  POKENUM_POSID1_PX = 50,
  POKENUM_POSID1_PY = NORMAL_POSID1_BALL_PY-16,

  NORMAL_POSID0_TRNAME_CPX = 4,
  NORMAL_POSID0_TRNAME_CPY = 17,
  NORMAL_POSID0_TRNAME_PTC_PX = 0x800,
  NORMAL_POSID0_TRNAME_PTC_PY = 0x2000,
  NORMAL_POSID0_BALL_PTC_BASE_X = 0xfffffc00,
  NORMAL_POSID0_BALL_PTC_BASE_Y = 0xffffdb00,

  NORMAL_POSID1_TRNAME_CPX = 16,
  NORMAL_POSID1_TRNAME_CPY = 3,
  NORMAL_POSID1_TRNAME_PTC_PX = 0xffffd800, 
  NORMAL_POSID1_TRNAME_PTC_PY = 0xffffe800,
  NORMAL_POSID1_BALL_PTC_BASE_X = 0x300,
  NORMAL_POSID1_BALL_PTC_BASE_Y = 0x1300,
