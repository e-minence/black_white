 ...
 *	{	
 *	○概要
 *	comm_btl_demo_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	comm_btl_demo_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム comm_btl_demo, COMM_BTL_DEMO -> config CONFIGなど
...
static const GFL_DISP_VRAM sc_vramSetTable =
{
	...
	GX_OBJVRAMMODE_CHAR_1D_64K,// サブ画面OBJマッピングモード
};
...
///	グラフィックメインワーク
//=====================================
struct _COMM_BTL_DEMO_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
COMM_BTL_DEMO_GRAPHIC_WORK * COMM_BTL_DEMO_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	COMM_BTL_DEMO_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(COMM_BTL_DEMO_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(COMM_BTL_DEMO_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void COMM_BTL_DEMO_GRAPHIC_Exit( COMM_BTL_DEMO_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void COMM_BTL_DEMO_GRAPHIC_2D_Draw( COMM_BTL_DEMO_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void COMM_BTL_DEMO_GRAPHIC_3D_StartDraw( COMM_BTL_DEMO_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void COMM_BTL_DEMO_GRAPHIC_3D_EndDraw( COMM_BTL_DEMO_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * COMM_BTL_DEMO_GRAPHIC_GetClunit( const COMM_BTL_DEMO_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * COMM_BTL_DEMO_GRAPHIC_GetCamera( const COMM_BTL_DEMO_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	COMM_BTL_DEMO_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
