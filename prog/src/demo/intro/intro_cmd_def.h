...
{ 
  ...
  INTRO_CMD_TYPE_BGM_FADEIN,
  //======================================================
  //BGM切り替え待ち
  //  BGMロード中は待ち続けます
  //======================================================
  INTRO_CMD_TYPE_BGM_CHANGE_WAIT,
  //======================================================
  //SE再生
  //  PARAM[0]: SE_Label
  //  PARAM[1]: volume
  ...
  //  PARAM[0]  MCSS_ID
  //======================================================
  INTRO_CMD_TYPE_MCSS_CHECK_ANIME,
  //======================================================
  //MCSSアニメーションチェックフラグリセット
  //  PARAM[0]  MCSS_ID
  //======================================================
  INTRO_CMD_TYPE_MCSS_RESET_ANIME_FLAG,
  //======================================================
  //MCSS移動
  //  PARAM[0]  MCSS_ID
  //  PARAM[1]  Ｘ移動量
  ...
  //======================================================
  //指定MCSSにアニメーションさせながらメッセージ表示
  //  PARAM[0]  str_id
  //  PARAM[1]  MCSS_ID
  //======================================================
  INTRO_CMD_TYPE_MCSS_TALK_MSG,
  ...
  INTRO_CMD_TYPE_SAVE_CHECK_ALL_END,
	...
	INTRO_CMD_TYPE_CMD_BG_EFF_IN,
	INTRO_CMD_TYPE_CMD_BG_EFF_OUT,
	INTRO_CMD_TYPE_CMD_OBJ_LOAD,
	INTRO_CMD_TYPE_CMD_OBJ_UNLOAD,
	INTRO_CMD_TYPE_CMD_OBJ_IN,
	INTRO_CMD_TYPE_CMD_OBJ_OUT,
