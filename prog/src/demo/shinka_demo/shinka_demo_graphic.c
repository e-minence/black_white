 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム ui_template, SHINKADEMO -> config CONFIGなど
...
/*
static const VecFx32 sc_CAMERA_PER_POS    	= { FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32( 100.0f ) };
static const VecFx32 sc_CAMERA_PER_UP       = { FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32( 1.0f ), FX_F32_TO_FX32(   0.0f ) };
static const VecFx32 sc_CAMERA_PER_TARGET		= { FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32(   0.0f ) };
*/

static const VecFx32 sc_CAMERA_PER_POS    	= { FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32( 10.0f ), FX_F32_TO_FX32(   100.0f ) };
static const VecFx32 sc_CAMERA_PER_UP       = { FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32(  1.0f ), FX_F32_TO_FX32(     0.0f ) };
static const VecFx32 sc_CAMERA_PER_TARGET		= { FX_F32_TO_FX32( 0.0f ), FX_F32_TO_FX32(  0.0f ), FX_F32_TO_FX32(     0.0f ) };
...
///	グラフィックメインワーク
//=====================================
struct _SHINKADEMO_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
SHINKADEMO_GRAPHIC_WORK * SHINKADEMO_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	SHINKADEMO_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(SHINKADEMO_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(SHINKADEMO_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void SHINKADEMO_GRAPHIC_Exit( SHINKADEMO_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void SHINKADEMO_GRAPHIC_2D_Draw( SHINKADEMO_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void SHINKADEMO_GRAPHIC_3D_StartDraw( SHINKADEMO_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void SHINKADEMO_GRAPHIC_3D_EndDraw( SHINKADEMO_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * SHINKADEMO_GRAPHIC_GetClunit( const SHINKADEMO_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * SHINKADEMO_GRAPHIC_GetCamera( const SHINKADEMO_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
/// サブBGの初期化
//=====================================
void SHINKADEMO_GRAPHIC_InitBGSub( SHINKADEMO_GRAPHIC_WORK* p_wk )
{
#ifdef GRAPHIC_BG_USE
	//グラフィックモード設定
	{	
    GFL_BG_SetBGModeDisp( &sc_bgsys_header, GFL_BG_SUB_DISP );
	}
...
/// サブBGの破棄
//=====================================
void SHINKADEMO_GRAPHIC_ExitBGSub( SHINKADEMO_GRAPHIC_WORK* p_wk )
{
#ifdef GRAPHIC_BG_USE
	//BG面破棄
	{	
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	SHINKADEMO_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
...
{	
	...
	{	
		...
		for( i = 0; i < NELEMS(sc_bgsetup); i++ )
		{
      if( sc_bgsetup[i].frame <= GFL_BG_FRAME3_M )
      {
			  GFL_BG_SetBGControl( sc_bgsetup[i].frame, &sc_bgsetup[i].bgcnt_header, sc_bgsetup[i].mode );
			  GFL_BG_ClearFrame( sc_bgsetup[i].frame );
			  GFL_BG_SetVisible( sc_bgsetup[i].frame, sc_bgsetup[i].is_visible );
