...
{ 
  ...
  { 
    GFL_BG_FRAME1_M,  //設定するフレーム
    {
      ...
      GX_BG_SCRBASE_0x1000, GX_BG_CHARBASE_0x04000, GFL_BG_CHRSIZ_256x256,//ｽｸﾘｰﾝﾍﾞｰｽ、ｷｬﾗﾍﾞｰｽ、ｷｬﾗｻｲｽﾞ
  ...
  { 
    GFL_BG_FRAME2_M,  //設定するフレーム
    {
      0, 0, 0x1000, 0,  //X,Y,ｽｸﾘｰﾝﾊﾞｯﾌｧ、ｽｸﾘｰﾝｵﾌｾｯﾄ
      GFL_BG_SCRSIZ_256x512, GX_BG_COLORMODE_16,  //ｽｸﾘｰﾝｻｲｽﾞ、ｶﾗｰﾓｰﾄﾞ
      GX_BG_SCRBASE_0x2000, GX_BG_CHARBASE_0x04000, GFL_BG_CHRSIZ_256x256,//ｽｸﾘｰﾝﾍﾞｰｽ、ｷｬﾗﾍﾞｰｽ、ｷｬﾗｻｲｽﾞ
  ...
  { 
    GFL_BG_FRAME3_M,  //設定するフレーム
    {
      0, 0, 0x1000, 0,  //X,Y,ｽｸﾘｰﾝﾊﾞｯﾌｧ、ｽｸﾘｰﾝｵﾌｾｯﾄ
      GFL_BG_SCRSIZ_256x512, GX_BG_COLORMODE_16,  //ｽｸﾘｰﾝｻｲｽﾞ、ｶﾗｰﾓｰﾄﾞ
      GX_BG_SCRBASE_0x3000, GX_BG_CHARBASE_0x0c000, GFL_BG_CHRSIZ_256x256,//ｽｸﾘｰﾝﾍﾞｰｽ、ｷｬﾗﾍﾞｰｽ、ｷｬﾗｻｲｽﾞ
 ...
 */
//-----------------------------------------------------------------------------
THE_END_GRAPHIC_WORK * THE_END_GRAPHIC_Init( int display_select, HEAPID heapID )
{ 
  THE_END_GRAPHIC_WORK * p_wk;
  p_wk  = GFL_HEAP_AllocMemory(heapID, sizeof(THE_END_GRAPHIC_WORK) );
  GFL_STD_MemClear( p_wk, sizeof(THE_END_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void THE_END_GRAPHIC_Exit( THE_END_GRAPHIC_WORK *p_wk )
{ 
  //VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void THE_END_GRAPHIC_2D_Draw( THE_END_GRAPHIC_WORK *p_wk )
{ 
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void THE_END_GRAPHIC_3D_StartDraw( THE_END_GRAPHIC_WORK *p_wk )
{ 
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void THE_END_GRAPHIC_3D_EndDraw( THE_END_GRAPHIC_WORK *p_wk )
{ 
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * THE_END_GRAPHIC_GetClunit( const THE_END_GRAPHIC_WORK *cp_wk )
{ 
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * THE_END_GRAPHIC_GetCamera( const THE_END_GRAPHIC_WORK *cp_wk )
{ 
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
  THE_END_GRAPHIC_WORK *p_wk  = p_work;
#ifdef GRAPHIC_BG_USE
