...
WFLBY_SAVEDATA* SAVEDATA_WFLBY_AllocWork( u32 heapID )
{
	...
	p_wk = GFL_HEAP_AllocClearMemory( heapID, SAVEDATA_WFLBY_GetWorkSize() );
 ...
 */
//-----------------------------------------------------------------------------
WFLBY_SAVEDATA* SAVEDATA_WFLBY_GetWork( SAVE_CONTROL_WORK* p_sv )
{
	WFLBY_SAVEDATA* p_wk;

	p_wk = SaveControl_DataPtrGet( p_sv, GMDATA_ID_WFHIROBA );
