 ...
 */
//-----------------------------------------------------------------------------
static void SetDeokisisuFormNo( ZUKAN_SAVEDATA * zw, u16 monsno, POKEMON_PARAM* pp  )
{
 ...
 */
//----------------------------------------------------------
static void SetZukanSpecialTurn(ZUKAN_SAVEDATA * zw, u16 monsno, POKEMON_PARAM* pp)
{
	int form;
