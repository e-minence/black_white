 ...
 */
//---------------------------------------------------------------------------
SYSTEMDATA * SaveData_GetSystemData(SAVE_CONTROL_WORK * sv)
{
	return SaveControl_DataPtrGet(sv, GMDATA_ID_SYSTEM_DATA);
}
 ...
 */
//---------------------------------------------------------------------------
GMTIME * SaveData_GetGameTime(SAVE_CONTROL_WORK * sv)
{
	SYSTEMDATA * system;
	system = SaveControl_DataPtrGet(sv, GMDATA_ID_SYSTEM_DATA);
...
{
	gt->use_flag = TRUE;
	GFL_RTC_GetDateTime(&gt->sv_date, &gt->sv_time);
