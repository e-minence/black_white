...
{
	{  64,  42, 112,  44, 0, 1, 0, 2, {  1*8,  9*8-1,  0*8, 16*8-1 } },					// 0 : HP回復ポケット
	{  64, 114, 112,  44, 0, 4, 1, 3, { 10*8, 18*8-1,  0*8, 16*8-1 } },					// 1 : 状態回復ポケット
	{ 192,  42, 112,  44, 2, 3, 0, 2, {  1*8,  9*8-1, 16*8, 32*8-1 } },					// 2 : ボールポケット
	{ 192, 114, 112,  44, 2, 5, 1, 3, { 10*8, 18*8-1, 16*8, 32*8-1 } },					// 3 : 戦闘用ポケット
	{ 108, 176, 184,  24, 1, 4, 4, 5, { 19*8, 24*8-1,  1*8, 26*8-1 } },					// 4 : 最後に使用した道具
	{ 240, 174,  32,  28, CURSORMOVE_RETBIT|3, 5, 4, 5, { 19*8, 24*8-1, 27*8, 32*8-1 } },	// 5 : 戻る
};
...
{
	{  64,  32, 112,  38, 0, 2, 0, 1, {  1*8,  7*8-1,  0*8, 16*8-1 } },					// 0 : アイテム１
	{ 192,  32, 112,  38, 1, 3, 0, 1, {  1*8,  7*8-1, 16*8, 32*8-1 } },					// 1 : アイテム２
	{  64,  80, 112,  38, 0, 4, 2, 3, {  7*8, 13*8-1,  0*8, 16*8-1 } },					// 2 : アイテム３
	{ 192,  80, 112,  38, 1, 5, 2, 3, {  7*8, 13*8-1, 16*8, 32*8-1 } },					// 3 : アイテム４
	{  64, 128, 112,  38, 2, 6, 4, 5, { 13*8, 19*8-1,  0*8, 16*8-1 } },					// 4 : アイテム５
	{ 192, 128, 112,  38, 3, 6, 4, 5, { 13*8, 19*8-1, 16*8, 32*8-1 } },					// 5 : アイテム６
	{ 240, 174,  32,  28, CURSORMOVE_RETBIT|5, 6, 6, 6, { 19*8, 24*8-1, 27*8, 32*8-1 } },	// 6 : 戻る
	{ 0, 0, 0, 0, 7, 7, 7, 7, { 19*8, 24*8-1,  0*8,  5*8-1 } },	// 7 : 前へ
	{ 0, 0, 0, 0, 8, 8, 8, 8, { 19*8, 24*8-1,  5*8, 10*8-1 } },	// 8 : 次へ
};
...
{
	{ 108, 176, 184,  24, 0, 0, 0, 1, { 19*8, 24*8-1,  1*8, 26*8-1 } },	// 0 : 使う
	{ 240, 174,  32,  28, 1, 1, 0, 1, { 19*8, 24*8-1, 27*8, 32*8-1 } },	// 1 : 戻る
};
