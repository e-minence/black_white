...
#define	WIN_CHG_NAME_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_CHG_IREKAE_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_CHG_STATUS_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_CHG_WAZACHECK_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P1_POKE1_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P1_POKE2_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P1_POKE3_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P1_POKE4_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P1_POKE5_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P1_POKE6_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_STM_HP_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_POW_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_DEF_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_AGI_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_SPP_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_SPD_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_LV_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
#define	WIN_STM_LV_CGX		( WIN_STM_SPD_CGX + WIN_STM_SPD_SX * WIN_STM_SPD_SY )
// 「つぎのレベルまで」
#define	WIN_STM_NEXT_PX		( 1 )
#define	WIN_STM_NEXT_PY		( 6 )
#define	WIN_STM_NEXT_SX		( 12 )
#define	WIN_STM_NEXT_SY		( 2 )
#define	WIN_STM_NEXT_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_WAZACHECK_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_STW_STATUS_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_ST_NAME_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STW_SKILL1_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_STW_SKILL2_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_STW_SKILL3_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_STW_SKILL4_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_STM_SPANAME_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_SPAINFO_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_ITEMNAME_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_HPNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_POWNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_DEFNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_AGINUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_SPPNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_SPDNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_HPGAGE_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_STM_LVNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_STM_NEXTNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P7_NAME_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P7_SKILL1_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P7_SKILL2_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P7_SKILL3_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P7_SKILL4_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P5_NAME_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P5_SKILL1_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P5_SKILL2_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P5_SKILL3_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P5_SKILL4_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P5_SKILL5_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P8_NAME_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P8_SKILL_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P8_PP_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P8_PPNUM_PAL	( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P8_WASURERU_PAL	( BPL_COMM_PAL_HPGAGE )
...
#define	WIN_P8_APP_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
...
#define	WIN_P8_INFO_PAL		( BPL_COMM_PAL_HPGAGE )//( BPL_PAL_SYS_FONT )
