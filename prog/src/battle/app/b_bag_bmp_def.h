...
// メッセージ表示
#define	WIN_TALK_FRM		( GFL_BG_FRAME0_S )
#define	WIN_TALK_PX			( 1 )
#define	WIN_TALK_PY			( 19 )
#define	WIN_TALK_SX			( 30 )
...
//============================================================================================
// 「じょうたいかいふく」
#define	WIN_P1_ZYOUTAI_FRM	( GFL_BG_FRAME0_S )
...
// 「HP/PPかいふく」
#define	WIN_P1_HP_FRM		( GFL_BG_FRAME0_S )
...
// 「せんとうよう」
#define	WIN_P1_BATTLE_FRM	( GFL_BG_FRAME0_S )
...
// 「ボール」
#define	WIN_P1_BALL_FRM		( GFL_BG_FRAME0_S )
