...
static const GFL_UI_TP_HITTBL SkillMenuTouchData[] = {
  //UP    DOWN    LEFT    RIGHT
  {0x03*8, 0x0a*8, 0x00*8, 0x10*8},   //技1
  {0x03*8, 0x0a*8, 0x10*8, 255},      //技2
  {0x0b*8, 0x12*8, 0x00*8, 0x10*8},   //技3
  {0x0b*8, 0x12*8, 0x10*8, 255},      //技4
  {0x12*8, 0x18*8, 0x16*8, 255},      //キャンセル
  {0x12*8, 0x18*8, 0x00*8, 0x0a*8},   //移動（3vs3時のみ）
  { GFL_UI_TP_HIT_END, 0, 0, 0 }
};
