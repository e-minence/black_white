 ...
 */
//--------------------------------------------------------------
void WazaPanel_CharLoad( HEAPID heap_id, int frame_no, u32 trans_pos, 
 ...
 */
//--------------------------------------------------------------
void WazaPanel_EasyCharLoad( int waza_type, HEAPID heap_id, int frame_no, 
	u32 trans_pos, int screen_type)
{
	...
	arc_data = GFL_ARC_UTIL_LoadBGCharacter( arc_id, char_index, 1, &char_data, heap_id );

	WazaPanel_CharLoad( heap_id, frame_no, trans_pos, screen_type, char_data->pRawData );
 ...
 */
//--------------------------------------------------------------
void WazaPanel_EasyCharLoad_ChainSet( int waza_type, HEAPID heap_id, int frame_no, 
	const u16 trans_pos[], int trans_num, int screen_type )
{
	...
	for(i = 0; i < trans_num; i++){
		WazaPanel_CharLoad( heap_id, frame_no, trans_pos[i], screen_type, char_data->pRawData);
	}
 ...
 */
//--------------------------------------------------------------
void WazaPanel_EasyPalLoad( PALETTE_FADE_PTR pfd, int waza_type, HEAPID heap_id, 
