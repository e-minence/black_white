...
#define MSGCOLOR_PP_BLACK		(PRINTSYS_LSB_Make(1, 2, 0))	//FONT_SYSTEMなので背景抜き色指定
#define MSGCOLOR_PP_YELLOW		(PRINTSYS_LSB_Make(3, 4, 0))	//FONT_SYSTEMなので背景抜き色指定
#define MSGCOLOR_PP_ORANGE		(PRINTSYS_LSB_Make(5, 6, 0))	//FONT_SYSTEMなので背景抜き色指定
#define MSGCOLOR_PP_RED			(PRINTSYS_LSB_Make(7, 8, 0))	//FONT_SYSTEMなので背景抜き色指定
