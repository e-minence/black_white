...
#define	BTLEFF_PARTICLE_PLAY_SIDE_NONE		      ( 6 )
#define	BTLEFF_PARTICLE_PLAY_SIDE_ATTACK	      ( 7 )
#define	BTLEFF_PARTICLE_PLAY_SIDE_ATTACK_MINUS	( 8 )
#define	BTLEFF_PARTICLE_PLAY_SIDE_DEFENCE	      ( 9 )
#define	BTLEFF_PARTICLE_PLAY_SIDE_DEFENCE_MINUS	( 10 )
