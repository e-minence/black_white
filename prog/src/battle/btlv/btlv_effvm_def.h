...
#define BTLEFF_WORK_ATTACK_POKEMON_VANISH ( 17 )  ///<攻撃側のポケモンがきえているか
#define BTLEFF_WORK_ATTACK_POKEMON_DIR    ( 18 )  ///<攻撃側のポケモンの向き
#define BTLEFF_WORK_POS_AA_RARE           ( 19 )   ///<POS_AAがレアか？
#define BTLEFF_WORK_POS_BB_RARE           ( 20 )   ///<POS_BBがレアか？
#define BTLEFF_WORK_POS_A_RARE            ( 21 )   ///<POS_Aがレアか？
#define BTLEFF_WORK_POS_B_RARE            ( 22 )   ///<POS_Bがレアか？
#define BTLEFF_WORK_POS_C_RARE            ( 23 )   ///<POS_Cがレアか？
#define BTLEFF_WORK_POS_D_RARE            ( 24 )   ///<POS_Dがレアか？
#define BTLEFF_WORK_POS_E_RARE            ( 25 )   ///<POS_Eがレアか？
#define BTLEFF_WORK_POS_F_RARE            ( 26 )   ///<POS_Fがレアか？
#define BTLEFF_WORK_ATTACK_RARE           ( 27 )   ///<攻撃側がレアか？
#define BTLEFF_WORK_POS_AA_JUMP           ( 28 )   ///<POS_AAが跳ねるの可？
#define BTLEFF_WORK_POS_BB_JUMP           ( 29 )   ///<POS_BBが跳ねるの可？
#define BTLEFF_WORK_POS_A_JUMP            ( 30 )   ///<POS_Aが跳ねるの可？
#define BTLEFF_WORK_POS_B_JUMP            ( 31 )   ///<POS_Bが跳ねるの可？
#define BTLEFF_WORK_POS_C_JUMP            ( 32 )   ///<POS_Cが跳ねるの可？
#define BTLEFF_WORK_POS_D_JUMP            ( 33 )   ///<POS_Dが跳ねるの可？
#define BTLEFF_WORK_POS_E_JUMP            ( 34 )   ///<POS_Eが跳ねるの可？
#define BTLEFF_WORK_POS_F_JUMP            ( 35 )   ///<POS_Fが跳ねるの可？
#define BTLEFF_WORK_ATTACK_JUMP           ( 36 )   ///<攻撃側が跳ねるの可？
#define BTLEFF_WORK_MULTI                 ( 37 )   ///<マルチ対戦？
#define BTLEFF_WORK_TRTYPE_A              ( 38 )   ///<トレーナータイプ
#define BTLEFF_WORK_TRTYPE_B              ( 39 )   ///<トレーナータイプ
#define BTLEFF_WORK_TRTYPE_C              ( 40 )   ///<トレーナータイプ
#define BTLEFF_WORK_TRTYPE_D              ( 41 )   ///<トレーナータイプ
#define BTLEFF_WORK_POS_AA_FLY            ( 42 )   ///<POS_AAは飛んでいる？
#define BTLEFF_WORK_POS_BB_FLY            ( 43 )   ///<POS_BBは飛んでいる？
#define BTLEFF_WORK_POS_A_FLY             ( 44 )   ///<POS_Aは飛んでいる？
#define BTLEFF_WORK_POS_B_FLY             ( 45 )   ///<POS_Bは飛んでいる？
#define BTLEFF_WORK_POS_C_FLY             ( 46 )   ///<POS_Cは飛んでいる？
#define BTLEFF_WORK_POS_D_FLY             ( 47 )   ///<POS_Dは飛んでいる？
#define BTLEFF_WORK_POS_E_FLY             ( 48 )   ///<POS_Eは飛んでいる？
#define BTLEFF_WORK_POS_F_FLY             ( 49 )   ///<POS_Fは飛んでいる？
#define BTLEFF_WORK_ATTACK_FLY            ( 50 )   ///<攻撃側は飛んでいる？
...
#define	EC_POKEMON_SIN_MOVE			      ( 17 )
#define	EC_POKEMON_SCALE						  ( 18 )
#define	EC_POKEMON_ROTATE						  ( 19 )
#define	EC_POKEMON_ALPHA						  ( 20 )
#define	EC_POKEMON_MOSAIC						  ( 21 )
#define	EC_POKEMON_SET_MEPACHI_FLAG	  ( 22 )
#define	EC_POKEMON_SET_ANM_FLAG			  ( 23 )
#define	EC_POKEMON_PAL_FADE					  ( 24 )
#define	EC_POKEMON_VANISH					    ( 25 )
#define	EC_POKEMON_SHADOW_VANISH	    ( 26 )
#define	EC_POKEMON_DEL	              ( 27 )
#define	EC_TRAINER_SET							  ( 28 )
#define	EC_TRAINER_MOVE							  ( 29 )
#define	EC_TRAINER_ANIME_SET				  ( 30 )
#define	EC_TRAINER_DEL							  ( 31 )
#define	EC_BG_LOAD	   				        ( 32 )
#define	EC_BG_SCROLL		   				    ( 33 )
#define	EC_BG_RASTER_SCROLL		   	    ( 34 )
#define	EC_BG_PAL_ANM		   				    ( 35 )
 ...
 * @param		param	セットする値
 *
 * #param COMBOBOX_TEXT WAZA_RANGE TURN_COUNT CONTINUE_COUNT YURE_CNT GET_SUCCESS GET_CRITICAL  ITEM_NO
 * #param COMBOBOX_VALUE BTLEFF_WORK_WAZA_RANGE BTLEFF_WORK_TURN_COUNT BTLEFF_WORK_CONTINUE_COUNT BTLEFF_WORK_YURE_CNT BTLEFF_WORK_GET_SUCCESS BTLEFF_WORK_GET_CRITICAL BTLEFF_WORK_ITEM_NO
