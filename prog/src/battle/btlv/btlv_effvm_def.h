 ...
 * @param		param	セットする値
 *
 * #param COMBOBOX_TEXT WAZA_RANGE TURN_COUNT CONTINUE_COUNT YURE_CNT GET_SUCCESS GET_CRITICAL  ITEM_NO ZOOM_OUT  PUSH_CAMERA_POS
 * #param COMBOBOX_VALUE BTLEFF_WORK_WAZA_RANGE BTLEFF_WORK_TURN_COUNT BTLEFF_WORK_CONTINUE_COUNT BTLEFF_WORK_YURE_CNT BTLEFF_WORK_GET_SUCCESS BTLEFF_WORK_GET_CRITICAL BTLEFF_WORK_ITEM_NO BTLEFF_WORK_ZOOM_OUT  BTLEFF_WORK_PUSH_CAMERA_POS
