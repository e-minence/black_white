...
*/
//-----------------------------------------------------------------------------
static void wndp_v_SetVisibleWnd(GFL_TCB * tcb, void* data);
static void wndp_v_SetWndInsidePlane(GFL_TCB * tcb, void* data);
static void wndp_v_SetWndOutsidePlane(GFL_TCB * tcb, void* data);
static void wndp_v_SetWndOBJInsidePlane(GFL_TCB * tcb, void* data);
static void wndp_v_SetWndPosition(GFL_TCB * tcb, void* data);
