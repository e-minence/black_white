...
//  マップデータの読み込み処理
//------------------------------------------------------------------
extern void FIELD_BMODEL_MAN_Load(FIELD_BMODEL_MAN * man, u16 zoneid, const AREADATA * areadata, int gray_scale);
...
typedef enum {
  ...
  BM_PROG_ID_WARP,
  BM_PROG_ID_EVENT,
  BM_PROG_ID_PPMACHINE,
  BM_PROG_ID_DOOR_ELEVATOR,
  BM_PROG_ID_DOOR_BELL,
  BM_PROG_ID_DOOR_AUTO2,
...
extern void G3DMAPOBJST_changeModelID(
    const FIELD_BMODEL_MAN * man, G3DMAPOBJST * obj, BMODEL_ID new_id );
