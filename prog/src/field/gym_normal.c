...
//※このジムは2部屋にギミックがあるが、正解の本棚はどちらの部屋でも0番目に登録する
...
//本棚座標
#define WALL1_X  (16*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL1_Z  (16*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL2_X  (1*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL2_Z  (1*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL3_X  (2*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL3_Z  (2*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL4_X  (3*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL4_Z  (3*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL5_X  (4*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL5_Z  (4*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL6_X  (5*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
#define WALL6_Z  (5*FIELD_CONST_GRID_FX32_SIZE + GRID_HALF_SIZE)
