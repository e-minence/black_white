...
extern void PALACE_SYS_Update(PALACE_SYS_PTR palace, PLAYER_WORK *plwork, FIELD_PLAYER *fldply, INTRUDE_COMM_SYS_PTR intcomm, FIELDMAP_WORK *fieldWork, GAME_COMM_SYS_PTR game_comm);
...
//  デバッグ用
//--------------------------------------------------------------
extern BOOL PALACE_DEBUG_CreateNumberAct(PALACE_SYS_PTR palace, HEAPID heap_id, FIELDMAP_WORK *fieldWork);
extern void PALACE_DEBUG_DeleteNumberAct(PALACE_SYS_PTR palace);
extern GMEVENT * EVENT_DebugPalaceNGWin( GAMESYS_WORK *gsys, FIELDMAP_WORK *fieldWork, FIELD_PLAYER *fld_player, BOOL left_right );
