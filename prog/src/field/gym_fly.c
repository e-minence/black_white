...
#include "../../../resource/fldmapdata/gimmick/gym_fly/gym_fly_local_def.h"
...
#define CAN2_Y  (CAN2_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN3_Y  (CAN3_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN4_Y  (CAN4_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN5_Y  (CAN5_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN6_Y  (CAN6_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN7_Y  (CAN7_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN8_Y  (CAN8_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN9_Y  (CAN9_GY*FIELD_CONST_GRID_FX32_SIZE)
...
#define CAN10_Y  (CAN10_GY*FIELD_CONST_GRID_FX32_SIZE)
...
///      OS_Printf("%x %x %x\n",dst_vec.x,dst_vec.y,dst_vec.z);
...

    {
      ...
      if ( cam_eff_idx == WALL_HIT_ANM_IDX ){
        ...
        //壁にぶち当たる大砲のときだけ着地ＳＥが無いので以下の処理で影復帰を行う
