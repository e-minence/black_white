 ...
 *
 * @file	fldmmdl_acmd.h
 * @brief	ƒtƒB[ƒ‹ƒh“®ìƒ‚ƒfƒ‹@ƒAƒjƒ[ƒVƒ‡ƒ“ƒRƒ}ƒ“ƒh“®ìŠÖ”’è‹`
 * @author	kagaya
 * @date	05.07.13
 *
 */
...
extern int (* const DATA_AC_WalkU12F_Tbl[])( MMDL * );
extern int (* const DATA_AC_WalkD12F_Tbl[])( MMDL * );
extern int (* const DATA_AC_WalkL12F_Tbl[])( MMDL * );
extern int (* const DATA_AC_WalkR12F_Tbl[])( MMDL * );
...
extern int (* const DATA_AC_HeroCutin_Tbl[])( MMDL * );
