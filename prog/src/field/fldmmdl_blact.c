...
static const GFL_BBDACT_ANM* playerBBDactAnmTable[] = { 
	PCstopUAnm, PCstopDAnm, PCstopLAnm, PCstopRAnm,	//’âŽ~
	PCwalkUAnm, PCwalkDAnm, PCwalkLAnm, PCwalkRAnm,	//ˆÚ“®32
	PCwalkUAnm, PCwalkDAnm, PCwalkLAnm, PCwalkRAnm,	//ˆÚ“®16
	PCwalkUAnm, PCwalkDAnm, PCwalkLAnm, PCwalkRAnm,	//ˆÚ“®8
	PCrunUAnm, PCrunDAnm, PCrunLAnm, PCrunRAnm,		//ˆÚ“®4
	PCrunUAnm, PCrunDAnm, PCrunLAnm, PCrunRAnm,		//ˆÚ“®2
	PCrunUAnm, PCrunDAnm, PCrunLAnm, PCrunRAnm,		//ˆÚ“®6
	PCrunUAnm, PCrunDAnm, PCrunLAnm, PCrunRAnm,		//ˆÚ“®3
	PCrunUAnm, PCrunDAnm, PCrunLAnm, PCrunRAnm,		//ˆÚ“®7

	PCrunUAnm, PCrunDAnm, PCrunLAnm, PCrunRAnm,		//ƒ_ƒbƒVƒ…4
	...
	if( draw->init == FALSE ){
		...
		if( draw->anm_walk_stop_frame > 1 ){
			...
			if( draw->anm_status == DRAW_STA_DASH_4F &&
				...
				OS_Printf( "ƒ_ƒbƒVƒ…‚¾‚Á‚½‚¯‚Ç’âŽ~‚ª—ˆ‚½‚Å‚²‚´‚é\n" );
			}
