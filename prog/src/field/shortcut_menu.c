...
{ 
  ...
  //レジスタ設定
#ifdef BUGFIX_AF_GFBTS1918_20100915
  G2_SetBlendAlpha( GX_BLEND_PLANEMASK_BG1, GX_BLEND_PLANEMASK_BG0 | GX_BLEND_PLANEMASK_OBJ, 12, 4 );
#else //BUGFIX_AF_GFBTS1918_20100915
  G2_SetBlendAlpha( GX_BLEND_PLANEMASK_BG1, GX_BLEND_PLANEMASK_BG0, 12, 4 );
#endif //BUGFIX_AF_GFBTS1918_20100915
