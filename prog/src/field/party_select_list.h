...
extern SELECT_PARTY PARTY_SELECT_LIST_Exit(PARTY_SELECT_LIST_PTR psl, BOOL *ng_flag);
extern BOOL PARTY_SELECT_LIST_Main(PARTY_SELECT_LIST_PTR psl);
extern SELECT_PARTY PARTY_SELECT_LIST_GetSelect(PARTY_SELECT_LIST_PTR psl, BOOL *ng_flag);
