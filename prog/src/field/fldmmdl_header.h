...
typedef struct _TAG_FLDMMDL_SAVE_DATA * FLDMMDL_SAVE_DATA_PTR;
...
//--------------------------------------------------------------
///	FLDMMDL_SAVE_DATA構造体
//--------------------------------------------------------------
typedef struct _TAG_FLDMMDL_SAVE_DATA
{
...
#define FLDMMDL_SAVE_DATA_SIZE (sizeof(FLDMMDL_SAVE_DATA))	///<FLDMMDL_SAVE_DATA size

//--------------------------------------------------------------
///	FLDMMDL_SAVE_DATA構造体 old
//--------------------------------------------------------------
typedef struct _TAG_FLDMMDL_SAVE_DATA_OLD
{
	u32 status_bit;											///<ステータスビット
	u32 move_bit;											///<動作ビット
	u32 obj_id;												///<OBJ ID
	...
	u8 move_proc_work[FLDMMDL_MOVE_WORK_SIZE];				///<動作関数用ワーク
	u8 move_sub_proc_work[FLDMMDL_MOVE_SUB_WORK_SIZE];		///<動作サブ関数用ワーク
}FLDMMDL_SAVE_DATA_OLD;

#define FLDMMDL_SAVE_DATA_OLD_SIZE (sizeof(FLDMMDL_SAVE_DATA_OLD))
