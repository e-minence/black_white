...
#define WEATHER_RAIN_FOG_OFS		(32607)
#define WEATHER_RAIN_FOG_SLOPE	(8)
...
// ライカミ　雷
#define WEATHER_SPARK_DARK_COLOR   ( GX_RGB(9,9,12) )
...
#define WEATHER_RAIKAMI_SPARK_DARK_COLOR   ( GX_RGB(6,6,10) )
...
#define EVENING_RAIN_TIME_AREA_MIN  ( 7140 )  // 夕立が起きる時間　（夕方までの時間）
#define EVENING_RAIN_TIME_AREA  ( 7200 )  // 夕立が起きる時間　（夕方までの時間）
#define EVENING_RAIN_TIME_KIRAKIRA_AREA     ( 7080 )  // きらきらが終わるまでの定義 夕方になってから1時間
enum
{
  /* 天気種類郡 */
...
static WEATHER_TASK_FUNC_RESULT WEATHER_RAIN_Init( WEATHER_TASK* p_wk, WEATHER_TASK_FOG_MODE fog_cont, HEAPID heapID )
{
	...
	// フォグの設定
	WEATHER_TASK_FogSet( p_wk, WEATHER_RAIN_FOG_SLOPE, WEATHER_FOG_DEPTH_DEFAULT_START, fog_cont );
...
static WEATHER_TASK_FUNC_RESULT WEATHER_RAIN_FadeIn( WEATHER_TASK* p_wk, WEATHER_TASK_FOG_MODE fog_cont, HEAPID heapID )
{
	...
	if(p_local_wk->work[0] > 0){
		...
		if( p_local_wk->work[0] == 0 ){
			...
			WEATHER_RAIN_FOG_SLOPE, 
			WEATHER_RAIN_FOG_OFS, 
...
static WEATHER_TASK_FUNC_RESULT WEATHER_RAIN_NoFade( WEATHER_TASK* p_wk, WEATHER_TASK_FOG_MODE fog_cont, HEAPID heapID )
{
	...
	// フォグの設定
	WEATHER_TASK_FogSet( p_wk, WEATHER_RAIN_FOG_SLOPE, WEATHER_RAIN_FOG_OFS, fog_cont );
