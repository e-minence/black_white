...
#define DRAGON1_Z (28*FIELD_CONST_GRID_FX32_SIZE)
...
#define DRAGON3_Z (27*FIELD_CONST_GRID_FX32_SIZE)
...
#define BUTTON2_Z (26*FIELD_CONST_GRID_FX32_SIZE+GRID_HALF_SIZE)
