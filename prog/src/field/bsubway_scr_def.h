...
#define BSWTOOL_GET_WIFI_UPLOAD_FLAG (BSWTOOL_WIFI_START+3)
#define BSWTOOL_WIFI_CONNECT (BSWTOOL_WIFI_START+4)
...
#define BSWSUB_SET_BOSS_CLEAR_FLAG (BSWSUB_START+11)
#define BSWSUB_GET_BOSS_CLEAR_FLAG (BSWSUB_START+12)
