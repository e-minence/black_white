...
#define BSWTOOL_WIFI_RANK_DOWN (BSWTOOL_WIFI_START_NO+0)
#define BSWTOOL_GET_WIFI_RANK (BSWTOOL_WIFI_START_NO+1)
#define BSWTOOL_SET_WIFI_UPLOAD_FLAG (BSWTOOL_WIFI_START_NO+2)
#define BSWTOOL_GET_WIFI_UPLOAD_FLAG (BSWTOOL_WIFI_START_NO+3)
#define BSWTOOL_WIFI_CONNECT (BSWTOOL_WIFI_START_NO+4)
...
#define BSWSUB_END_NO (BSWSUB_START_NO+27)
