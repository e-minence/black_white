...
#define BSWSUB_CLEAR_STAGE_ROUND (BSWSUB_START_NO+49)
#define BSWSUB_END_NO (BSWSUB_START_NO+50)
...
#define BSWSUB_COMM_END_NO (BSWSUB_COMM_START_NO+11)
