...
#define BSWTOOL_SET_RECEIPT_MAP_LOCATION (BSWTOOL_START_NO+45)
#define BSWTOOL_END_NO (BSWTOOL_START_NO+46)
...
#define BSWSUB_COMM_CHK_BTLREC_VER (BSWSUB_COMM_START_NO+16)
#define BSWSUB_COMM_END_NO (BSWSUB_COMM_START_NO+17)
