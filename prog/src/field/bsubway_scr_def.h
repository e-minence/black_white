...
#define BSWTOOL_SET_BOSS_CLEAR_FLAG (17)
#define BSWTOOL_GET_SUPPORT_ENCOUNT_END (18)
#define BSWTOOL_SET_SUPPORT_ENCOUNT_END (19)
#define BSWTOOL_SET_TRAIN (20)
#define BSWTOOL_SET_TRAIN_ANM (21)
#define BSWTOOL_SET_TRAIN_VANISH (22)
#define BSWTOOL_GET_DATA_PLAY_MODE (23)
#define BSWTOOL_CHK_MODE_MULTI (24)
#define BSWTOOL_OBJ_HEIGHT_OFF (25)
#define BSWTOOL_OBJ_HEIGHT_ON (26)
#define BSWTOOL_CHK_EXIST_OBJ (27)
#define BSWTOOL_GET_HOME_NPC_MSGID (28)
...
#define BSWSUB_END_NO (BSWSUB_START_NO+39)
