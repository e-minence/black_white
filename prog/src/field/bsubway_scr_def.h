...
#define BSWSUB_CALL_BTLREC_EXIST (BSWSUB_START_NO+43)
#define BSWSUB_CHK_BTLREC_EXIST (BSWSUB_START_NO+44)
#define BSWSUB_STORE_BTLREC (BSWSUB_START_NO+45)
#define BSWSUB_SAVE_BTLREC (BSWSUB_START_NO+46)
#define BSWSUB_FREE_BTLPRM (BSWSUB_START_NO+47)
#define BSWSUB_END_NO (BSWSUB_START_NO+48)
