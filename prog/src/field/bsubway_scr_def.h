...
#define BSWTOOL_OBJ_VANISH (14)
#define BSWTOOL_GET_BOSS_CLEAR_FLAG (15)
#define BSWTOOL_SET_BOSS_CLEAR_FLAG (16)
#define BSWTOOL_GET_SUPPORT_ENCOUNT_END (17)
#define BSWTOOL_SET_SUPPORT_ENCOUNT_END (18)
#define BSWTOOL_SET_TRAIN (19)
#define BSWTOOL_SET_TRAIN_ANM (20)
#define BSWTOOL_SET_TRAIN_VANISH (21)
#define BSWTOOL_GET_DATA_PLAY_MODE (22)
#define BSWTOOL_CHK_MODE_MULTI (23)
#define BSWTOOL_OBJ_HEIGHT_OFF (24)
#define BSWTOOL_OBJ_HEIGHT_ON (25)
#define BSWTOOL_CHK_EXIST_OBJ (26)
#define BSWTOOL_GET_HOME_NPC_MSGID (27)
#define BSWTOOL_GET_WIFI_RANK (28)
#define BSWTOOL_UP_WIFI_RANK (29)
#define BSWTOOL_DOWN_WIFI_RANK (30)
#define BSWTOOL_GET_STAGE_NO (31)
#define BSWTOOL_GET_OBJCODE_PARTNER (32)
#define BSWTOOL_CHK_BTL_BOX_IN (33)
...
#define BSWSUB_END_NO (BSWSUB_START_NO+40)
...
#define BSWSUB_COMM_END_NO (BSWSUB_COMM_START_NO+10)
//バトルサブウェイコマンド　引数NULL
#define BSW_NULL (0)
