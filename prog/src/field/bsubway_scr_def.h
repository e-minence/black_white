...
#define BSWTOOL_CHK_HOME_NPC_GETITEM (39)
#define BSWTOOL_GET_HOME_NPC_GETITEM_MSGID_BEFORE (40)
#define BSWTOOL_GET_HOME_NPC_GETITEM_MSGID_AFTER (41)
#define BSWTOOL_GET_HOME_NPC_GETITEM_ITEMNO (42)
#define BSWTOOL_GET_LEADERDATA_DATANUM (43)
#define BSWTOOL_END_NO (44)
...
#define BSWSUB_END_NO (BSWSUB_START_NO+56)
