...
#define BSWTOOL_GET_BOSS_CLEAR_FLAG (16)
#define BSWTOOL_GET_S_BOSS_CLEAR_FLAG (17)
#define BSWTOOL_SET_BOSS_CLEAR_FLAG (18)
#define BSWTOOL_SET_S_BOSS_CLEAR_FLAG (19)
#define BSWTOOL_GET_SUPPORT_ENCOUNT_END (20)
#define BSWTOOL_SET_SUPPORT_ENCOUNT_END (21)
#define BSWTOOL_SET_TRAIN (22)
#define BSWTOOL_SET_TRAIN_ANM (23)
#define BSWTOOL_SET_TRAIN_VANISH (24)
#define BSWTOOL_GET_DATA_PLAY_MODE (25)
#define BSWTOOL_CHK_MODE_MULTI (26)
#define BSWTOOL_OBJ_HEIGHT_OFF (27)
#define BSWTOOL_OBJ_HEIGHT_ON (28)
#define BSWTOOL_CHK_EXIST_OBJ (29)
#define BSWTOOL_GET_HOME_NPC_MSGID (30)
#define BSWTOOL_GET_WIFI_RANK (31)
#define BSWTOOL_UP_WIFI_RANK (32)
#define BSWTOOL_DOWN_WIFI_RANK (33)
...
#define BSWTOOL_WIFI_END_NO (BSWTOOL_WIFI_START_NO+12)
...
#define BSWSUB_END_NO (BSWSUB_START_NO+35)
...
#define BSW_COMM_MULTI_SEND_MYST 10
