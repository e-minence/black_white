...
// 履歴の人の情報をWordSetに設定
extern void FIELD_WFBC_SetWordSetParentPlayer( FIELD_WFBC* p_wk, WORDSET* p_wordset, u32 npc_id, u32 word_set_idx, HEAPID heapID );

// バトルしたことを設定
extern void FIELD_WFBC_SetBattlePeople( FIELD_WFBC* p_wk, u32 npc_id );
extern BOOL FIELD_WFBC_IsBattlePeople( FIELD_WFBC* p_wk, u32 npc_id );
