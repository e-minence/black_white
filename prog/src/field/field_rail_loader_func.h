...
typedef enum
{
	...
	FIELD_RAIL_LOADER_CAMERA_FUNC_FIXANGLE_LINEWAY_CENTER,	// 進行方向に対するアングルを固定 ターゲットラインの中心
	FIELD_RAIL_LOADER_CAMERA_FUNC_STOPSCROLL_FIXANGLE_START,// カメラスクロール停止、始点　FIXアングル
	FIELD_RAIL_LOADER_CAMERA_FUNC_STOPSCROLL_FIXANGLE_END,// カメラスクロール停止、終点　FIXアングル
	FIELD_RAIL_LOADER_CAMERA_FUNC_OFSANGLE_NOT_TRACE,			// オフセットアングルカメラ	　カメラTRACEなし（ライン専用）
	FIELD_RAIL_LOADER_CAMERA_FUNC_FIXANGLE_CENTER,			// FIXアングルカメラ	　常に中心 カメラTRACEなし（ライン専用）
	FIELD_RAIL_LOADER_CAMERA_FUNC_OFSANGLE_CENTER,			// オフセットアングルカメラ	常に中心　カメラTRACEなし（ライン専用）
	FIELD_RAIL_LOADER_CAMERA_FUNC_FIXANGLE_TARGETOFFS,  // FIXアングルカメラ & ターゲットオフセット	
	FIELD_RAIL_LOADER_CAMERA_FUNC_OFSANGLE_TARGETOFFS,	// オフセットアングルカメラ	& ターゲットオフセット
	FIELD_RAIL_LOADER_CAMERA_FUNC_FIXANGLE_TARGETOFFS_NOT_TRACE,  // FIXアングルカメラ & ターゲットオフセット	TRACEなし
