...
/// DP　から移植　基本情報	
//=====================================
#define		WEATHER_FOG_DEPTH_DEFAULT	      ( 32640 )	// フォグデフォルト値
...
///	システム生成・破棄・メイン
//=====================================
extern WEATHER_TASK* WEATHER_TASK_Init( GFL_CLUNIT* p_clunit, const FIELD_CAMERA* cp_camera, FIELD_LIGHT* p_light, FIELD_FOG_WORK* p_fog, const FIELD_ZONEFOGLIGHT* cp_zonefog, FIELD_3DBG** pp_3dbg, FIELD_SOUND* p_sound, u16 season, HEAPID heapID ); // pp_3dbg　配列数はWEATHER_TASK_3DBG_NUM
