...
#define MATTR_NORMAL_02           (0x11)		//移動可能２
#define MATTR_NOT_MOVE_02         (0x12)		//移動不可２
...
#define MATTR_E_GRASS_LOW_02      (0x21)		//四季変化なし草むら弱
#define MATTR_E_GRASS_HIGH_02     (0x22)		//四季変化なし草むら強
#define MATTR_E_DESERT_02         (0x23)		//砂漠２（エンカウント）
...
#define MATTR_DIVING              (0x9c)		//ダイビング
#define MATTR_SLIP_01             (0xa0)		//滑り降り
#define MATTR_E_SLIP_01           (0xa1)		//エンカウント地点からの滑り降り
...
#define MATTR_BOOKSHELF_01        (0xd9)		//小さな本棚１
#define MATTR_BOOKSHELF_02        (0xda)		//小さな本棚２
#define MATTR_BOOKSHELF_03        (0xdb)		//大きな本棚１
#define MATTR_BOOKSHELF_04        (0xdc)		//大きな本棚２
#define MATTR_VASE_01             (0xdd)		//壷
#define MATTR_DUST_BOX            (0xde)		//ゴミ箱
#define MATTR_SHOPSHELF_01        (0xdf)		//普通の棚１
#define MATTR_SHOPSHELF_02        (0xe0)		//普通の棚２（カラーボックス）
#define MATTR_SHOPSHELF_03        (0xe1)		//普通の棚３（食器棚風）
