...
extern u32 FIELD_CAMERA_GetCameraType( const FIELD_CAMERA * camera );
...
extern const u16 * FIELD_CAMERA_GetAnglePitchAddress( const FIELD_CAMERA *camera );
...
//  WIPEを表示するひつようがあるか？
//------------------------------------------------------------------
extern BOOL FIELD_CAMERA_DEBUG_IsWipeDraw( const FIELD_CAMERA* camera);
