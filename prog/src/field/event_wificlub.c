...
#ifdef BUGFIX_BTS7931_20100726  //HEAPの断片化の修正
  pClub->pMatchParam->pPokeParty[0] = PokeParty_AllocPartyWork(GetHeapLowID( GFL_HEAPID_APP ));   //お互いのPartyを受信
  pClub->pMatchParam->pPokeParty[1] = PokeParty_AllocPartyWork(GetHeapLowID( GFL_HEAPID_APP ));   //お互いのPartyを受信
  pClub->pMatchParam->pRegulation = Regulation_AllocWork(GetHeapLowID( GFL_HEAPID_APP ));
#else  //BUGFIX_BTS7931_20100726  //HEAPの断片化の修正
...
#endif //BUGFIX_BTS7931_20100726  //HEAPの断片化の修正
