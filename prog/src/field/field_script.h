...
//	debug
//--------------------------------------------------------------
#define FLDSCRIPT_PL_NULL	//PL箇所無効化
#define DEBUG_FLDSCRIPT		//定義でデバッグ機能有効
...
//--------------------------------------------------------------
typedef	struct _TAG_FLDSCRIPT FLDSCRIPT;
 ...
 */
//--------------------------------------------------------------
extern void FLDSCRIPT_SetupScript(
 ...
 */
//--------------------------------------------------------------
extern void FLDSCRIPT_CallScript( GMEVENT *event,
 ...
 */
//--------------------------------------------------------------
extern void FLDSCRIPT_ChangeScript( GMEVENT *event,
 ...
 */
//--------------------------------------------------------------
extern VMHANDLE * FLDSCRIPT_AddVMachine(
 ...
 *
 * FLDSCRIPT_GetSubMemberWorkを使用してもよいが、内部構造が
 * 剥き出しになっているので４つのパラメータのみ専用関数を用意した
 */
//--------------------------------------------------------------
extern void FLDSCRIPT_SetParam(
 ...
 */
//--------------------------------------------------------------
extern void * FLDSCRIPT_GetSubMemberWork( FLDSCRIPT * sc, u32 id );
 ...
 */
//--------------------------------------------------------------
extern void * FLDSCRIPT_GetMemberWork( FLDSCRIPT *sc, u32 id );
...
extern void FLDSCRIPT_SetNextScript( FLDCOMMON_WORK* fsys );
#endif
 ...
 */
//------------------------------------------------------------------
extern u16 * FLDSCRIPT_GetEventWork( FLDCOMMON_WORK* fsys, u16 work_no );
 ...
 */
//------------------------------------------------------------------
extern u16 FLDSCRIPT_GetEventWorkValue( FLDCOMMON_WORK* fsys, u16 work_no );
 ...
 */
//------------------------------------------------------------------
extern BOOL FLDSCRIPT_SetEventWorkValue(
