	...
	static const SEQ_PARAM SeqParamTable[] = {
		{
			...
			WSEQ_SIMPLEEFFEX_ATK, WAZADATA_CATEGORY_SIMPLE_EFFECT, POKESICK_NULL, 
			{ { WAZA_RANKEFF_ATTACK, 2 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_NONE, 0,
		},{
			WSEQ_SIMPLEEFFEX_DEF, WAZADATA_CATEGORY_SIMPLE_EFFECT, POKESICK_NULL, 
			{ { WAZA_RANKEFF_DEFENCE, 2 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_NONE, 0,
		},{
			WSEQ_SIMPLEEFFEX_AGI, WAZADATA_CATEGORY_SIMPLE_EFFECT, POKESICK_NULL, 
			{ { WAZA_RANKEFF_AGILITY, 2 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_NONE, 0,
		},{
			WSEQ_SIMPLEEFFEX_SPATK, WAZADATA_CATEGORY_SIMPLE_EFFECT, POKESICK_NULL, 
			...
			WSEQ_SIMPLEEFFEX_DOWN_DEF, WAZADATA_CATEGORY_SIMPLE_EFFECT, POKESICK_NULL, 
			{ { WAZA_RANKEFF_DEFENCE, -2 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_NONE, 0,
		},{
			WSEQ_SIMPLEEFFEX_DOWN_AGI, WAZADATA_CATEGORY_SIMPLE_EFFECT, POKESICK_NULL, 
			{ { WAZA_RANKEFF_AGILITY, -2 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_NONE, 0,
		},{
			WSEQ_SIMPLEEFFEX_DOWN_SPDEF, WAZADATA_CATEGORY_SIMPLE_EFFECT, POKESICK_NULL, 
			{ { WAZA_RANKEFF_SP_DEFENCE, -2 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_NONE, 0,
		},{
			...
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			TRUE, BTL_WEATHER_NONE, 0,
		},{
				WSEQ_MUST_SHRINK, WAZADATA_CATEGORY_SIMPLE_DAMAGE, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			TRUE, BTL_WEATHER_NONE, 0,
		},{
				WSEQ_WEATHER_RAIN, WAZADATA_CATEGORY_WEATHER, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_RAIN, 0,
		},{
				WSEQ_WEATHER_SHINE, WAZADATA_CATEGORY_WEATHER, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SHINE, 0,
		},{
				WSEQ_WEATHER_STORM, WAZADATA_CATEGORY_WEATHER, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SAND, 0,
		},{
				WSEQ_WEATHER_SNOW, WAZADATA_CATEGORY_WEATHER, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SNOW, 0,
		},{
				WSEQ_REACT_A1, WAZADATA_CATEGORY_SIMPLE_DAMAGE, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SNOW, 25,
		},{
				WSEQ_REACT_B1, WAZADATA_CATEGORY_SIMPLE_DAMAGE, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SNOW, 33,
		},{
				WSEQ_REACT_B2, WAZADATA_CATEGORY_SIMPLE_DAMAGE, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SNOW, 33,
		},{
				WSEQ_REACT_B3, WAZADATA_CATEGORY_SIMPLE_DAMAGE, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SNOW, 33,
		},{
				WSEQ_REACT_C1, WAZADATA_CATEGORY_SIMPLE_DAMAGE, POKESICK_NULL, 
			{ { WAZA_RANKEFF_NULL, 0 }, { WAZA_RANKEFF_NULL, 0 } },
			FALSE, BTL_WEATHER_SNOW, 50,
		},
	};
