...
/*↑[GS_CONVERT_TAG]*/
	GFL_BG_SetBGControl( bgl, COMERRRST_TEXT_FRAME, &hd0, GFL_BG_MODE_TEXT );
/*↑[GS_CONVERT_TAG]*/
/*↑[GS_CONVERT_TAG]*/
	GFL_BG_ClearScreen( bgl, COMERRRST_TEXT_FRAME );	
/*↑[GS_CONVERT_TAG]*/
	//メッセージウインドウキャラ＆パレット読み込み
	BmpWinFrame_GraphicSet(	bgl, COMERRRST_TEXT_FRAME, 
/*↑[GS_CONVERT_TAG]*/
...
/*↑[GS_CONVERT_TAG]*/
	//メッセージデータ読み込み
	msgman = MSGMAN_Create( GflMsgLoadType_DIRECT, ARC_MSG, NARC_msg_communication_dat, heapID );
/*↑[GS_CONVERT_TAG]*/
