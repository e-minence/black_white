...
typedef struct _COMM_TOOL_WORK_t{
    ...
    //------------------  tempデータ用バッファ
    u8 tempWork[COMM_MACHINE_MAX][_TEMPDATA_SIZE+2];
...
//#ifdef PM_DEBUG
        {
            if((GFL_UI_KEY_GetTrg() == PAD_BUTTON_B) && (_keytrg==3)){
/*↑[GS_CONVERT_TAG]*/
                _keytrg = 4;
                Snd_SePlay(SEQ_SE_DP_DECIDE);
            }
            else if((GFL_UI_KEY_GetTrg() == PAD_BUTTON_B) && (_keytrg==2)){
/*↑[GS_CONVERT_TAG]*/
                _keytrg = 3;
            }
            else if((GFL_UI_KEY_GetTrg() == PAD_BUTTON_R) && (_keytrg==1)){
/*↑[GS_CONVERT_TAG]*/
                _keytrg = 2;
            }
            else if((GFL_UI_KEY_GetTrg() == PAD_BUTTON_L) && (_keytrg==0)){
/*↑[GS_CONVERT_TAG]*/
                _keytrg = 1;
            }
            else if((GFL_UI_KEY_GetTrg() == PAD_BUTTON_START) && (_keytrg < 4)){
/*↑[GS_CONVERT_TAG]*/
                _keytrg = 0;
            }

            if((GFL_UI_KEY_GetTrg() == PAD_BUTTON_L) && (_keytrg==4)){
/*↑[GS_CONVERT_TAG]*/
