	...
	case 1:
		{
			...
			setup_party( HEAPID_CORE, para->partyPlayer, MONSNO_GURAADON, MONSNO_PIKATYUU, MONSNO_YUKINOOO, 0 );
			setup_party( HEAPID_CORE, para->partyEnemy1, MONSNO_TEKKANIN, MONSNO_METAGUROSU, MONSNO_REKKUUZA, 0 );
			{
				#if 0
				// どくにしてみる
