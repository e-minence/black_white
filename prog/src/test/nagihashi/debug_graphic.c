 ...
 *	{	
 *	○概要
 *	debug_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	debug_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム debug, DEUBG -> config CONFIGなど
 ...
 */
//-----------------------------------------------------------------------------
DEUBG_GRAPHIC_WORK * DEUBG_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	DEUBG_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(DEUBG_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(DEUBG_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void DEUBG_GRAPHIC_Exit( DEUBG_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void DEUBG_GRAPHIC_2D_Draw( DEUBG_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void DEUBG_GRAPHIC_3D_StartDraw( DEUBG_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void DEUBG_GRAPHIC_3D_EndDraw( DEUBG_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * DEUBG_GRAPHIC_GetClunit( const DEUBG_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * DEUBG_GRAPHIC_GetCamera( const DEUBG_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	DEUBG_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
