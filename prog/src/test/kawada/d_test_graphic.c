...
#if 1
  // バトルの下画面
  // prog/src/battle/btlv/btlv_input.c  BTLV_INPUT_Init(BTLV_INPUT_InitEx)が設定してくれる
#endif
 ...
 */
//-----------------------------------------------------------------------------
D_TEST_GRAPHIC_WORK * D_TEST_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	D_TEST_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(D_TEST_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(D_TEST_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void D_TEST_GRAPHIC_Exit( D_TEST_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void D_TEST_GRAPHIC_2D_Draw( D_TEST_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void D_TEST_GRAPHIC_3D_StartDraw( D_TEST_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void D_TEST_GRAPHIC_3D_EndDraw( D_TEST_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * D_TEST_GRAPHIC_GetClunit( const D_TEST_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * D_TEST_GRAPHIC_GetCamera( const D_TEST_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	D_TEST_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
