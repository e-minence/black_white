...
static void	DrawObj
			( FLD_G3D_MAP* g3Dmap, const FLD_G3D_MAP_OBJ* obj, GFL_G3D_CAMERA* g3Dcamera );
static void	DirectDrawObj
			( FLD_G3D_MAP* g3Dmap, const FLD_G3D_MAP_DDOBJ* ddobj, GFL_G3D_CAMERA* g3Dcamera );
 ...
 */
//------------------------------------------------------------------
FLD_G3D_MAP*	FLD_G3D_MAP_Create( FLD_G3D_MAP_SETUP* setup, HEAPID heapID )
{
	...
	case LOAD_END:
		...
		if( g3Dmap->trans.y == 0 ){
			...
			for( i=0; i<4; i++ ){
				...
				FLD_G3D_MAP_GetAttr( &attrInfo, g3Dmap, &pWorld, mapWidth );
 ...
 */
//------------------------------------------------------------------
void	FLD_G3D_MAP_SetLoadReq( FLD_G3D_MAP* g3Dmap,
 ...
 */
//------------------------------------------------------------------
void FLD_G3D_MAP_GetAttr( FLD_G3D_MAP_ATTRINFO* attrInfo, const FLD_G3D_MAP* g3Dmap,
