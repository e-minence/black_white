...
extern void * SaveData_Extra_Mirror_LoadAlloc(
		SAVEDATA *sv, int heap_id, EXDATA_ID id, LOAD_RESULT * result, BOOL *old);
extern SAVE_RESULT SaveData_Extra_Mirror_Save(SAVEDATA * sv, EXDATA_ID id, void * data);
