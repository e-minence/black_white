...
static const u8 INFOWIN_GPFSYNC_DRAW_X = 14;
static const u8 INFOWIN_GPFSYNC_DRAW_WIDTH = 6;

static const u8 INFOWIN_IR_DRAW_X = 20;
static const u8 INFOWIN_IR_DRAW_WIDTH = 2;

static const u8 INFOWIN_WIFI_DRAW_X = 22;
static const u8 INFOWIN_WIFI_DRAW_WIDTH = 4;

static const u8 INFOWIN_BEACON_DRAW_X = 26;
...
enum
{
	INFOWIN_REFRESH_TIME		= 0x01,
	INFOWIN_REFRESH_GPF_SYNC	= 0x02,
	INFOWIN_REFRESH_IR			= 0x04,
	INFOWIN_REFRESH_WIFI		= 0x08,
	INFOWIN_REFRESH_BEACON		= 0x10,

	INFOWIN_DISP_GPF_SYNC	= 0x20,
	INFOWIN_DISP_IR			= 0x40,
	INFOWIN_DISP_BEACON		= 0x80,
	
	INFOWIN_REFRESH_MASK = 0x1F,
	INFOWIN_DISP_MASK = 0xE0,
	INFOWIN_FLG_NULL = 0x00,
};
