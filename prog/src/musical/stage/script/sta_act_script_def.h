...
extern void  STA_ACT_ReadyBgm( ACTING_WORK *work , const u16 seqNo );
extern void  STA_ACT_StartBgm(  ACTING_WORK *work , const u16 seqNo );
extern void  STA_ACT_StopBgm(  ACTING_WORK *work );
extern void  STA_ACT_SetBgmLinkNumber(  ACTING_WORK *work ,const u16 arcNum , const u16 dstNum , const u16 srcNum );
