  ...
  { 
    ...
    case SEQ_TOUCH:
      { 
        ...
        {	
          if( GFL_CLACT_WK_GetAnmSeq( p_wk->p_scale) == 7 ) //拡大
          { 
 ...
 *	@param	const PLACE_DATA *cp_wk   ワーク
 *
 *	@return TRUEで名所を表示してよい  FALSEはダメ
 */
//-----------------------------------------------------------------------------
static BOOL PLACEDATA_IsVisiblePlaceName( const PLACE_DATA *cp_wk )
{ 
