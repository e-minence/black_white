...
static BOOL keycheck_category_group_mode( PMS_INPUT_WORK* wk )
{
	static const struct {
		...
		{ CATEGORY_POS_BACK,		CATEGORY_GROUP_TRAINER,	CATEGORY_GROUP_SKILL,	  CATEGORY_GROUP_STATUS },	// ポケモン
		{ CATEGORY_POS_BACK,	  CATEGORY_GROUP_UNION,	  CATEGORY_GROUP_POKEMON,	CATEGORY_GROUP_SKILL },	  // ステータス
		{ CATEGORY_POS_BACK,		CATEGORY_GROUP_GREET,	  CATEGORY_GROUP_STATUS,  CATEGORY_GROUP_POKEMON },	// わざ
	  ...
	  { CATEGORY_GROUP_PERSON,	CATEGORY_POS_BACK,		CATEGORY_GROUP_PICTURE,	CATEGORY_GROUP_PICTURE },	// ピクチャ
