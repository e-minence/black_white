...
static const struct {
  ...
  // X改行
	...
	{ L'ひ',  INITIAL_XPOS(7),  INITIAL_YPOS(0), INI_BACK,  INI_MI,    INI_HA,    INI_HU,   INI_HI,  INI_BOU, },
	{ L'ふ',  INITIAL_XPOS(8),  INITIAL_YPOS(0), INI_BACK,  INI_MU,    INI_HI,    INI_HE,   INI_HU,  INI_OTHER, },
	...
	{ L'み',  INITIAL_XPOS(7),  INITIAL_YPOS(1), INI_HI,    INI_YU,    INI_MA,    INI_MU,   INI_HI,  INI_BOU, },
	{ L'む',  INITIAL_XPOS(8),  INITIAL_YPOS(1), INI_HU,    INI_YO,    INI_MI,    INI_ME,   INI_HU,  INI_OTHER, },
	...
	{ L'ゆ',  INITIAL_XPOS(7), INITIAL_YPOS(2), INI_MI,     INI_RI,    INI_YA,    INI_YO,   INI_HI,  INI_BOU, },
  ...
  { L'わ',  INITIAL_XPOS(6), INITIAL_YPOS(4), INI_RA,     INI_BACK,  INI_NO,    INI_BOU,   INI_HA,  INI_WA, },
