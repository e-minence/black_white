...
static const struct {
	...
	{ L'あ',  INITIAL_XPOS(0),  INITIAL_YPOS(0), INI_BACK,  INI_KA,    INI_HO,    INI_I,     INI_A,   INI_NA, },
	{ L'い',  INITIAL_XPOS(1),  INITIAL_YPOS(0), INI_BACK,  INI_KI,    INI_A,     INI_U,     INI_I,   INI_NI, },
	{ L'う',  INITIAL_XPOS(2),  INITIAL_YPOS(0), INI_BACK,  INI_KU,    INI_I,     INI_E,     INI_U,   INI_NU, },
	{ L'え',  INITIAL_XPOS(3),  INITIAL_YPOS(0), INI_BACK,  INI_KE,    INI_U,     INI_O,     INI_E,   INI_NE, },
	{ L'お',  INITIAL_XPOS(4),  INITIAL_YPOS(0), INI_BACK,  INI_KO,    INI_E,     INI_HA,    INI_O,   INI_NO, },
	...
	{ L'な',  INITIAL_XPOS(0),  INITIAL_YPOS(4), INI_TA,    INI_BACK,  INI_OTHER, INI_NI,    INI_A,  INI_NA, },
	{ L'に',  INITIAL_XPOS(1),  INITIAL_YPOS(4), INI_TI,    INI_BACK,  INI_NA,    INI_NU,    INI_I,  INI_NI, },
	{ L'ぬ',  INITIAL_XPOS(2),  INITIAL_YPOS(4), INI_TU,    INI_BACK,  INI_NI,    INI_NE,    INI_U,  INI_NU, },
	{ L'ね',  INITIAL_XPOS(3),  INITIAL_YPOS(4), INI_TE,    INI_BACK,  INI_NU,    INI_NO,    INI_E,  INI_NE, },
	{ L'の',  INITIAL_XPOS(4),  INITIAL_YPOS(4), INI_TO,    INI_BACK,  INI_NE,    INI_WA,    INI_O,  INI_NO, },

  // X改行

	{ L'は',  INITIAL_XPOS(6),  INITIAL_YPOS(0), INI_BACK,  INI_MA,    INI_O,     INI_HI,   INI_HA,  INI_WA, },
	{ L'ひ',  INITIAL_XPOS(7),  INITIAL_YPOS(0), INI_BACK,  INI_MI,    INI_HA,    INI_HU,   INI_HI,  INI_OTHER, },
	{ L'ふ',  INITIAL_XPOS(8),  INITIAL_YPOS(0), INI_BACK,  INI_MU,    INI_HI,    INI_HE,   INI_HU,  INI_RU, },
	{ L'へ',  INITIAL_XPOS(9),  INITIAL_YPOS(0), INI_BACK,  INI_ME,    INI_HU,    INI_HO,   INI_HE,  INI_RE, },
	{ L'ほ',  INITIAL_XPOS(10), INITIAL_YPOS(0), INI_BACK,  INI_MO,    INI_HE,    INI_A,    INI_HO,  INI_RO, },

	{ L'ま',  INITIAL_XPOS(6),  INITIAL_YPOS(1), INI_HA,    INI_YA,    INI_KO,    INI_MI,   INI_HA,  INI_WA, },
	{ L'み',  INITIAL_XPOS(7),  INITIAL_YPOS(1), INI_HI,    INI_YU,    INI_MA,    INI_MU,   INI_HI,  INI_OTHER, },
	{ L'む',  INITIAL_XPOS(8),  INITIAL_YPOS(1), INI_HU,    INI_YO,    INI_MI,    INI_ME,   INI_HU,  INI_RU, },
	{ L'め',  INITIAL_XPOS(9),  INITIAL_YPOS(1), INI_HE,    INI_RE,    INI_MU,    INI_MO,   INI_HE,  INI_RE, },
	{ L'も',  INITIAL_XPOS(10), INITIAL_YPOS(1), INI_HO,    INI_RO,    INI_ME,    INI_KA,   INI_HO,  INI_RO, },

	{ L'や',  INITIAL_XPOS(6), INITIAL_YPOS(2), INI_MA,     INI_RA,    INI_SO,    INI_YU,   INI_HA,  INI_WA, },
	{ L'ゆ',  INITIAL_XPOS(7), INITIAL_YPOS(2), INI_MI,     INI_RI,    INI_YA,    INI_YO,   INI_HI,  INI_OTHER, },
	{ L'よ',  INITIAL_XPOS(8), INITIAL_YPOS(2), INI_MU,     INI_RU,    INI_YU,    INI_SA,   INI_HU,  INI_RU, },

	{ L'ら',  INITIAL_XPOS(6),  INITIAL_YPOS(3), INI_YA,    INI_WA,    INI_TO,    INI_RI,    INI_HA,  INI_WA, },
	{ L'り',  INITIAL_XPOS(7),  INITIAL_YPOS(3), INI_YU,    INI_OTHER, INI_RA,    INI_RU,    INI_HI,  INI_OTHER, },
	{ L'る',  INITIAL_XPOS(8),  INITIAL_YPOS(3), INI_YO,    INI_BACK,  INI_RI,    INI_RE,    INI_HU,  INI_RU, },
  ...
  { L'わ',  INITIAL_XPOS(6), INITIAL_YPOS(4), INI_RA,     INI_BACK,  INI_NO,    INI_OTHER, INI_HA,  INI_WA, },
	{ L'！',  INITIAL_XPOS(7), INITIAL_YPOS(4), INI_RI,     INI_BACK,  INI_WA,    INI_NA,    INI_HI,  INI_OTHER },
};
