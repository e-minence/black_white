...
*/
		BOX2UI_CursorMoveChange( syswk, BOX2UI_INIT_ID_ARRANGE_MOVE, 0 );
		syswk->next_seq = BOX2SEQ_MAINSEQ_ARRANGE_POKEGET_MAIN;
	}
...
//		PMSND_PlaySE( SE_BOX2_CLOSE_PARTY_TRAY );
...
//			PMSND_PlaySE( SE_BOX2_DISABLE_BUTTON );
