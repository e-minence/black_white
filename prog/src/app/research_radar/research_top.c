...
// 全画面共通ワーク
static RESEARCH_COMMON_WORK* GetCommonWork( const RRT_WORK* work ); // 全画面共通ワークを取得する
static void SetCommonWork( RRT_WORK* work, RESEARCH_COMMON_WORK* commonWork ); // 全画面共通ワークを設定する
// ヒープID
