...
#define TITLE_STRING_OFFSET_Y (0)   // 文字列の書き込み先オフセットY
#define TITLE_STRING_COLOR_L  (1)   // フォント (文字) のカラー番号
#define TITLE_STRING_COLOR_S  (2)   // フォント (影)　 のカラー番号
#define TITLE_STRING_COLOR_B  (0)   // フォント (背景) のカラー番号

// 上画面 調査項目の補足文
#define TOPIC_CAPTION_X               (0)   // X座標   (キャラクター単位)
#define TOPIC_CAPTION_Y               (3)   // Y座標   (キャラクター単位)
#define TOPIC_CAPTION_WIDTH           (32)  // Xサイズ (キャラクター単位)
#define TOPIC_CAPTION_HEIGHT          (3)   // Yサイズ (キャラクター単位)
...
#define QUESTION_CAPTION_Y               (6)   // Y座標   (キャラクター単位)
...
#define QUESTION_CAPTION_STRING_COLOR_L  (1)   // フォント (文字) のカラー番号
#define QUESTION_CAPTION_STRING_COLOR_S  (2)   // フォント (影)　 のカラー番号
...
#define QUESTION_STRING_OFFSET_Y (0)   // 文字列の書き込み先オフセットY
