...
static void SetTopicButtonSelected   ( const RESEARCH_SELECT_WORK* work, u8 topicID ); // 選択されている状態にする
static void SetTopicButtonNotSelected( const RESEARCH_SELECT_WORK* work ); // 選択されていない状態にする
...
static void UpdateTopicSelectIcon( const RESEARCH_SELECT_WORK* work ); // 調査項目選択アイコンの表示状態を更新する
...
static void FinishSequence_SETUP( RESEARCH_SELECT_WORK* work )
{
  ...
  if( nowTopicID != INVESTIGATING_QUESTION_NULL ) {
    // 調査中の項目を選択状態にする
    SetTopicButtonSelected( work, nowTopicID ); // 選択している状態にする
...
//----------------------------------------------------------------------------------------------
/**
 * @brief 調査項目のボタンを 選択された状態にする
 *
 * @param work
 * @param topicID 選択状態にする調査項目のID
 */
//----------------------------------------------------------------------------------------------
