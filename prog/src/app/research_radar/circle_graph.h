...
extern BOOL CIRCLE_GRAPH_IsAnime( const CIRCLE_GRAPH* graph ); // アニメーション中かどうかを判定する
extern void CIRCLE_GRAPH_GetComponentPointPos( const CIRCLE_GRAPH* graph, u8 componentID, int* destX, int* destY ); // 矢印が指し示すべき座標を取得する
