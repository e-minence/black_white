...
static RESEARCH_COMMON_WORK* GetCommonWork( const RRG_WORK* work ); // 全画面共通ワークを取得する
static void SetCommonWork( RRG_WORK* work, RESEARCH_COMMON_WORK* commonWork ); // 全画面共通ワークを設定する
// 調査データ表示タイプ
...
//-----------------------------------------------------------------------------------------
/**
 * @brief 状態を初期化する ( ==> RRG_STATE_SETUP )
 *
 * @param work
 */
//-----------------------------------------------------------------------------------------
