...
static void SubBG_BackGround_Setup( HEAPID heapID )
{
  ...
  GFL_BG_SetVisible( SUB_BG_BACK_GROUND, TRUE );
  ...
  // データ読み込み
  {
    ...
    // パレットデータ
    {
      ...
      datID = NARC_research_radar_radar_NCLR;
      src   = GFL_ARC_LoadDataAllocByHandle( handle, datID, heapID );
      NNS_G2dGetUnpackedPaletteData( src, &data );
      GFL_BG_LoadPalette( SUB_BG_BACK_GROUND, data->pRawData, 
                          ONE_PALETTE_SIZE * SUB_BG_BACK_GROUND_PLT_NUM, 
                          ONE_PALETTE_SIZE * SUB_BG_BACK_GROUND_FIRST_PLT_IDX );
    ...
    // キャラクタデータ
    {
      ...
      datID = NARC_research_radar_radar_NCGR;
      src   = GFL_ARC_LoadDataAllocByHandle( handle, datID, heapID );
    ...
    // スクリーンデータ
    {
      ...
      datID = NARC_research_radar_radar_NSCR;
      src   = GFL_ARC_LoadDataAllocByHandle( handle, datID, heapID );
