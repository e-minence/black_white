 ...
 *	{	
 *	○概要
 *	pms_select_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	pms_select_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム pms_select, PMS_SELECT -> config CONFIGなど
...
{	
	...
	{	
		GFL_BG_FRAME1_S,	//設定するフレーム
		{
			0, 0, 0x800, 0,	//X,Y,ｽｸﾘｰﾝﾊﾞｯﾌｧ、ｽｸﾘｰﾝｵﾌｾｯﾄ
			GFL_BG_SCRSIZ_256x256, GX_BG_COLORMODE_16,	//ｽｸﾘｰﾝｻｲｽﾞ、ｶﾗｰﾓｰﾄﾞ
			GX_BG_SCRBASE_0x1000, GX_BG_CHARBASE_0x0c000, GFL_BG_CHRSIZ_256x256,//ｽｸﾘｰﾝﾍﾞｰｽ、ｷｬﾗﾍﾞｰｽ、ｷｬﾗｻｲｽﾞ
			GX_BG_EXTPLTT_01, 0, 0, 0, FALSE//拡張ﾊﾟﾚｯﾄｽﾛｯﾄ、表示優先度、ｴﾘｱｵｰﾊﾞｰ、ﾀﾞﾐｰ、ﾓｻﾞｲｸﾌﾗｸﾞ
		},
		GFL_BG_MODE_TEXT,//BGの種類
		TRUE,	//初期表示
...
///	グラフィックメインワーク
//=====================================
struct _PMS_SELECT_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
PMS_SELECT_GRAPHIC_WORK * PMS_SELECT_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	PMS_SELECT_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(PMS_SELECT_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(PMS_SELECT_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void PMS_SELECT_GRAPHIC_Exit( PMS_SELECT_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void PMS_SELECT_GRAPHIC_2D_Draw( PMS_SELECT_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * PMS_SELECT_GRAPHIC_GetClunit( const PMS_SELECT_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * PMS_SELECT_GRAPHIC_GetCamera( const PMS_SELECT_GRAPHIC_WORK *cp_wk )
{	
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	PMS_SELECT_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
