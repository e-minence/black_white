 ...
 */
//-----------------------------------------------------------------------------
MANUAL_GRAPHIC_WORK * MANUAL_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	MANUAL_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(MANUAL_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(MANUAL_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void MANUAL_GRAPHIC_Exit( MANUAL_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void MANUAL_GRAPHIC_2D_Draw( MANUAL_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void MANUAL_GRAPHIC_3D_StartDraw( MANUAL_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void MANUAL_GRAPHIC_3D_EndDraw( MANUAL_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * MANUAL_GRAPHIC_GetClunit( const MANUAL_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * MANUAL_GRAPHIC_GetCamera( const MANUAL_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	MANUAL_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
