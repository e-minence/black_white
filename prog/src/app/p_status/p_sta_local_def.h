...
#define PSTATUS_OBJPLT_IJYOU (0x4)  //1本
#define PSTATUS_OBJPLT_POKERUSU (0x5)  //1本
#define PSTATUS_OBJPLT_MARK (0x6)  //1本
#define PSTATUS_OBJPLT_BALL (0x7)  //1本
#define PSTATUS_OBJPLT_POKE_TYPE (0x8)  //3本
#define PSTATUS_OBJPLT_SKILL_PLATE (0xb)  //2本
#define PSTATUS_OBJPLT_RIBBON_BAR (0xd)
#define PSTATUS_OBJPLT_CURSOR_COMMON (0xe)
