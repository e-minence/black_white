...
///	グラフィックメインワーク
//=====================================
struct _SUBWAY_MAP_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
SUBWAY_MAP_GRAPHIC_WORK * SUBWAY_MAP_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	SUBWAY_MAP_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(SUBWAY_MAP_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(SUBWAY_MAP_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void SUBWAY_MAP_GRAPHIC_Exit( SUBWAY_MAP_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void SUBWAY_MAP_GRAPHIC_2D_Draw( SUBWAY_MAP_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void SUBWAY_MAP_GRAPHIC_3D_StartDraw( SUBWAY_MAP_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void SUBWAY_MAP_GRAPHIC_3D_EndDraw( SUBWAY_MAP_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * SUBWAY_MAP_GRAPHIC_GetClunit( const SUBWAY_MAP_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * SUBWAY_MAP_GRAPHIC_GetCamera( const SUBWAY_MAP_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	SUBWAY_MAP_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
