...
#define UN_SELECT_MCSS
#define UN_SELECT_TASKMENU
#define UN_SELECT_TYPEICON      // 分類、技アイコン
#define UN_SELECT_ITEM_ICON     // どうぐアイコン
#define UN_SELECT_POKE_ICON     // ポケアイコン(ポケアイコン用アイテムアイコン込み)
#define UN_SELECT_OAM_MAPMODEL  // マップモデルをOAMで表示
#define UN_SELECT_POKE2D				// ポケモンBG,OBJ読みこみ
#define UN_SELECT_BALL					// ボールアイコン読みこみ
#define UN_SELECT_PMSDRAW       // 簡易会話表示
...
#ifdef UN_SELECT_PMSDRAW
#define UN_SELECT_PMSDRAW_NUM (3) ///< 簡易会話の個数
#endif // UN_SELECT_PMSDRAW 
...
#ifdef UN_SELECT_MCSS
	//MCSS
	MCSS_SYS_WORK							*mcss_sys;
	MCSS_WORK									*mcss_wk;
#endif //UN_SELECT_MCSS
...
#ifdef UN_SELECT_TYPEICON
	//分類、技アイコン
  UI_EASY_CLWK_RES      clres_type_icon;
  GFL_CLWK                  *clwk_type_icon;
#endif //UN_SELECT_TYPEICON

#ifdef UN_SELECT_ITEM_ICON
  // どうぐアイコン
  UI_EASY_CLWK_RES      clres_item_icon;
  GFL_CLWK                  *clwk_item_icon;
#endif //UN_SELECT_ITEM_ICON

#ifdef UN_SELECT_POKE_ICON
  // ポケアイコン
...
#endif //UN_SELECT_POKE_ICON

#ifdef UN_SELECT_OAM_MAPMODEL
  // OAMマップモデル
  UI_EASY_CLWK_RES      clres_oam_mmdl;
  GFL_CLWK                  *clwk_oam_mmdl;
#endif //UN_SELECT_OAM_MAPMODEL

#ifdef UN_SELECT_POKE2D
	u32												ncg_poke2d;
	u32												ncl_poke2d;
	u32												nce_poke2d;
	GFL_CLWK									*clwk_poke2d;
#endif //UN_SELECT_POKE2D

#ifdef UN_SELECT_BALL
  // ボールアイコン
  UI_EASY_CLWK_RES      clres_ball;
  GFL_CLWK                  *clwk_ball;
#endif //UN_SELECT_BALL

#ifdef	UN_SELECT_PRINT_TOOL
	//プリントユーティリティ
	PRINT_UTIL								print_util;
	u32												seq;
#endif	//UN_SELECT_PRINT_TOOL

#ifdef UN_SELECT_PMSDRAW
  GFL_BMPWIN*               pms_win[ UN_SELECT_PMSDRAW_NUM ];
...
//以下カスタムボタン使用サンプル用
static TOUCHBAR_WORK * UNSelect_TOUCHBAR_InitEx( UN_SELECT_MAIN_WORK *wk, GFL_CLUNIT *clunit, HEAPID heapID );
static void UNSelect_TOUCHBAR_ExitEx( UN_SELECT_MAIN_WORK *wk );
#endif //UN_SELECT_TOUCHBAR
...
///	MCSS
//=====================================
static MCSS_SYS_WORK * UNSelect_MCSS_Init( u16 wk_max, HEAPID heapID );
static void UNSelect_MCSS_Exit( MCSS_SYS_WORK * mcss );
static void UNSelect_MCSS_Draw( MCSS_SYS_WORK * mcss );
static MCSS_WORK * UNSelect_MCSS_CreateWkPP( MCSS_SYS_WORK * mcss, POKEMON_PARAM *pp, const VecFx32 *pos );
static void UNSelect_MCSS_DeleteWk( MCSS_SYS_WORK * mcss, MCSS_WORK *wk );
#endif //UN_SELECT_MCSS
...
///	分類、技アイコン
//=====================================
static void UNSelect_TYPEICON_CreateCLWK( UN_SELECT_MAIN_WORK *wk, PokeType type, GFL_CLUNIT *unit, HEAPID heapID );
static void UNSelect_TYPEICON_DeleteCLWK( UN_SELECT_MAIN_WORK *wk );
#endif //UN_SELECT_TYPEICON
...
///	どうぐアイコン
//=====================================
static void UNSelect_ITEM_ICON_CreateCLWK( UN_SELECT_MAIN_WORK* wk, u16 item_id, GFL_CLUNIT* unit, HEAPID heapID );
static void UNSelect_ITEM_ICON_DeleteCLWK( UN_SELECT_MAIN_WORK* wk );
#endif //UN_SELECT_ITEM_ICON
...
///	ポケアイコン
//=====================================
static void UNSelect_POKE_ICON_CreateCLWK( UN_SELECT_MAIN_WORK* wk, u32 mons, u32 form_no, BOOL egg, GFL_CLUNIT* unit, HEAPID heapID );
static void UNSelect_POKE_ICON_DeleteCLWK( UN_SELECT_MAIN_WORK* wk );
#endif //UN_SELECT_POKE_ICON
...
///	OAMでマップモデル表示
//=====================================
static void UNSelect_OAM_MAPMODEL_CreateCLWK( UN_SELECT_MAIN_WORK *wk, u16 tex_idx, u8 ptn_ofs, GFL_CLUNIT *unit, HEAPID heapID );
static void UNSelect_OAM_MAPMODEL_DeleteCLWK( UN_SELECT_MAIN_WORK* wk );
#endif //UN_SELECT_OAM_MAPMODEL
...
///	ポケモンOBJ,BG読みこみ
//=====================================
static void UNSelect_POKE2D_LoadResourceBG( UN_SELECT_MAIN_WORK *wk, HEAPID heapID );
static void UNSelect_POKE2D_UnLoadResourceBG( UN_SELECT_MAIN_WORK *wk );
static void UNSelect_POKE2D_LoadResourceOBJ( UN_SELECT_MAIN_WORK *wk, HEAPID heapID );
static void UNSelect_POKE2D_UnLoadResourceOBJ( UN_SELECT_MAIN_WORK *wk );
static void UNSelect_POKE2D_CreateCLWK( UN_SELECT_MAIN_WORK *wk, GFL_CLUNIT *clunit, HEAPID heapID );
static void UNSelect_POKE2D_DeleteCLWK( UN_SELECT_MAIN_WORK *wk );
#endif //UN_SELECT_POKE2D
...
///	ボールアイコン
//=====================================
static void UNSelect_BALLICON_CreateCLWK( UN_SELECT_MAIN_WORK *wk, BALL_ID ballID, GFL_CLUNIT *unit, HEAPID heapID );
static void UNSelect_BALLICON_DeleteCLWK( UN_SELECT_MAIN_WORK* wk );
#endif //UN_SELECT_BALL
...
///	簡易会話表示
//=====================================
static void UNSelect_PMSDRAW_Init( UN_SELECT_MAIN_WORK* wk );
static void UNSelect_PMSDRAW_Exit( UN_SELECT_MAIN_WORK* wk );
static void UNSelect_PMSDRAW_Proc( UN_SELECT_MAIN_WORK* wk );
#endif // UN_SELECT_PMSDRAW
...
static GFL_PROC_RESULT UNSelectProc_Init( GFL_PROC *proc, int *seq, void *pwk, void *mywk )
{
  ...
  wk->heapID = HEAPID_UN_SELECT;
	...
	{	
		...
		wk->touchbar	= UNSelect_TOUCHBAR_InitEx( wk, clunit, wk->heapID );
	}
#endif //UN_SELECT_TOUCHBAR

#ifdef UN_SELECT_MCSS
	//MCSS初期化&ワーク作成
	wk->mcss_sys	= UNSelect_MCSS_Init( 1, wk->heapID );
	{
		POKEMON_PARAM	*pp;  
		VecFx32 pos	= { 0, -FX32_ONE*10, 0	};

		pp	= PP_Create( MONSNO_HUSIGIBANA, 0, 0, wk->heapID );
		wk->mcss_wk		= UNSelect_MCSS_CreateWkPP( wk->mcss_sys, pp, &pos );
	...
	{	
		GFL_CLUNIT	*clunit	= UN_SELECT_GRAPHIC_GetClunit( wk->graphic );
		UNSelect_TYPEICON_CreateCLWK( wk, POKETYPE_KUSA, clunit, wk->heapID );
	}
#endif //UN_SELECT_TYPEICON
  ...
  //OAMマップモデルの読み込み
  {
    ...
    u16 ptn_ofs = 3;
		...
		UNSelect_OAM_MAPMODEL_CreateCLWK( wk, NARC_fldmmdl_mdlres_hero_nsbtx, ptn_ofs, clunit, wk->heapID );
  }
#endif //UN_SELECT_OAM_MAPMODEL
  ...
  {
		GFL_CLUNIT	*clunit	= UN_SELECT_GRAPHIC_GetClunit( wk->graphic );
    UNSelect_POKE_ICON_CreateCLWK( wk, MONSNO_HUSIGIDANE, 0, FALSE, clunit, wk->heapID );
  }
#endif //UN_SELECT_POKE_ICON
  ...
  { 
		GFL_CLUNIT	*clunit	= UN_SELECT_GRAPHIC_GetClunit( wk->graphic );
    UNSelect_ITEM_ICON_CreateCLWK( wk, ITEM_KIZUGUSURI, clunit, wk->heapID );
  }
#endif //UN_SELECT_ITEM_ICON

#ifdef UN_SELECT_POKE2D
	//ポケモンOBJ,BG読みこみ
	UNSelect_POKE2D_LoadResourceBG( wk, wk->heapID );
	{	
		GFL_CLUNIT *clunit = UN_SELECT_GRAPHIC_GetClunit( wk->graphic );
		UNSelect_POKE2D_LoadResourceOBJ( wk, wk->heapID );
		UNSelect_POKE2D_CreateCLWK( wk, clunit, wk->heapID );
	}
#endif //UN_SELECT_POKE2D
  ...
  { 
		GFL_CLUNIT	*clunit	= UN_SELECT_GRAPHIC_GetClunit( wk->graphic );
    UNSelect_BALLICON_CreateCLWK( wk, BALLID_MONSUTAABOORU, clunit, wk->heapID );
  }
#endif //UN_SELECT_BALL

#ifdef UN_SELECT_PMSDRAW  
  UNSelect_PMSDRAW_Init( wk );
#endif //UN_SELECT_PMSDRAW
...
#ifdef UN_SELECT_BALL
  // どうぐアイコンの破棄
   UNSelect_BALLICON_DeleteCLWK( wk );
#endif //UN_SELECT_BALL

#ifdef UN_SELECT_POKE2D
	UNSelect_POKE2D_DeleteCLWK( wk );
	UNSelect_POKE2D_UnLoadResourceOBJ( wk );
	UNSelect_POKE2D_UnLoadResourceBG( wk );
#endif //UN_SELECT_POKE2D

#ifdef UN_SELECT_TYPEICON
	//属性アイコンの破棄
	UNSelect_TYPEICON_DeleteCLWK( wk );
#endif //UN_SELECT_TYPEICON
...
#ifdef UN_SELECT_ITEM_ICON
  //どうぐアイコンの破棄
  UNSelect_ITEM_ICON_DeleteCLWK( wk );
#endif //UN_SELECT_ITEM_ICON

#ifdef UN_SELECT_OAM_MAPMODEL
  //OAMマップモデルの破棄
  UNSelect_OAM_MAPMODEL_DeleteCLWK( wk );
#endif //UN_SELECT_OAM_MAPMODEL

#ifdef UN_SELECT_POKE_ICON
   UNSelect_POKE_ICON_DeleteCLWK( wk );
#endif //UN_SELECT_POKE_ICON
...
#ifdef UN_SELECT_MCSS
	//MCSS破棄
	UNSelect_MCSS_DeleteWk( wk->mcss_sys, wk->mcss_wk );
	UNSelect_MCSS_Exit( wk->mcss_sys );
#endif //UN_SELECT_MCSS

#ifdef UN_SELECT_TOUCHBAR
	//タッチバー
	UNSelect_TOUCHBAR_ExitEx( wk );
#endif //UN_SELECT_TOUCHBAR

#ifdef UN_SELECT_PMSDRAW
  UNSelect_PMSDRAW_Exit( wk );
#endif //UN_SELECT_PMSDRAW
...
#ifdef UN_SELECT_MCSS
	UNSelect_MCSS_Draw( wk->mcss_sys );
#endif //UN_SELECT_MCSS
 ...
 *	@brief	属性、タイプアイコン作成
 *
 *	@param	UN_SELECT_MAIN_WORK *wk ワーク
 *	@param	PokeType					タイプ
...
// サンプルメイン
static BOOL PrintTool_MainFunc( UN_SELECT_MAIN_WORK * wk )
{
	switch( wk->seq ){
	case 0:
...
// BMPWIN作成
static void PrintTool_AddBmpWin( UN_SELECT_MAIN_WORK * wk )
{
...
// BMPWIN削除
static void PrintTool_DelBmpWin( UN_SELECT_MAIN_WORK * wk )
{
		GFL_BMPWIN_Delete( wk->print_util.win );
}

// BMPWINスクリーン転送
static void PrintTool_ScreenTrans( UN_SELECT_MAIN_WORK * wk )
{
...
// ＨＰ表示
static void PrintTool_PrintHP( UN_SELECT_MAIN_WORK * wk )
{
	STRBUF * strbuf;
...
static void UNSelect_PMSDRAW_Init( UN_SELECT_MAIN_WORK* wk )
{
  ...
  clunit = UN_SELECT_GRAPHIC_GetClunit( wk->graphic );

  wk->pms_draw  = PMS_DRAW_Init( clunit, CLSYS_DRAW_SUB, wk->print_que, wk->font, 
      PLTID_OBJ_PMS_DRAW, UN_SELECT_PMSDRAW_NUM ,wk->heapID );
  
  {
    ...
    // PMS表示用BMPWIN生成
    for( i=0; i<UN_SELECT_PMSDRAW_NUM; i++ )
    {
