 ...
 *	{	
 *	○概要
 *	un_select_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	un_select_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム un_select, UN_SELECT -> config CONFIGなど
...
///	グラフィックメインワーク
//=====================================
struct _UN_SELECT_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
UN_SELECT_GRAPHIC_WORK * UN_SELECT_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	UN_SELECT_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(UN_SELECT_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(UN_SELECT_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void UN_SELECT_GRAPHIC_Exit( UN_SELECT_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void UN_SELECT_GRAPHIC_2D_Draw( UN_SELECT_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void UN_SELECT_GRAPHIC_3D_StartDraw( UN_SELECT_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void UN_SELECT_GRAPHIC_3D_EndDraw( UN_SELECT_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * UN_SELECT_GRAPHIC_GetClunit( const UN_SELECT_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * UN_SELECT_GRAPHIC_GetCamera( const UN_SELECT_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	UN_SELECT_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
