...
enum
{
	MYSIGN_RES_MAIN_PLTT = 0,
	MYSIGN_RES_MAIN_CHAR,
	MYSIGN_RES_MAIN_ANIM,
	MYSIGN_RES_SUB_PLTT,
	MYSIGN_RES_SUB_CHAR,
	MYSIGN_RES_SUB_ANIM,
...
//	GFL_CLWK	*SubActWork[NAMEIN_OAM_NUM];	// セルアクターワークポインタ配列
	GFL_CLWK	*ButtonActWork[9];				// セルアクターワークポインタ配列

	u32			resObjTbl[MYSIGN_RES_MAX];// リソースオブジェテーブル
