...
enum {
	...
	ZKNLISTOBJ_IDX_POKEICON_SW = ZKNLISTOBJ_IDX_POKEICON_S + ZKNLISTOBJ_SUB_POKEICON_MAX,
	ZKNLISTOBJ_IDX_POKEGRA = ZKNLISTOBJ_IDX_POKEICON_SW + ZKNLISTOBJ_SUB_POKEICON_MAX,
