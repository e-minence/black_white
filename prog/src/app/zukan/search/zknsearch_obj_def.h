...
enum {
	...
	ZKNSEARCHOBJ_IDX_FORM_LABEL,

	ZKNSEARCHOBJ_IDX_LOADING_BAR,

	ZKNSEARCHOBJ_IDX_MARK1_M,
	ZKNSEARCHOBJ_IDX_MARK2_M,
	ZKNSEARCHOBJ_IDX_MARK1_S,
	ZKNSEARCHOBJ_IDX_MARK2_S,
	ZKNSEARCHOBJ_IDX_MARK1_SW,
	ZKNSEARCHOBJ_IDX_MARK2_SW,

	ZKNSEARCHOBJ_IDX_FORM_M,
	ZKNSEARCHOBJ_IDX_FORM_S = ZKNSEARCHOBJ_IDX_FORM_M+ZKNSEARCHOBJ_FORM_MAX,
	ZKNSEARCHOBJ_IDX_FORM_SW = ZKNSEARCHOBJ_IDX_FORM_S+ZKNSEARCHOBJ_FORM_MAX,

	ZKNSEARCHOBJ_IDX_MAX = ZKNSEARCHOBJ_IDX_FORM_SW+ZKNSEARCHOBJ_FORM_MAX,
};
...
enum {
	...
	ZKNSEARCHOBJ_CHRRES_LOADING_BAR,
...
enum {
	...
	ZKNSEARCHOBJ_PALRES_LOADING_BAR,
...
enum {
	...
	ZKNSEARCHOBJ_CELRES_LOADING_BAR,
