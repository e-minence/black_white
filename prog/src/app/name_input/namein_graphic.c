 ...
 *	{	
 *	○概要
 *	namein_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	namein_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム namein, NAMEIN -> config CONFIGなど
...
{	
	...
	{	
		GFL_BG_FRAME3_M,	//設定するフレーム
		{
			0, 0, 0x800, 0,	//X,Y,ｽｸﾘｰﾝﾊﾞｯﾌｧ、ｽｸﾘｰﾝｵﾌｾｯﾄ
			GFL_BG_SCRSIZ_256x256, GX_BG_COLORMODE_16,	//ｽｸﾘｰﾝｻｲｽﾞ、ｶﾗｰﾓｰﾄﾞ
			GX_BG_SCRBASE_0x3000, GX_BG_CHARBASE_0x08000, GFL_BG_CHRSIZ_256x256,//ｽｸﾘｰﾝﾍﾞｰｽ、ｷｬﾗﾍﾞｰｽ、ｷｬﾗｻｲｽﾞ
 ...
 */
//-----------------------------------------------------------------------------
NAMEIN_GRAPHIC_WORK * NAMEIN_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	NAMEIN_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(NAMEIN_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(NAMEIN_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void NAMEIN_GRAPHIC_Exit( NAMEIN_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void NAMEIN_GRAPHIC_2D_Draw( NAMEIN_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void NAMEIN_GRAPHIC_3D_StartDraw( NAMEIN_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void NAMEIN_GRAPHIC_3D_EndDraw( NAMEIN_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * NAMEIN_GRAPHIC_GetClunit( const NAMEIN_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * NAMEIN_GRAPHIC_GetCamera( const NAMEIN_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	NAMEIN_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
