...
/**
 *
 *	@file		chihou_zukan_award_graphic.c
 *	@brief	グラフィック設定
 *	@author	Koji Kawada
 *	@data		2010.03.04
 *	@version {1.0}
...
///	グラフィックメインワーク
//=====================================
struct _CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK * CHIHOU_ZUKAN_AWARD_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void CHIHOU_ZUKAN_AWARD_GRAPHIC_Exit( CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void CHIHOU_ZUKAN_AWARD_GRAPHIC_2D_Draw( CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void CHIHOU_ZUKAN_AWARD_GRAPHIC_3D_StartDraw( CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void CHIHOU_ZUKAN_AWARD_GRAPHIC_3D_EndDraw( CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * CHIHOU_ZUKAN_AWARD_GRAPHIC_GetClunit( const CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * CHIHOU_ZUKAN_AWARD_GRAPHIC_GetCamera( const CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	CHIHOU_ZUKAN_AWARD_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
