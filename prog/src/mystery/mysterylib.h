...
///	PROC初期化をまとめた関数
//------------------------------------------------------------------
extern void *MysteryLib_InitProc(GFL_PROC *proc, int heapid, int size, int heapsize);

//------------------------------------------------------------------
///	ＢＧ初期化関数(１フレームのみ)
//------------------------------------------------------------------
extern void MysteryLib_BgInitFrame(GFL_BG_INI *ini, int frame, u8 size, u32 scrbase, u32 scrchar);
...
///	MYSTERY_WIN構造体の初期化
//------------------------------------------------------------------
extern void MysteryLib_WinInit1(MYSTERY_WIN *mw, GFL_BMPWIN *win, int palno, int arc, int fchr, int fcol);
...
///	メッセージウィンドウを登録
//------------------------------------------------------------------
extern int MysteryLib_CreateWin(GFL_BG_INI *bgl, MYSTERY_WIN *mw, int sx, int sy, int msg);
...
///	CLACT_ADDの雛形を作成
//------------------------------------------------------------------
extern GFL_CLWK* MysteryLib_MakeCLACT(int screen, GFL_CLWK *anim, int sx, int sy, int anum);
...
//------------------------------------------------------------------
extern void MysteryLib_MenuKeyMove(BMPMENULIST_WORK * wk, u32 param, u8 mode);
...
///	ＤＳセーブシーケンス
//------------------------------------------------------------------
extern void MysteryLib_InitSaveDSCard(SAVE_CONTROL_WORK *sv);
