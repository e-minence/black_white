...
typedef struct {
	...
	GFL_BMPWIN	*selwin[MYSTERYGIFT_WIN_MAX];	// メニュー選択するウィンドウ
	GFL_BMPWIN	*upwin;				// 画面上のタイトルウィンドウ
...
extern GFL_PROC *MyseryGiftGetProcp(void);
extern void MysteryGiftSetProcp(GFL_PROC *proc);
