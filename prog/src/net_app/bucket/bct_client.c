...
#define BCT_MARUNOMU_ROTA_X_MIN			( GFL_CALC_GET_ROTA_NUM( 20 ) )	// 傾斜最小値
#define BCT_MARUNOMU_ROTA_X_INIT        ( GFL_CALC_GET_ROTA_NUM( 20 ) )    // マルノームの口の傾き
#define BCT_MARUNOMU_ROTA_X_ADD         ( GFL_CALC_GET_ROTA_NUM( 30 ) )   // マルノームの口の傾き
#define BCT_MARUNOMU_ROTA_X_MAX_360		( 90 )	// 最大傾斜
#define BCT_MARUNOMU_ROTA_X_MAX			( GFL_CALC_GET_ROTA_NUM( BCT_MARUNOMU_ROTA_X_MAX_360 ) )	// 最大傾斜
#define BCT_MARUNOMU_ROTA_X_DIF			( BCT_MARUNOMU_ROTA_X_MAX - BCT_MARUNOMU_ROTA_X_MIN )	// MINとMAXの差
#define BCT_MARUNOMU_ROTA_X_ADD_SUB ( GFL_CALC_GET_ROTA_NUM( 8 ) )    // 補正地
#define BCT_MARUNOMU_ROTA_INIT			( GFL_CALC_GET_ROTA_NUM( 180 ) )	// Y軸回転初期値
...
#define BCT_MARUNOMU_DRAWROTA_ADD       ( GFL_CALC_GET_ROTA_NUM( 0 ) )  // 表示で補正する回転角
