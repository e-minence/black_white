...
void BB_disp_BG_Load( BB_WORK* wk )
{
	...
	// ----- 上画面 -----	
	GFL_ARCHDL_UTIL_TransVramBgCharacter( hdl, NARC_manene_upper_bg_NCGR,   	GFL_BG_FRAME0_S, 0, 0, 0, HEAPID_BB );		///< 背景
	GFL_ARCHDL_UTIL_TransVramBgCharacter( hdl, NARC_manene_upper_bg_maku_NCGR, GFL_BG_FRAME1_S, 0, 0, 0, HEAPID_BB );		///< 幕
	...
	// ----- 下画面 -----
	GFL_ARCHDL_UTIL_TransVramBgCharacter( hdl, NARC_manene_bottom_bg_NCGR,   	GFL_BG_FRAME3_M, 0, 0, 0, HEAPID_BB );		///< 背景
	GFL_ARCHDL_UTIL_TransVramBgCharacter( hdl, NARC_manene_bottom_bg_maku_NCGR,GFL_BG_FRAME1_M, 0, 0, 0, HEAPID_BB );		///< 幕
