 ...
 *	{	
 *	○概要
 *	mystery_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	mystery_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム mystery, UI_TEMPLATE -> config CONFIGなど
 ...
 */
//-----------------------------------------------------------------------------
MYSTERY_GRAPHIC_WORK * MYSTERY_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
 ...
 */
//-----------------------------------------------------------------------------
void MYSTERY_GRAPHIC_Exit( MYSTERY_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void MYSTERY_GRAPHIC_2D_Draw( MYSTERY_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void MYSTERY_GRAPHIC_3D_StartDraw( MYSTERY_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void MYSTERY_GRAPHIC_3D_EndDraw( MYSTERY_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * MYSTERY_GRAPHIC_GetClunit( const MYSTERY_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * MYSTERY_GRAPHIC_GetCamera( const MYSTERY_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	MYSTERY_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
...
{	
  ...
  {
    static const GFL_REND_SURFACE_INIT  sc_render_tbl[2] =
    { 
      { 
