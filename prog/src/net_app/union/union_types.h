...
typedef enum{ //※MenuMemberMax, UNION_STATUS_TRAINERCARD以降のテーブルと並びを同じにしておくこと！
  ...
  UNION_PLAY_CATEGORY_COLOSSEUM_MULTI_FREE_SHOOTER,       ///<コロシアム
  UNION_PLAY_CATEGORY_COLOSSEUM_MULTI_FREE,               ///<コロシアム
  UNION_PLAY_CATEGORY_COLOSSEUM_MULTI_FLAT_SHOOTER,   ///<コロシアム
  UNION_PLAY_CATEGORY_COLOSSEUM_MULTI_FLAT,           ///<コロシアム
  UNION_PLAY_CATEGORY_COLOSSEUM_END = UNION_PLAY_CATEGORY_COLOSSEUM_MULTI_FLAT,
...
enum{
  ...
  UNION_STATUS_FORCE_EXIT,  ///<通信エラーなどによる強制終了
...
typedef enum{
  ...
  UNION_SUBPROC_ID_COLOSSEUM_WARP_MULTI_FREE_SHOOTER,    ///<コロシアム遷移(マルチ部屋)
  UNION_SUBPROC_ID_COLOSSEUM_WARP_MULTI_FREE,    ///<コロシアム遷移(マルチ部屋)
  UNION_SUBPROC_ID_COLOSSEUM_WARP_MULTI_FLAT_SHOOTER,    ///<コロシアム遷移(マルチ部屋)
  UNION_SUBPROC_ID_COLOSSEUM_WARP_MULTI_FLAT,    ///<コロシアム遷移(マルチ部屋)
...
typedef struct{
  ...
  u8 func_proc;
  u8 func_seq;
  u8 focus_mac_address[6];    ///<下画面で名前を選択した相手のMacAddress
  u8 padding4[2];
