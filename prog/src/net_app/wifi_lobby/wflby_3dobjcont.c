	...
	case WFLBY_3DOBJCONT_JUMP_SEQ_MAIN:
		...
		// 描画反映処理
		{
			...
			if( count > 0 ){
				...
				// ジャンプ
				matrix.z += FX_Mul( GFL_CALC_Sin360(r), WFLBY_3DOBJCONT_MOVEOBJ_JUMP_ZDIS*FX32_ONE );
				matrix.y += FX_Mul( GFL_CALC_Sin360(r), WFLBY_3DOBJCONT_MOVEOBJ_JUMP_DIS*FX32_ONE );
			}
