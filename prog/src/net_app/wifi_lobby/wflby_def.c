...
u32 WFLBY_BattleWazaType_Get( WFLBY_POKEWAZA_TYPE type )
{
	static const u8 sc_BATTLE_WAZA_TYPE_DATA[ WFLBY_POKEWAZA_TYPE_NUM ] = {
		POKETYPE_HATE,		//	WFLBY_POKEWAZA_TYPE_NONE,	// 選ばない
		POKETYPE_NORMAL,	//	WFLBY_POKEWAZA_TYPE_NORMAL,
		POKETYPE_BATTLE,	//	WFLBY_POKEWAZA_TYPE_BATTLE,
		POKETYPE_HIKOU,		//	WFLBY_POKEWAZA_TYPE_HIKOU,
		POKETYPE_POISON,	//	WFLBY_POKEWAZA_TYPE_POISON,
		POKETYPE_JIMEN,		//	WFLBY_POKEWAZA_TYPE_JIMEN,
		POKETYPE_IWA,		//	WFLBY_POKEWAZA_TYPE_IWA,
		POKETYPE_MUSHI,		//	WFLBY_POKEWAZA_TYPE_MUSHI,
		POKETYPE_GHOST,		//	WFLBY_POKEWAZA_TYPE_GHOST,
		POKETYPE_METAL,		//	WFLBY_POKEWAZA_TYPE_METAL,
		POKETYPE_FIRE,		//	WFLBY_POKEWAZA_TYPE_FIRE,
		POKETYPE_WATER,		//	WFLBY_POKEWAZA_TYPE_WATER,
		POKETYPE_KUSA,		//	WFLBY_POKEWAZA_TYPE_KUSA,
		POKETYPE_ELECTRIC,	//	WFLBY_POKEWAZA_TYPE_ELECTRIC,
		POKETYPE_SP,		//	WFLBY_POKEWAZA_TYPE_SP,
		POKETYPE_KOORI,		//	WFLBY_POKEWAZA_TYPE_KOORI,
		POKETYPE_DRAGON,	//	WFLBY_POKEWAZA_TYPE_DRAGON,
		POKETYPE_AKU,		//	WFLBY_POKEWAZA_TYPE_AKU,
	};
