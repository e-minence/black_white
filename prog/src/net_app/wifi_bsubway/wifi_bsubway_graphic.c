 ...
 *	{	
 *	○概要
 *	wifi_bsubway_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	wifi_bsubway_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム wifi_bsubway, UI_TEMPLATE -> config CONFIGなど
...
{	
	...
	{	
		GFL_BG_FRAME1_M,	//設定するフレーム
		{
			...
			GFL_BG_SCRSIZ_512x256, GX_BG_COLORMODE_16,	//ｽｸﾘｰﾝｻｲｽﾞ、ｶﾗｰﾓｰﾄﾞ
	...
	{	
		GFL_BG_FRAME3_M,	//設定するフレーム
		{
			0, 0, 0x800, 0,	//X,Y,ｽｸﾘｰﾝﾊﾞｯﾌｧ、ｽｸﾘｰﾝｵﾌｾｯﾄ
			GFL_BG_SCRSIZ_256x256, GX_BG_COLORMODE_16,	//ｽｸﾘｰﾝｻｲｽﾞ、ｶﾗｰﾓｰﾄﾞ
			GX_BG_SCRBASE_0x3000, GX_BG_CHARBASE_0x10000, GFL_BG_CHRSIZ_256x256,//ｽｸﾘｰﾝﾍﾞｰｽ、ｷｬﾗﾍﾞｰｽ、ｷｬﾗｻｲｽﾞ
	...
	{	
		GFL_BG_FRAME3_S,	//設定するフレーム
		{
			0, 0, 0x800, 0,	//X,Y,ｽｸﾘｰﾝﾊﾞｯﾌｧ、ｽｸﾘｰﾝｵﾌｾｯﾄ
			GFL_BG_SCRSIZ_256x256, GX_BG_COLORMODE_16,	//ｽｸﾘｰﾝｻｲｽﾞ、ｶﾗｰﾓｰﾄﾞ
			GX_BG_SCRBASE_0x3000, GX_BG_CHARBASE_0x10000, GFL_BG_CHRSIZ_256x256,
			GX_BG_EXTPLTT_01, 3, 0, 0, FALSE//拡張ﾊﾟﾚｯﾄｽﾛｯﾄ、表示優先度、ｴﾘｱｵｰﾊﾞｰ、ﾀﾞﾐｰ、ﾓｻﾞｲｸﾌﾗｸﾞ
		},
		GFL_BG_MODE_TEXT,//BGの種類
		TRUE,	//初期表示
...
///	グラフィックメインワーク
//=====================================
struct _WIFI_BSUBWAY_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
WIFI_BSUBWAY_GRAPHIC_WORK * WIFI_BSUBWAY_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	WIFI_BSUBWAY_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(WIFI_BSUBWAY_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(WIFI_BSUBWAY_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void WIFI_BSUBWAY_GRAPHIC_Exit( WIFI_BSUBWAY_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void WIFI_BSUBWAY_GRAPHIC_2D_Draw( WIFI_BSUBWAY_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void WIFI_BSUBWAY_GRAPHIC_3D_StartDraw( WIFI_BSUBWAY_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void WIFI_BSUBWAY_GRAPHIC_3D_EndDraw( WIFI_BSUBWAY_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * WIFI_BSUBWAY_GRAPHIC_GetClunit( const WIFI_BSUBWAY_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * WIFI_BSUBWAY_GRAPHIC_GetCamera( const WIFI_BSUBWAY_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	WIFI_BSUBWAY_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
