...
///	ATLAS統計・競争関係（SC）
//=====================================
extern void WIFIBATTLEMATCH_SC_Start( WIFIBATTLEMATCH_NET_WORK *p_wk, WIFIBATTLEMATCH_TYPE mode, WIFIBATTLEMATCH_BTLRULE rule, BtlResult result );
...
typedef enum
{
  ...
  WIFIBATTLEMATCH_RECV_GPFDATA_RET_DIRTY, //もらえなかった
...
extern WIFIBATTLEMATCH_RECV_GPFDATA_RET WIFIBATTLEMATCH_NET_WaitRecvGpfData( WIFIBATTLEMATCH_NET_WORK *p_wk );  //@todoレーティングやWIFI大会ではエラー文章を出す
...
///	不正文字チェック
//=====================================
extern void WIFIBATTLEMATCH_NET_StartBadWord( WIFIBATTLEMATCH_NET_WORK *p_wk, STRBUF *p_str, HEAPID heapID );
