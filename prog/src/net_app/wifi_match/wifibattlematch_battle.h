...
typedef enum 
{
  ...
  WIFIBATTLEMATCH_BATTLELINK_RESULT_ERROR_LIVE,               //エラー検知（LIVE）
  WIFIBATTLEMATCH_BATTLELINK_RESULT_ERROR_RETURN_LOGIN_WIFI,  //エラー検知（WIFI）
  WIFIBATTLEMATCH_BATTLELINK_RESULT_ERROR_DISCONNECT_WIFI,    //切断された（WIFI）
