...
typedef enum
{
	...
	WIFIBATTLEMATCH_VIEW_RES_MODE_RANDOM,  //ランダム対戦

	WIFIBATTLEMATCH_VIEW_RES_MODE_DIGITALCARD,
  WIFIBATTLEMATCH_VIEW_RES_MODE_MENU  = WIFIBATTLEMATCH_VIEW_RES_MODE_LIVE, //ライブ大会と同じ
...
#define PLAYERINFO_TRAINER_CUP_Y			(112-2)
...
typedef enum
{
  PLAYERINFO_WIFI_UPDATE_TYPE_LOCK,   //すべて表示
  PLAYERINFO_WIFI_UPDATE_TYPE_UNLOCK, //ロックだけ消える
  PLAYERINFO_WIFI_UPDATE_TYPE_UNREGISTER,//ポケモンとロックが消える
