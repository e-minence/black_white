 ...
 *	{	
 *	○概要
 *	wifibattlematch_graphicはファイルごとコピペして使うことができる、グラフィック設定モジュールです。
 ...
 *	
 *	○中身
 *	wifibattlematch_graphic.cの中身は、データ部と、関数部にわかれております。
 ...
 *
 *	○使用方法
 *	１．使用したいフォルダへコピーしリネーム wifibattlematch, UI_TEMPLATE -> config CONFIGなど
...
///	グラフィックメインワーク
//=====================================
struct _WIFIBATTLEMATCH_GRAPHIC_WORK
{
	GRAPHIC_BG_WORK		bg;
 ...
 */
//-----------------------------------------------------------------------------
WIFIBATTLEMATCH_GRAPHIC_WORK * WIFIBATTLEMATCH_GRAPHIC_Init( int display_select, HEAPID heapID )
{	
	WIFIBATTLEMATCH_GRAPHIC_WORK * p_wk;
	p_wk	= GFL_HEAP_AllocMemory(heapID, sizeof(WIFIBATTLEMATCH_GRAPHIC_WORK) );
	GFL_STD_MemClear( p_wk, sizeof(WIFIBATTLEMATCH_GRAPHIC_WORK) );
 ...
 */
//-----------------------------------------------------------------------------
void WIFIBATTLEMATCH_GRAPHIC_Exit( WIFIBATTLEMATCH_GRAPHIC_WORK *p_wk )
{	
	//VBLANKTask消去
 ...
 */
//-----------------------------------------------------------------------------
void WIFIBATTLEMATCH_GRAPHIC_2D_Draw( WIFIBATTLEMATCH_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
void WIFIBATTLEMATCH_GRAPHIC_3D_StartDraw( WIFIBATTLEMATCH_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
void WIFIBATTLEMATCH_GRAPHIC_3D_EndDraw( WIFIBATTLEMATCH_GRAPHIC_WORK *p_wk )
{	
#ifdef GRAPHIC_G3D_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_CLUNIT * WIFIBATTLEMATCH_GRAPHIC_GetClunit( const WIFIBATTLEMATCH_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_OBJ_USE
 ...
 */
//-----------------------------------------------------------------------------
GFL_G3D_CAMERA * WIFIBATTLEMATCH_GRAPHIC_GetCamera( const WIFIBATTLEMATCH_GRAPHIC_WORK *cp_wk )
{	
#ifdef GRAPHIC_G3D_USE
...
static void Graphic_VBlankTask( GFL_TCB *p_tcb, void *p_work )
{
	WIFIBATTLEMATCH_GRAPHIC_WORK *p_wk	= p_work;
#ifdef GRAPHIC_BG_USE
