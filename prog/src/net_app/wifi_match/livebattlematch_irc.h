...
typedef enum
{
  LIVEBATTLEMATCH_RESULT_CONTINUE,  //処理中
  LIVEBATTLEMATCH_RESULT_SUCCESS,   //成功
  LIVEBATTLEMATCH_RESULT_FAILIRE,   //失敗
}LIVEBATTLEMATCH_RESULT;
extern BOOL LIVEBATTLEMATCH_IRC_StartConnect( LIVEBATTLEMATCH_IRC_WORK *p_wk );
extern LIVEBATTLEMATCH_RESULT LIVEBATTLEMATCH_IRC_WaitConnect( LIVEBATTLEMATCH_IRC_WORK *p_wk );
//接続キャンセル
