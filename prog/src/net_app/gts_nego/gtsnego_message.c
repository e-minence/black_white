...
GTSNEGO_MESSAGE_WORK* GTSNEGO_MESSAGE_Init(HEAPID id)
{
  ...
  pWork->pMsgData = GFL_MSG_Create( GFL_MSG_LOAD_NORMAL, ARCID_MESSAGE, NARC_message_gtsnego_dat, pWork->heapID );
