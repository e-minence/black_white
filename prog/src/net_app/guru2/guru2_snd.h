...
//  define
//==============================================================================
#define GURU2_SE_COUNT_3      (SEQ_SE_SYS_52) // (SEQ_SE_DP_DECIDE)   //3
#define GURU2_SE_COUNT_2      (SEQ_SE_SYS_52) // (SEQ_SE_DP_DECIDE)  //2
#define GURU2_SE_COUNT_1      (SEQ_SE_SYS_52) // (SEQ_SE_DP_DECIDE)  //1
#define GURU2_SE_START        (SEQ_SE_SYS_53) // (SEQ_SE_DP_CON_016) //スタート
#define GURU2_SE_BTN_PUSH     (SEQ_SE_SYS_54) // (SEQ_SE_DP_BUTTON9) //下画面ボタン押す
