...
extern void POKEMONTRADE_DEMO_PTC_LoadOne_Init( POKEMONTRADE_DEMO_WORK* pWork );
extern const BOOL POKEMONTRADE_DEMO_PTC_LoadOne_Loop( POKEMONTRADE_DEMO_WORK* pWork );
