...
//フェードに関する時間
#define _POKEUP_WHITEOUT_START (400)       //絵コンテ６番モンスターボールが打ちあがった際のホワイトアウト
...
#define _POKECHANGE_WHITEOUT_START (880+60)  //絵コンテ１４番ポケモン交換シーンのホワイトアウト
#define _POKECHANGE_WHITEOUT_TIMER (29)      //絵コンテ１４番ポケモン交換シーンのホワイトアウト時間
#define _POKECHANGE_WHITEIN_START  (910+60)  //絵コンテ１５番ボールおち前のフェードイン
#define _POKECHANGE_WHITEIN_TIMER (30)        //絵コンテ１５番ボールおち前のフェードイン時間

#define _POKESPLASH_WHITEOUT_START (1300+60)  //絵コンテ２０番ボールおちシーンのホワイトアウト
#define _POKESPLASH_WHITEOUT_TIMER (29)       //絵コンテ２０番ボールおちシーンのホワイトアウト時間
#define _POKESPLASH_WHITEIN_START  (1330+60)  //絵コンテ２１番もう一回ボール落ちのフェードイン
#define _POKESPLASH_WHITEIN_TIMER (90)        //絵コンテ２１番もう一回ボール落ちのフェードイン時間

#define _DEMO_END (1680+60)   //デモが終わる最後のフレーム


//ポケモンの動きに関する時間
#define _POKEMON_DELETE_TIME   (58)     // 絵コンテ３番  ポケモンを消す
#define _POKE_APPEAR_START   (410+60)   //絵コンテ８番  ポケモン登場 自分のは裏
#define _POKE_APPEAR_TIME    (30)       //絵コンテ８番  ポケモン登場移動時間
#define _POKE_SIDEOUT_START   (450+60)  //絵コンテ１０番  ポケモン左右に移動していく
#define _POKE_SIDEOUT_TIME    (80)      //絵コンテ１０番  ポケモン登場移動時間
#define _POKE_SIDEIN_START   (530+60)   //絵コンテ１１番  ポケモン左右に移動して戻ってくる
#define _POKE_SIDEIN_TIME    (240)     //絵コンテ１１番 ポケモン登場移動時間
#define _POKE_LEAVE_START   (800+60)  //絵コンテ１３番  ポケモン退場
#define _POKE_LEAVE_TIME    (30)      //絵コンテ１３番  ポケモン退場移動時間
#define _POKEMON_CREATE_TIME   (1604+60+4)  ///絵コンテ２４番 交換終了してポケモン登場 
...
//絵コンテ８番の最初の位置
#define _POKEMON_PLAYER_APPEAR_POSX _MCSS_POS_X( -60)  // 自分のポケモンのX
#define _POKEMON_PLAYER_APPEAR_POSY _MCSS_POS_Y(-100)  // 自分のポケモンのY
#define _POKEMON_PLAYER_APPEAR_POSZ _MCSS_POS_Z(  10)  // 自分のポケモンのZ
#define _POKEMON_FRIEND_APPEAR_POSX _MCSS_POS_X( 60)  // 相手のポケモンのX
#define _POKEMON_FRIEND_APPEAR_POSY _MCSS_POS_Y(100)  // 相手のポケモンのY
...
#define _POKEMON_PLAYER_UP_POSY   _MCSS_POS_Y(-28)             // 自分のポケモンのY
...
//絵コンテ１０番
#define _POKEMON_PLAYER_SIDEOUT_POSX _MCSS_POS_X(-120)           // 自分のポケモンのX
...
#define _POKEMON_FRIEND_SIDEOUT_POSX _MCSS_POS_X(120)           // 相手のポケモンのX
...
#define _POKEMON_PLAYER_SIDEST_POSY _MCSS_POS_Y(0)  // 自分のポケモンが左から登場する場合のY
...
#define _POKEMON_FRIEND_SIDEST_POSY _MCSS_POS_Y(-28)  // 相手のポケモンが右から登場する場合のY
...
#define _POKEMON_FRIEND_LEAVE_POSY _MCSS_POS_Y(-130)  // 相手のポケモンが下に退場する場合のY
