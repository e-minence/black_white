...
#if ( PM_VERSION == VERSION_PLATINUM )

#define ZKN_TEXT_DAT	( NARC_msg_zkn_comment_platinum_dat )
#define ZKN_ARC_DAT	( ARC_ZUKAN_ENC_PLATINUM )
