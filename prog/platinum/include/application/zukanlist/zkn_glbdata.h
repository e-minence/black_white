...
GLOBAL u32 ZKN_GLBDATA_SaveData_FormGet( const ZKN_GLB_DATA* cp_glb, u32 monsno, int count );
GLOBAL u32 ZKN_GLBDATA_SaveData_FormNumGet( const ZKN_GLB_DATA* cp_glb, u32 monsno );
...
GLOBAL u32 ZKN_GLBDATA_TouchCursorFlagGet( const ZKN_GLB_DATA* cp_glb );
