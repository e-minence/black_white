...
#define POKE_NET_GDS_URL		"pmsv.denyu-sha.to"	// サーバーURL
...
/*-----------------------------------------------------------------------*
					関数外部宣言
 *-----------------------------------------------------------------------*/
extern BOOL POKE_NET_GDS_Initialize(s32 _pid);
...
extern BOOL POKE_NET_GDS_BattleDataSearchRanking(void *_response);
extern BOOL POKE_NET_GDS_BattleDataSearchExRanking(void *_response);
extern BOOL POKE_NET_GDS_BattleDataGet(u64 _code ,void *_response);
