...
extern	u16					BattleWorkRandGet(BATTLE_WORK *bw);
extern	RECORD_PARAM		*BattleWorkBattleRecBufferGet(BATTLE_WORK *bw);
extern	void				BattleWorkBattleRec(BATTLE_WORK *bw,int client_no,REC_DATA data);
extern	REC_DATA			BattleWorkBattlePlay(BATTLE_WORK *bw,int client_no);
extern	u8					BattleWorkBattleRecordSendDataMake(BATTLE_WORK *bw,u8 *buf);
extern	void				BattleWorkBattleRecordRecvDataSet(BATTLE_WORK *bw,u16 size,u8 *buf);
extern	u16					BattleWorkCommIDGet(BATTLE_WORK *bw);
extern	int					BattleWorkCommStandNoGet(BATTLE_WORK *bw,u16 id);
extern	u16					BattleWorkTrainerUseItemGet(BATTLE_WORK *bw,int client_no,int pos);
extern	u32					BattleWorkBattleRecStopFlagGet(BATTLE_WORK *bw);
extern	void				BattleWorkBattleRecStopFlagSet(BATTLE_WORK *bw,int flag);
extern	void				BattleWorkPlayBackStopButtonSet(BATTLE_WORK *bw);
extern	u8					BattleWorkVoiceWazaParamGet(BATTLE_WORK *bw,int client_no);
