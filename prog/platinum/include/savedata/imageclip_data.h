...
//	
//--------------------------------------------------------------
GLOBAL void ImcTelevision_to_GTDress(const IMC_TELEVISION_SAVEDATA * dress, GT_GDS_DRESS * gt_dress);
GLOBAL void GTDress_to_ImcTelevision(const GT_GDS_DRESS * gt_dress, IMC_TELEVISION_SAVEDATA * dress);
