...
extern void MISC_SetGdsSend_Box(MISC *misc, int box_no, int flag);
extern BOOL MISC_GetGdsSend_Box(MISC *misc, int box_no);
extern void MISC_SetGdsSend_Dress(MISC *misc, int flag);
extern BOOL MISC_GetGdsSend_Dress(MISC *misc);
extern void MISC_SetGdsSend_Video(MISC *misc, int flag);
extern BOOL MISC_GetGdsSend_Video(MISC *misc);
