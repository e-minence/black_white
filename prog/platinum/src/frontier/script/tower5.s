...
//--------------------------------------------------------------------
#if 0
#define PLAYER_X		(8*12)//(8*16)
#define PLAYER_Y		(8*14)//(8*24)
#define PCWOMAN2_X		(8*3)//(8*16)
#define PCWOMAN2_Y		(8*14)//(8*10)
#define ENEMY_X			(8*13)//(8*16)
#define ENEMY_Y			(8*6)//(8*6)
#define MINE_X			(8*13)//(8*16)
#define MINE_Y			(8*22)//(8*24)
#else
#define PLAYER_X		(8*15)//(8*16)
#define PLAYER_Y		(8*16)//(8*24)
