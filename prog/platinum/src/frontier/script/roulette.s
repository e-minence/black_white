...
//#define DEBUG_BRAIN_OFF				//ブレーン登場オフデバック(有効でデバック)
...
_ACTOR_LABEL	default_scene3_actor
	...
	_ACTOR_DATA				OBJID_PEOPLE8,CAMPBOY,WF2DMAP_WAY_C_DOWN, \
							8*26,8*30,ON,EVENTID_TEST_SCR_OBJ1
	/*同じキャラを複数配置*/
	_ACTOR_DATA				OBJID_PEOPLE11,CAMPBOY,WF2DMAP_WAY_C_RIGHT, \
...
_RESOURCE_LABEL	kaihuku_set_resource
	_CHAR_RESOURCE_DATA		BFSM,WF2DC_C_MOVENORMAL
	_CHAR_RESOURCE_DATA_END

//--------------------------------------------------------------------
//--------------------------------------------------------------------
_ACTOR_LABEL	kaihuku_set_actor
	_ACTOR_DATA			OBJID_KAIHUKU,BFSM,WF2DMAP_WAY_C_UP, \
...
_ARTICLE_RESOURCE_LABEL	article_pokepanel_resource
	...
	_ARTICLE_RESOURCE_DATA	ACTID_ROULETTE_POKEPANEL2
	_ARTICLE_RESOURCE_DATA_END
...
_ARTICLE_ACTOR_LABEL	article_pokepanel_single_l_actor
	...
	_ARTICLE_ACTOR_DATA		ACTID_ROULETTE_POKEPANEL2, POKEPANEL_L_X, POKEPANEL_SINGLE_Y2, ON, OFF, ACTWORK_5
	_ARTICLE_ACTOR_DATA_END
...
_ARTICLE_ACTOR_LABEL	article_pokepanel_single_r_actor
	...
	_ARTICLE_ACTOR_DATA		ACTID_ROULETTE_POKEPANEL2, POKEPANEL_R_X, POKEPANEL_SINGLE_Y2, ON, OFF, ACTWORK_7
	_ARTICLE_ACTOR_DATA_END
...
ev_roulette_start_2:
	...
	/*通信：トレーナー情報やりとり*/
	_ROULETTE_TOOL		FR_ID_CHECK_COMM_TYPE,0,0,FSW_ANSWER
	_IFVAL_JUMP			FSW_ANSWER,EQ,1,ev_roulette_multi_comm_tr
...
ev_roulette_multi_room_enemy_poke_send2:
	...
	_ROULETTE_SEND_BUF	FSW_LOCAL2,0,FSW_ANSWER
	_IFVAL_JUMP			FSW_ANSWER,EQ,0,ev_roulette_multi_room_enemy_poke_send2/*送信失敗は再送信へ*/
...
ev_roulette_multi_room_go_rental:
	/*「しばらくお待ちください」*/
	_TALKMSG_ALL_PUT	msg_roulette_room_wait
...
ev_roulette_rank_go:
	...
	_CALL				ev_roulette_brain_check

	/*ブレーン登場かチェック*/
	_IFVAL_CALL			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_1ST,ev_roulette_leader_1st_12
	_IFVAL_CALL			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_2ND,ev_roulette_leader_2nd_12
	...
	/*通信マルチ*/
	_ROULETTE_TOOL		FR_ID_CHECK_COMM_TYPE,0,0,FSW_ANSWER
	_IFVAL_CALL			FSW_ANSWER,EQ,1,ev_roulette_comm_command_initialize
...
ev_roulette_seq24:
	...
	_ARTICLE_ACTOR_ANIME_START	ACTWORK_5,2		//2番のアニメ実行
	_ARTICLE_ACTOR_ANIME_START	ACTWORK_6,3		//3番のアニメ実行
	_ARTICLE_ACTOR_ANIME_START	ACTWORK_7,3		//3番のアニメ実行
...
ev_roulette_taisen_go:
	_ROULETTE_TOOL		FR_ID_CLEAR_PARENT_CHECK_FLAG,0,0,FSW_ANSWER		/*クリアしておく*/
...
/*																	*/
/********************************************************************/
ev_roulette_comm_command_initialize:
	_ROULETTE_TOOL		FR_ID_COMM_COMMAND_INITIALIZE,0,0,FSW_ANSWER
	_TIME_WAIT			1,FSW_ANSWER
	_RET
...
ev_roulette_room_etc_add:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_1ST,ev_roulette_leader_1st_02
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_2ND,ev_roulette_leader_2nd_02
...
ev_roulette_battle:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_1ST,ev_roulette_leader_1st_33
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_2ND,ev_roulette_leader_2nd_33
...
ev_roulette_battle_2:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_1ST,ev_roulette_battle_2_0
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_2ND,ev_roulette_battle_2_0
...
ev_roulette_battle_2_0:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_1ST,ev_roulette_leader_1st_03
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_2ND,ev_roulette_leader_2nd_03
...
ev_roulette_room_saikai:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_1ST,ev_roulette_leader_1st_01
	_IFVAL_JUMP			FSW_ANSWER,EQ,ROULETTE_LEADER_SET_2ND,ev_roulette_leader_2nd_01

	_JUMP				ev_roulette_room_saikai_02
	_END

ev_roulette_room_saikai_02:
	_DEBUG_PRINT		FSW_LOCAL1
...
ev_roulette_room_menu_make:
	...
	/*戦闘がないパネルでない時は「きろくする」メニュー追加*/
	_IFVAL_JUMP		FSW_PARAM4,EQ,0,ev_roulette_room_menu_make_04_set
...
ev_roulette_room_menu_make_comm:
	...
	/*戦闘がないパネルでない時は「きろくする」メニュー追加*/
	_IFVAL_JUMP		FSW_PARAM4,EQ,0,ev_roulette_room_menu_make_02_set
...
ev_roulette_room_menu_make_01:
	_BMPMENU_INIT_EX	24,13,0,1,FSW_PARAM1			/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_01,0	/*つづける*/
	_JUMP			ev_roulette_room_yasumu_next
	_END

ev_roulette_room_menu_make_02:
	_BMPMENU_INIT_EX	23,11,0,1,FSW_PARAM1			/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_01,0	/*つづける*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_02,1	/*きろくする*/
	_JUMP			ev_roulette_room_yasumu_next
	_END

ev_roulette_room_menu_make_03:
	_BMPMENU_INIT_EX	24,11,0,1,FSW_PARAM1			/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_01,0	/*つづける*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_03,2	/*やすむ*/
	_JUMP			ev_roulette_room_yasumu_next
	_END

ev_roulette_room_menu_make_04:
	_BMPMENU_INIT_EX	23,9,0,1,FSW_PARAM1				/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_01,0	/*つづける*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_02,1	/*きろくする*/
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_03,2	/*やすむ*/
	_JUMP			ev_roulette_room_yasumu_next
...
ev_roulette_room_yasumu_next:
	_BMPMENU_MAKE_LIST	msg_roulette_room_choice_04,3	/*リタイア*/
	_BMPMENU_START
...
/*			連勝数を取得(ブレーンチェック用)(FSW_ANSWER使用)		*/
/********************************************************************/
ev_roulette_brain_check:
	/*連勝数取得*/
	_ROULETTE_TOOL		FR_ID_GET_RENSYOU,0,0,FSW_ANSWER
	_ADD_WK				FSW_ANSWER,1

#ifdef DEBUG_BRAIN_OFF	/********************************************/
	_LDVAL				FSW_ANSWER,ROULETTE_LEADER_SET_1ST
#endif	/************************************************************/
