...
bf_no_sel_menu:
	...
	/*メニュー作成*/
	_BMPMENU_INIT_EX	18,5,0,1,FSW_ANSWER									/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_bf_info_choice_01,FRONTIER_NO_TOWER				/*バトルタワー*/
	_BMPMENU_MAKE_LIST	msg_bf_info_choice_02,FRONTIER_NO_FACTORY_LV50		/*バトルファクトリー*/
	_BMPMENU_MAKE_LIST	msg_bf_info_choice_03,FRONTIER_NO_CASTLE			/*バトルキャッスル*/
	_BMPMENU_MAKE_LIST	msg_bf_info_choice_04,FRONTIER_NO_STAGE				/*バトルステージ*/
	_BMPMENU_MAKE_LIST	msg_bf_info_choice_05,FRONTIER_NO_ROULETTE			/*バトルルーレット*/
	_BMPMENU_MAKE_LIST	msg_bf_info_choice_06,FRONTIER_NO_YAMERU			/*やめる*/
	_BMPMENU_START
...
ev_bf_info_choice_04:
	...
	_SAVE_EVENT_WORK_SET	LOCALWORK3,FSW_LOCAL3							/*init*/
	_JUMP					ev_bf_info_send_retire_flag
	_END
...
ev_bf_info_send_retire_flag:
	/*「しばらくお待ちください」*/
	_TALKMSG_ALL_PUT	msg_bf_info_005
...
ev_bf_info_sel_check:
	...
	_IFVAL_JUMP			FSW_ANSWER,EQ,0,ev_bf_info_choice_06			/*送信失敗は再送信*/
...
ev_bf_info_sel_ok:
	...
	_IFVAL_JUMP			FSW_ANSWER,EQ,FRONTIER_NO_ROULETTE,ev_bf_info_pokelist_start/*キャッスル*/
...
ev_wifi_counter_return_yes:
	...
	_TALKMSG_ALL_PUT	msg_bf_info_031
	_LDVAL				FSW_PARAM2,0
