...
_ACTOR_LABEL	etc_set_actor
	_ACTOR_DATA			OBJID_ETC,FSW_PARAM2,WF2DMAP_WAY_C_DOWN, \
							8*16,8*28,ON,EVENTID_TEST_SCR_OBJ1
	_ACTOR_DATA_END
...
ev_stage_multi_room_go_rental:
	/*「少々お待ちください」*/
	_TALKMSG_ALL_PUT	msg_stage_room_wait
...
ev_stage_room_go:
	...
	_CALL			ev_stage_brain_check
	_NUMBER_NAME	0,FSW_ANSWER

	/*ブレーン登場かチェック*/
	_IFVAL_JUMP		FSW_ANSWER,EQ,STAGE_LEADER_SET_1ST,ev_stage_leader_1st_02
	_IFVAL_JUMP		FSW_ANSWER,EQ,STAGE_LEADER_SET_2ND,ev_stage_leader_2nd_02
...
ev_stage_battle:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP		FSW_ANSWER,EQ,STAGE_LEADER_SET_1ST,ev_stage_leader_1st_33
	_IFVAL_JUMP		FSW_ANSWER,EQ,STAGE_LEADER_SET_2ND,ev_stage_leader_2nd_33
...
ev_stage_battle_2:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP		FSW_ANSWER,EQ,STAGE_LEADER_SET_1ST,ev_stage_leader_1st_03
	_IFVAL_JUMP		FSW_ANSWER,EQ,STAGE_LEADER_SET_2ND,ev_stage_leader_2nd_03
...
ev_stage_room_menu_make_01:
	_BMPMENU_INIT_EX	24,13,0,1,FSW_PARAM0			/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_01,0		/*つづける*/
	_JUMP			ev_stage_room_yasumu_next
	_END

ev_stage_room_menu_make_02:
	_BMPMENU_INIT_EX	23,11,0,1,FSW_PARAM0			/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_01,0		/*つづける*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_02,1		/*きろくする*/
	_JUMP			ev_stage_room_yasumu_next
	_END

ev_stage_room_menu_make_03:
	_BMPMENU_INIT_EX	24,11,0,1,FSW_PARAM0			/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_01,0		/*つづける*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_03,2		/*やすむ*/
	_JUMP			ev_stage_room_yasumu_next
	_END

ev_stage_room_menu_make_04:
	_BMPMENU_INIT_EX	23,9,0,1,FSW_PARAM0				/*Bキャンセル有効*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_01,0		/*つづける*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_02,1		/*きろくする*/
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_03,2		/*やすむ*/
	_JUMP			ev_stage_room_yasumu_next
...
ev_stage_room_yasumu_next:
	_BMPMENU_MAKE_LIST	msg_stage_room_choice_04,3		/*リタイア*/
	_BMPMENU_START
