...
//#define DEBUG_BRAIN_OFF				//ブレーン登場にする(有効でデバック)
...
ev_factory_multi_room_tr_info_msg:
	...
	_FACTORY_SEND_BUF	FSW_LOCAL2,0,FSW_ANSWER
	_IFVAL_JUMP		FSW_ANSWER,EQ,0,ev_factory_multi_room_tr_info_msg		/*送信失敗、再送信へ*/
...
ev_factory_multi_lap_4:
	...
	_IFVAL_CALL		FSW_ANSWER,NE,0xff,ev_factory_multi_lap_4_0		/*同じタイプが存在*/
	_IFVAL_CALL		FSW_ANSWER,EQ,0xff,ev_factory_multi_lap_4_1		/*同じタイプがない*/
	_RET

ev_factory_multi_lap_4_0:
	_TALKMSG	msg_factory_room_34
	_RET

ev_factory_multi_lap_4_1:
...
ev_factory_multi_room_go_rental:
	/*「少々お待ちください」*/
	_TALKMSG_ALL_PUT	msg_factory_room_wait
...
ev_factory_room_go_2:
	...
	_CALL			ev_factory_brain_check
	_NUMBER_NAME	0,FSW_ANSWER

	/*ブレーン登場かチェック*/
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_1ST,ev_factory_leader_1st_02
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_2ND,ev_factory_leader_2nd_02
...
ev_factory_battle:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_1ST,ev_factory_leader_1st_31
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_2ND,ev_factory_leader_2nd_31
...
ev_factory_battle_2:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_1ST,ev_factory_leader_1st_03
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_2ND,ev_factory_leader_2nd_03
...
ev_factory_room_saikai:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_1ST,ev_factory_leader_1st_01
	_IFVAL_JUMP		FSW_ANSWER,EQ,FACTORY_LEADER_SET_2ND,ev_factory_leader_2nd_01
...
ev_factory_room_menu_make_01:
	...
	_BMPMENU_MAKE_LIST	msg_factory_room_choice_01,0	/*つづける*/
...
ev_factory_room_menu_make_02:
	...
	_BMPMENU_MAKE_LIST	msg_factory_room_choice_01,0	/*つづける*/
	_BMPMENU_MAKE_LIST	msg_factory_room_choice_02,1	/*きろくする*/
	_JUMP			ev_factory_room_yasumu_next
	_END
...
ev_factory_room_menu_make_03:
	...
	_BMPMENU_MAKE_LIST	msg_factory_room_choice_01,0	/*つづける*/
	_BMPMENU_MAKE_LIST	msg_factory_room_choice_03,2	/*やすむ*/
	_JUMP			ev_factory_room_yasumu_next
	_END
...
ev_factory_room_yasumu_next:
	_BMPMENU_MAKE_LIST	msg_factory_room_choice_04,3	/*リタイア*/
	_BMPMENU_START
