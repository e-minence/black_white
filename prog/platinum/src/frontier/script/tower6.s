...
_ACTOR_LABEL	default_set_actor
	...
	//自分、パートナー
	_ACTOR_DATA				OBJID_MINE,FSW_PARAM0,WF2DMAP_WAY_C_DOWN, \
							MINE_X,MINE_Y,ON,EVENTID_TEST_SCR_OBJ1
	_ACTOR_DATA				OBJID_PAIR,FSW_PARAM1,WF2DMAP_WAY_C_DOWN, \
...
ev_tower_roomd_siobtl_02:
	...
	_BMPMENU_INIT		24,13,0,0,FSW_ANSWER		//Bキャンセル無効
	_BMPMENU_MAKE_LIST	msg_tower_choice_06,0		//つづける
...
ev_tower_roomd_siobtl_02_rec:
	...
	_BMPMENU_INIT		23,11,0,0,FSW_ANSWER		//Bキャンセル無効
	_BMPMENU_MAKE_LIST	msg_tower_choice_06,0		//つづける
	_BMPMENU_MAKE_LIST	msg_tower_choice_13,1		/*きろくする*/
	_JUMP				ev_tower_roomd_roomd_siobtl_02_sub
	_END

/*ワイアレスで、DPが含まれていたら、記録処理はいらない*/
ev_tower_roomd_siobtl_03_rec:
	_BMPMENU_INIT		24,11,0,0,FSW_ANSWER		//Bキャンセル無効
	_BMPMENU_MAKE_LIST	msg_tower_choice_06,0		//つづける
	_JUMP				ev_tower_roomd_roomd_siobtl_02_sub
	_END

ev_tower_roomd_roomd_siobtl_02_sub:
	_BMPMENU_MAKE_LIST	msg_tower_choice_08,2		//リタイア
	_BMPMENU_START
...
ev_tower_roomd_common_exit:
	...
	_BTOWER_TOOLS		BTWR_SUB_GET_PLAY_MODE,BTWR_NULL_PARAM,FSW_ANSWER
	_IFVAL_JUMP			FSW_ANSWER,EQ,BTWR_MODE_COMM_MULTI,ev_tower_roomd_sio_exit
...
ev_tower_roomd_aibtl_02_rec:
	_BMPMENU_INIT		23,9,0,0,FSW_ANSWER				//Bキャンセル無効
	_BMPMENU_MAKE_LIST	msg_tower_choice_06,0			//つづける
	_BMPMENU_MAKE_LIST	msg_tower_choice_13,1			/*きろくする*/
	_JUMP				ev_tower_roomd_aibtl_02_sub
	_END
...
ev_tower_roomd_aibtl_02_sub:
	_BMPMENU_MAKE_LIST	msg_tower_choice_07,2			//やすむ
	_BMPMENU_MAKE_LIST	msg_tower_choice_08,3			//リタイア
	_BMPMENU_START
