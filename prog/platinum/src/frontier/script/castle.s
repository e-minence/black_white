...
_ACTOR_LABEL	default_set_actor
	_PLAYER_ACTOR_DATA		OBJID_PLAYER,WF2DMAP_WAY_C_LEFT,8*36,8*14,OFF/*自分自身のアクタセット*/
	...
	_ACTOR_DATA				OBJID_MINE,FSW_LOCAL7,WF2DMAP_WAY_C_LEFT, \
							8*36,8*14,ON,EVENTID_TEST_SCR_OBJ1
	_ACTOR_DATA_END

_ACTOR_LABEL	default_set_actor_multi
	_PLAYER_ACTOR_DATA		OBJID_PLAYER,WF2DMAP_WAY_C_UP,8*36,8*14,OFF	/*自分自身のアクタセット*/
	_SIO_PLAYER_ACTOR_DATA	0,OBJID_SIO_USER_0,WF2DMAP_WAY_C_LEFT,8*36,8*14,ON
	_SIO_PLAYER_ACTOR_DATA	1,OBJID_SIO_USER_1,WF2DMAP_WAY_C_LEFT,8*36,8*16,ON
	_ACTOR_DATA				OBJID_BRAIN3_INFO,BRAINS3,WF2DMAP_WAY_C_RIGHT, \
							8*26,8*14,ON,EVENTID_TEST_SCR_OBJ1
	_ACTOR_DATA_END
...
ev_castle_start_2:
	...
	/*通信：トレーナー情報やりとり*/
	_CASTLE_TOOL		FC_ID_CHECK_COMM_TYPE,0,0,FSW_ANSWER
	_IFVAL_JUMP			FSW_ANSWER,EQ,1,ev_castle_multi_comm_tr
...
ev_castle_room_renshou_0:
	/*通信マルチ*/
	_CASTLE_TOOL	FC_ID_CHECK_COMM_TYPE,0,0,FSW_ANSWER
	_IFVAL_CALL		FSW_ANSWER,EQ,1,ev_castle_multi_room_enemy_poke_send2
...
ev_castle_room_go_rental_2_sub:
	...
	_BMPMENU_MAKE_LIST_TALK_MSG	msg_castle_room_choice_10,msg_castle_room_21,1	/*てもち*/
	_BMPMENU_MAKE_LIST_TALK_MSG	msg_castle_room_choice_11,msg_castle_room_22,2	/*トレーナー*/
	_BMPMENU_MAKE_LIST_TALK_MSG	msg_castle_room_choice_13,msg_castle_room_24,4	/*たいせん*/
...
ev_castle_room_lap_3_make_list_lt:
	_BMPMENU_INIT_EX	24,11,0,0,FSW_ANSWER									/*Bキャンセル無効*/
...
ev_castle_room_lap_3_make_list_ge:
	...
	_CALL				ev_castle_brain_check

	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_1ST,ev_castle_room_lap_3_make_list_lt
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_2ND,ev_castle_room_lap_3_make_list_lt

	_BMPMENU_INIT_EX	24,9,0,0,FSW_ANSWER										/*Bキャンセル無効*/
	//_BMPLIST_INIT_EX	24,11,0,0,FSW_ANSWER									/*Bキャンセル無効*/
	_RET
...
ev_castle_room_lap_3_make_list_ge_nukemiti:
	...
	/*連勝数取得*/
	_CASTLE_TOOL		FC_ID_GET_RENSYOU,0,0,FSW_PARAM4						/*注意！*/
	_ADD_WK				FSW_PARAM4,1

#ifdef DEBUG_BRAIN_OFF	/********************************************/
	_LDVAL				FSW_PARAM4,CASTLE_LEADER_SET_1ST
#endif	/************************************************************/

	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_PARAM4,EQ,CASTLE_LEADER_SET_1ST,ev_castle_leader_nukemiti_off
	_IFVAL_JUMP			FSW_PARAM4,EQ,CASTLE_LEADER_SET_2ND,ev_castle_leader_nukemiti_off

	_BMPMENU_MAKE_LIST_TALK_MSG	msg_castle_room_choice_14,msg_castle_room_25,5	/*ぬけみち*/
...
ev_castle_temoti_go:
	...
	/*通信マルチ*/
	_CASTLE_TOOL		FC_ID_CHECK_COMM_TYPE,0,0,FSW_ANSWER
	_IFVAL_CALL			FSW_ANSWER,EQ,1,ev_castle_comm_command_initialize
...
/*																	*/
/********************************************************************/
ev_castle_comm_command_initialize:
	_CASTLE_TOOL		FC_ID_COMM_COMMAND_INITIALIZE,0,0,FSW_ANSWER
	_TIME_WAIT			1,FSW_ANSWER
	_RET
...
ev_castle_room_go_2:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_1ST,ev_castle_leader_1st_02
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_2ND,ev_castle_leader_2nd_02
...
ev_castle_battle:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_1ST,ev_castle_leader_1st_33
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_2ND,ev_castle_leader_2nd_33
...
ev_castle_battle_2:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_1ST,ev_castle_leader_1st_03
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_2ND,ev_castle_leader_2nd_03
...
ev_castle_battle_6_sub:
	...
	/*取得CPによってメッセージをかえる*/
	_PLAYER_NAME		1
	_IFVAL_JUMP			FSW_PARAM4,GE,70,ev_castle_cp_num_01
	_IFVAL_JUMP			FSW_PARAM4,GE,45,ev_castle_cp_num_02
	_IFVAL_JUMP			FSW_PARAM4,GE,20,ev_castle_cp_num_03
...
ev_castle_cp_num_multi:
	/*「しばらくお待ちください」*/
	//_TALKMSG_ALL_PUT	msg_castle_room_wait				/*★*/
	_CALL				ev_castle_multi_comm_basic_call
	//_TALK_CLOSE											/*★*/
	_RET
...
ev_castle_room_saikai:
	...
	/*ブレーン登場かチェック*/
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_1ST,ev_castle_leader_1st_01
	_IFVAL_JUMP			FSW_ANSWER,EQ,CASTLE_LEADER_SET_2ND,ev_castle_leader_2nd_01
...
ev_castle_room_menu_make:
	...
	/*パスを選択していなかったら「きろくする」メニュー追加*/
	_IFVAL_JUMP		FSW_LOCAL5,EQ,0,ev_castle_room_menu_make_04_set
...
ev_castle_room_menu_make_comm:
	...
	/*パスを選択していなかったら「きろくする」メニュー追加*/
	_IFVAL_JUMP		FSW_LOCAL5,EQ,0,ev_castle_room_menu_make_02_set
...
ev_castle_room_menu_make_01:
	...
	_BMPMENU_MAKE_LIST	msg_castle_room_choice_01,0		/*つづける*/
...
ev_castle_room_menu_make_02:
	...
	_BMPMENU_MAKE_LIST	msg_castle_room_choice_01,0		/*つづける*/
	_BMPMENU_MAKE_LIST	msg_castle_room_choice_02,1		/*きろくする*/
	_JUMP			ev_castle_room_yasumu_next
	_END
...
ev_castle_room_menu_make_03:
	...
	_BMPMENU_MAKE_LIST	msg_castle_room_choice_01,0		/*つづける*/
	_BMPMENU_MAKE_LIST	msg_castle_room_choice_03,2		/*やすむ*/
	_JUMP			ev_castle_room_yasumu_next
	_END
...
ev_castle_room_yasumu_next:
	_BMPMENU_MAKE_LIST	msg_castle_room_choice_04,3		/*リタイア*/
	_BMPMENU_START
...
/*			連勝数を取得(ブレーンチェック用)(FSW_ANSWER使用)		*/
/********************************************************************/
ev_castle_brain_check:
	/*連勝数取得*/
	_CASTLE_TOOL		FC_ID_GET_RENSYOU,0,0,FSW_ANSWER
	_ADD_WK				FSW_ANSWER,1

#ifdef DEBUG_BRAIN_OFF	/********************************************/
	_LDVAL				FSW_ANSWER,CASTLE_LEADER_SET_1ST
#endif	/************************************************************/
