...
#define MINE_WIN_TALKMENU2_CGX	(MINE_WIN_TALK_CGX + MINE_WIN_TALK_SX *MINE_WIN_TALK_SY)
...
#define MINE_WIN_BASIC_LIST_CGX	(MINE_WIN_TALKMENU_CGX + MINE_WIN_TALKMENU_SX * MINE_WIN_TALKMENU_SY)
