...
static void Title3D_ModelLoad( TITLE_3DWORK* g3Dwk, int dataID, int texanmID, int heapID)
{
	...
	g3Dwk->resanm2 = ArchiveDataLoadMalloc(ARC_TITLE_PL,NARC_titledemo_pl_title_gira_nsbca,heapID);
...
static void Title3D_DemoModelLoad(TITLE_3DWORK *g3Dwk, int heapID)
{
	...
	{//顔
		//モデルデータ読み込み
		D3DOBJ_MdlLoadH(&g3Dwk->kao_mdl, hdl, NARC_titledemo_pl_op_kao_nsbmd, heapID);
		...
		D3DOBJ_AnmLoadH(&g3Dwk->kao_ica_anm, &g3Dwk->kao_mdl, hdl, 
			NARC_titledemo_pl_op_kao_nsbca, heapID, &g3Dwk->allocater);
		D3DOBJ_AnmSet(&g3Dwk->kao_ica_anm, 0);
		//imaアニメデータ読み込み
		D3DOBJ_AnmLoadH(&g3Dwk->kao_ima_anm, &g3Dwk->kao_mdl, hdl, 
			NARC_titledemo_pl_op_kao_nsbma, heapID, &g3Dwk->allocater);
	...
	{//穴
		//モデルデータ読み込み
		D3DOBJ_MdlLoadH(&g3Dwk->ana_mdl, hdl, NARC_titledemo_pl_op_ana_nsbmd, heapID);
		...
		D3DOBJ_AnmLoadH(&g3Dwk->ana_ica_anm, &g3Dwk->ana_mdl, hdl, 
			NARC_titledemo_pl_op_ana_nsbca, heapID, &g3Dwk->allocater);
		D3DOBJ_AnmSet(&g3Dwk->ana_ica_anm, 0);
		//itaアニメデータ読み込み
		D3DOBJ_AnmLoadH(&g3Dwk->ana_ita_anm, &g3Dwk->ana_mdl, hdl, 
			NARC_titledemo_pl_op_ana_nsbta, heapID, &g3Dwk->allocater);
...
static BOOL TitleDemo_Init( TITLE_TITLEDEMO_WORK* wk, GF_BGL_INI* bgl,int heapID )
{
	...
	Title3D_ModelLoad( &wk->poke, 
						NARC_titledemo_pl_title_gira_nsbmd, 
						NARC_titledemo_pl_title_gira_nsbta, 
						heapID );
	...
	case TDSEQ_TITLE_EF_CAMERAMOVE:
		{
			...
			///	wk->poke.anm_flag = DRAW3DANM_STOP;		///< PLはアニメをとめない
...
static void Title2DGraphicSet(GF_BGL_INI* ini,int heapID, TITLE_TITLEDEMO_WORK* wk )
{
	{	// 背景
		...
		palIDm = NARC_titledemo_pl_title_back_m_pla_NCLR;
		palIDs = NARC_titledemo_pl_title_back_s_pla_NCLR;
	...
	{	// ロゴ
		int cgxID,palID;
		cgxID = NARC_titledemo_pl_logo_pla_NCGR;
		palID = NARC_titledemo_pl_logo_pla_NCLR;
	...
	{	// copyright
		ArcUtil_BgCharSet	//キャラ
			(ARC_TITLE_PL,NARC_titledemo_pl_title_cpright_NCGR,ini,TITLE_CPRIGHT_FRAME,0,0,0,heapID);
		ArcUtil_ScrnSet		//スクリーン
			(ARC_TITLE_PL,NARC_titledemo_pl_title_cpright_NSCR,ini,TITLE_CPRIGHT_FRAME,0,0,0,heapID);
		ArcUtil_PalSet		//パレット(ガイドウインドウ用込み)
			(ARC_TITLE_PL,NARC_titledemo_pl_title_cpright_NCLR,TITLE_GF_PALTYPE,32*1,32*3,heapID);
	}
...
static void Title2DGraphicSetEffect(GF_BGL_INI* ini,int heapID, TITLE_TITLEDEMO_WORK* wk )
{
	...
	if( wk->wait_counter == 0 ){
		cgxID = NARC_titledemo_pl_Pla_logo01_NCGR;
		palID = NARC_titledemo_pl_Pla_logo01_NCLR;
...
#define TD_TITLEPL_CMR_CPY_ST			(FX32_ONE * 256)
#define TD_TITLEPL_CMR_CPZ_ST			(FX32_ONE * 420)
...
///< ターゲット	開始
#define TD_TITLEPL_CMR_TPX_ST			(FX32_ONE * 64)
#define TD_TITLEPL_CMR_TPY_ST			(FX32_ONE * 34)
