 ...
 *
 * @param	pKiraDataListPtr	データリストポインタ	
 * @param   kira_vanish			TRUE:強制非表示
 *
 * @return	none
 */
//--------------------------------------------------------------------------------------------
void Scene2_KiraGenerateMain(OPD_KIRA_DATLST_PTR pKiraDataListPtr, int kira_vanish)
{
	Scene2_GenerateKira( pKiraDataListPtr, 2, kira_vanish);
}
