...
//ＶＲＡＭ設定
//----------------------------------
#define LIBRARY_TV_NULL_PALETTE		( 0x0000 )		//ＢＧバックグラウンドパレット
#define PALSIZE					( 2*16 )
...
static void LibraryTV_VramBankSet( LIBRARY_TV_DEMO_WORK* wk )
{
	...
	GF_BGL_BackGroundColorSet( GF_BGL_FRAME0_M, LIBRARY_TV_NULL_PALETTE );	//背景色初期化
	GF_BGL_BackGroundColorSet( GF_BGL_FRAME0_S, LIBRARY_TV_NULL_PALETTE );	//背景色初期化
...
//テロップ表示
//----------------------------------
#define LIBRARY_TV_STRBUF_SIZE		(0x400)	//メッセージバッファサイズ
#define DOTSIZE						( 8 )
