...
//==============================================================================
/**
 * @brief   生まれたタマゴ用の個性乱数の取得
 *
 * @param   sw		
 *
 * @retval  int		0:タマゴが無い  0以外:生まれるポケモン用の個性乱数
 */
//==============================================================================
...
//==============================================================================
/**
 * タマゴが生まれているか設定(個性乱数を設定する）
 *
 * @param   sw		
 * @param   flag	個性乱数が入る（0:タマゴは無い 0以外:生まれるタマゴの個性乱数）
 *
 * @retval  none
 */
//==============================================================================
