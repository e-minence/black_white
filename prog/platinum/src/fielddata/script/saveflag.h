...
//#define FE_T07_HOME_BUY					(FE_FLAG_START+119)	//家購入したか
...
#define	FE_D32_JUDGE_TALK				(FE_FLAG_START+155)	//個体判定の人と会話したか
...
#if 0
#define	FV_			(FV_FLAG_START+342)		//dummy
#define	FV_			(FV_FLAG_START+343)		//dummy
#define	FV_			(FV_FLAG_START+344)		//dummy
#define	FV_			(FV_FLAG_START+345)		//dummy
#define	FV_			(FV_FLAG_START+346)		//dummy
