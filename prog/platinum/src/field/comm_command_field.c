...
static const CommPacketTbl _CommPacketTbl[] = {
    ...
    { CommDummyCallBack, _getZero,			 NULL},	//ぐるぐる交換用テーブル
    { CommDummyCallBack, _getZero,			 NULL},

	{CommFldStageRecvMonsNo,		_getVariable,	NULL},		//ステージ
	{CommFldCastleRecvMonsNo,		_getVariable,	NULL},		//キャッスル
	{CommFldRouletteRecvMonsNo,		_getVariable,	NULL},		//ルーレット
