...
extern u32 FE_HeapIDGet( const FE_SYS *fes );
...
extern void FE_FROMdl_ResSetArcLoad( FE_SYS *fes, FRO_MDL *rmdl,
		u32 idx, u32 arc_idx, ALLOC_TYPE alloc_type );
extern void FE_FROMdl_ResSetArcLoadTexTrans( FE_SYS *fes, FRO_MDL *rmdl,
		u32 idx, u32 arc_idx, ALLOC_TYPE alloc_type );
extern void FE_FROAnm_AnmResSetArcLoad( FE_SYS *fes, FRO_ANM *ranm, 
		u32 idx, u32 arc_idx, u32 alloc_type );
extern void FE_FROAnm_AnmResObjInitSame( FE_SYS *fes, FRO_ANM *ranm, const FRO_MDL *rmdl,
		FRO_ANM *m_ranm, u32 idx );
