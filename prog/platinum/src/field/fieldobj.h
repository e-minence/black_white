...
#define FLDOBJ_MOVE_BIT_ATTR_GET_OFF		(1<<2)			///<アトリビュート取得を一切行わない
...
extern void FieldOBJ_MoveBitSet_AttrGetOFF( FIELD_OBJ_PTR fldobj, int flag );
extern int FieldOBJ_MoveBitCheck_AttrGetOFF( CONST_FIELD_OBJ_PTR fldobj );
...
extern FIELD_OBJ_PTR FieldOBJ_SearchGridPos(
	CONST_FIELD_OBJ_SYS_PTR sys, int x, int z, int old_hit );
...
extern void FieldOBJ_MoveRoute4_Move( FIELD_OBJ_PTR fldobj );
...
extern void FieldOBJ_MoveCopyU_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopyD_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopyL_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopyR_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopyLGrassU_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopyLGrassD_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopyLGrassL_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopyLGrassR_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_MoveCopy_Move( FIELD_OBJ_PTR fldobj );

extern void FieldOBJ_AlongWallL_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_AlongWallR_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_AlongWallLRL_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_AlongWallLRR_Init( FIELD_OBJ_PTR fldobj );

extern void FieldOBJ_AlongWall_Move( FIELD_OBJ_PTR fldobj );
...
extern void FieldOBJ_DrawModel00_Init( FIELD_OBJ_PTR fldobj );
...
extern void FieldOBJ_DrawModel00_Pop( FIELD_OBJ_PTR fldobj );
...
extern void FieldOBJ_DrawBlActOff_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActOff_Delete( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActOff_Push( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActOff_Pop( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActOff_Draw( FIELD_OBJ_PTR fldobj );
extern u16 FieldOBJ_DrawBlActOff_RotateXGet( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActOff_RotateXSet( FIELD_OBJ_PTR fldobj, u16 rx );
extern u16 FieldOBJ_DrawBlActOff_RotateYGet( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActOff_RotateYSet( FIELD_OBJ_PTR fldobj, u16 rx );
extern u16 FieldOBJ_DrawBlActOff_RotateZGet( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActOff_RotateZSet( FIELD_OBJ_PTR fldobj, u16 rx );
