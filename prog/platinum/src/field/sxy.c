...
void SXY_HeroFrontObjGet( FIELDSYS_WORK * repw, FIELD_OBJ_PTR * obj )
{
	...
	*obj = FieldOBJ_SearchGridPos( repw->fldobjsys, gx, gz, FALSE );
}
 ...
 *
 * @param	repw	フィールドデータ
 * @param	obj		フィールドOBJデータ
 *
 * @retval	"TRUE = 起動ok"
 * @retval	"FALSE = OBJがいない"
 */
//--------------------------------------------------------------------------------------------
 ...
 * @param	size	BGデータサイズ
 *
 * @retval	"EVENT_ID_NONE = 看板なし"
 * @retvel	"EVENT_ID_NONE != 看板あり"
 */
//--------------------------------------------------------------------------------------------
