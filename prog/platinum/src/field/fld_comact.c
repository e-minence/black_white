...
FLD_COMACT_WORK* FComAct_Init(int heapID)
{
	...
	FldClact_LoadResPlttArcH(
		&wk->fcat, p_handle,NARC_fld_comact_fld_comact_nclr,
		0, 2, NNS_G2D_VRAM_TYPE_2DMAIN, FCOMACT_PAL_H_ID );

	FldClact_LoadResCellArcH(
		&wk->fcat, p_handle, NARC_fld_comact_fld_comact_ncer,
		0, FCOMACT_CEL_H_ID_CURSOR );

	FldClact_LoadResCellAnmArcH(
		&wk->fcat, p_handle, NARC_fld_comact_fld_comact_nanr,
		0, FCOMACT_ANM_H_ID_CURSOR );

	FldClact_LoadResourceCharArcH(
		&wk->fcat, p_handle, NARC_fld_comact_fld_comact_ncgr,
