...
//	FE_FLD_DOOR2,					///<フィールドOBJ　ドア２		3
	FE_FLD_FLDROBJ,					///<フィールドOBJ　レンダOBJ
	FE_FLD_GYM04EFF,				///<フィールド　草ジムエフェクト
	FE_FLD_GYM07EFF,				///<フィールド　格闘ジムエフェクト
	FE_FLD_GYM05EFF,				///<フィールド　ゴーストジムエフェクト
	FE_FLD_NAMIPOKER,				///<フィールド　回転波乗りポケモン
