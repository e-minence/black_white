...
GLOBAL void ENC_GPrint_SwitchOn(void);
GLOBAL BOOL ENC_GPrint_Check(void);
GLOBAL void ENC_GPrint_Draw(void);
GLOBAL void ENC_GPrint_Exit(void);

GLOBAL void ENC_GPrint_PTC_Load(ARCHANDLE* p_handle, u32 idx);
GLOBAL void ENC_GPrint_PTC_Start(u32 emitter_num);
GLOBAL BOOL ENC_GPrint_PTC_Move(void);
GLOBAL BOOL ENC_GPrint_PTC_EndCheck(void);
GLOBAL void ENC_GPrint_PTC_Delete(void);
