...
extern int EvTrainer_EyeRangeCheck(
	CONST_FIELD_OBJ_PTR fldobj, PLAYER_STATE_PTR jiki, int *hit_dir );

extern int EvTrainer_EyeRangeHitCheck(
	CONST_FIELD_OBJ_PTR fldobj, PLAYER_STATE_PTR jiki, int eye_dir, int eye_range );

extern int EvTrainerFldOBJTrainerIDGet( FIELD_OBJ_PTR fldobj );
extern int EvTrainer_FightFlagCheck( FIELDSYS_WORK *fsys, FIELD_OBJ_PTR fldobj );

extern TCB_PTR EvTrainerEyeMoveSet( FIELDSYS_WORK *fsys, FIELD_OBJ_PTR fldobj, PLAYER_STATE_PTR jiki,
