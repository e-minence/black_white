...
static u16 GetWazaOshieDataCount( POKEMON_PARAM* poke );
...
BOOL EvCmdWazaOshieDataCount( VM_MACHINE * core )
{
	...
	*ret_wk = GetWazaOshieDataCount( poke );
	return 0;
}
...
enum{
	...
	WAZAOSHIE_MINO_G	= 499,
	WAZAOSHIE_MINO_M	= 500,

	WAZAOSHIE_KIMA		= 501,

	WAZAOSHIE_EU		= 502,

	WAZAOSHIE_PURA_1	= 503,
	WAZAOSHIE_PURA_2	= 504,
	WAZAOSHIE_PURA_3	= 505,
	WAZAOSHIE_PURA_4	= 506,
	WAZAOSHIE_PURA_5	= 507,
};
