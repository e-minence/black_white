...
static u8 CheckCMTable[] = {
	...
	FLAG_AnytimeDisable,			///<バトルタワー	C11到着■
	FLAG_AnytimeDisable,			///< Wi-Fiバトルタワー	C11到着■
	FLAG_GameClearCheck,			///<乗り物ＣＭ（船）	殿堂入り後
	FLAG_C11Check,					///<バトルステージ	C11到着★
	FLAG_C11Check,					///<バトルキャッスル	C11到着★
	FLAG_C11Check,					///<バトルルーレット	C11到着★
	FLAG_C11Check,					///<バトルファクトリー	C11到着★
	FLAG_AnytimeEnable,				///<グローバルタワー	最初から★
	FLAG_AnytimeEnable,				///<WIFIひろば	最初から★
};
 ...
 *
 * tvcm.gmmのmsgIDとして使用している([32]をCMの数が増えたら対応しないとダメ！)★
 * tvcm.gmmのmsgIDとして使用している([36]をCMの数が増えたら対応しないとダメ！)★
 */
//--------------------------------------------------------------------
