...
extern int (* const DATA_AC_JumpU_3G_24F_Tbl[])( FIELD_OBJ_PTR  );
extern int (* const DATA_AC_JumpD_3G_24F_Tbl[])( FIELD_OBJ_PTR  );
extern int (* const DATA_AC_JumpL_3G_24F_Tbl[])( FIELD_OBJ_PTR  );
...
extern int (* const DATA_AC_WalkGLL8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGLR8F_Tbl[])( FIELD_OBJ_PTR );

extern int (* const DATA_AC_WalkGRU8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGRD8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGRL8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGRR8F_Tbl[])( FIELD_OBJ_PTR );

extern int (* const DATA_AC_WalkGUU8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUD8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUL8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUR8F_Tbl[])( FIELD_OBJ_PTR );

extern int (* const DATA_AC_DashGLU4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGLD4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGLL4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGLR4F_Tbl[])( FIELD_OBJ_PTR );

extern int (* const DATA_AC_DashGRU4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGRD4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGRL4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGRR4F_Tbl[])( FIELD_OBJ_PTR );

extern int (* const DATA_AC_DashGUU4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGUD4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_DashGUL4F_Tbl[])( FIELD_OBJ_PTR );
...
extern int (* const DATA_AC_JumpGLL1G_8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_JumpGLR1G_8F_Tbl[])( FIELD_OBJ_PTR );

extern int (* const DATA_AC_JumpGRU1G_8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_JumpGRD1G_8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_JumpGRL1G_8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_JumpGRR1G_8F_Tbl[])( FIELD_OBJ_PTR );

extern int (* const DATA_AC_JumpGUU1G_8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_JumpGUD1G_8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_JumpGUL1G_8F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_JumpGUR1G_8F_Tbl[])( FIELD_OBJ_PTR );
...
{
	MV_COPYU,												///<動作コード
	FieldOBJ_MoveCopyU_Init,								///<初期化関数
	FieldOBJ_MoveCopy_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
static const FIELD_OBJ_MOVE_PROC_LIST DATA_FieldOBJMove_CopyLGrassU =
{
	...
	FieldOBJ_MoveCopyLGrassU_Init,								///<初期化関数
	FieldOBJ_MoveCopy_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
static const FIELD_OBJ_MOVE_PROC_LIST DATA_FieldOBJMove_CopyLGrassD =
{
	...
	FieldOBJ_MoveCopyLGrassD_Init,								///<初期化関数
	FieldOBJ_MoveCopy_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
static const FIELD_OBJ_MOVE_PROC_LIST DATA_FieldOBJMove_CopyLGrassL =
{
	...
	FieldOBJ_MoveCopyLGrassL_Init,								///<初期化関数
	FieldOBJ_MoveCopy_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
static const FIELD_OBJ_MOVE_PROC_LIST DATA_FieldOBJMove_CopyLGrassR =
{
	...
	FieldOBJ_MoveCopyLGrassR_Init,								///<初期化関数
	FieldOBJ_MoveCopy_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
{
	MV_ALONGW_L,												///<動作コード
	FieldOBJ_AlongWallL_Init,								///<初期化関数
	FieldOBJ_AlongWall_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
{
	MV_ALONGW_R,												///<動作コード
	FieldOBJ_AlongWallR_Init,								///<初期化関数
	FieldOBJ_AlongWall_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
{
	MV_ALONGW_LRL,												///<動作コード
	FieldOBJ_AlongWallLRL_Init,								///<初期化関数
	FieldOBJ_AlongWall_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
...
{
	MV_ALONGW_LRR,												///<動作コード
	FieldOBJ_AlongWallLRR_Init,								///<初期化関数
	FieldOBJ_AlongWall_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
