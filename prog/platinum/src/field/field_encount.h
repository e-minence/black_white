...
extern void EventCmd_WildBattleEventGet(GMEVENT_CONTROL * event, u16 monsno, u8 level, int * win_flag,BOOL densetsu);
extern void EventCmd_FirstBattle(GMEVENT_CONTROL * event, int tr_id_0, int heapID, int * winlose_flag);
...
extern void EventCmd_GirathinaWildBattle( GMEVENT_CONTROL * event,
