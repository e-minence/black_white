 ...
 */
//--------------------------------------------------------------------------------------------
BOOL EvCmdStatusName(VM_MACHINE * core ) 
{
	FIELDSYS_WORK * fsys	= core->fsys;
	WORDSET** wordset		= GetEvScriptWorkMemberAdrs( fsys, ID_EVSCR_WORDSET );
	u8 idx					= VMGetU8(core);
	u8 status				= VMGetWorkValue(core);

	WORDSET_RegisterPokeStatusName( *wordset, idx, status );
	return 0;
}
 ...
 */
//--------------------------------------------------------------------------------------------
BOOL EvCmdTypeName(VM_MACHINE * core ) 
{
	FIELDSYS_WORK * fsys	= core->fsys;
	WORDSET** wordset		= GetEvScriptWorkMemberAdrs( fsys, ID_EVSCR_WORDSET );
	u8 idx					= VMGetU8(core);
	...
	WORDSET_RegisterPokeTypeName( *wordset, idx, type );
	return 0;
}
 ...
 */
//--------------------------------------------------------------------------------------------
BOOL EvCmdNumberNameEx32(VM_MACHINE * core ) 
{
	FIELDSYS_WORK * fsys	= core->fsys;
	WORDSET** wordset		= GetEvScriptWorkMemberAdrs( fsys, ID_EVSCR_WORDSET );
	u8 idx					= VMGetU8(core);
	u32 num					= VMGetU32(core);
	u8	dtype				= VMGetU8(core);
	u8	keta				= VMGetU8(core);
	...
	WORDSET_RegisterNumber( *wordset, idx, num, keta, 
							dtype, NUMBER_CODETYPE_DEFAULT );
 ...
 */
//--------------------------------------------------------------------------------------------
BOOL EvCmdTrainerName(VM_MACHINE * core ) 
{
	FIELDSYS_WORK * fsys	= core->fsys;
	WORDSET** wordset		= GetEvScriptWorkMemberAdrs( fsys, ID_EVSCR_WORDSET );
	u8 idx					= VMGetU8(core);
	u16 trid				= VMGetWorkValue(core);

	WORDSET_RegisterTrainerName( *wordset, idx, trid );
	return 0;
}
