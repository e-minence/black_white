...
#define	HEAD_OBJ_RECOVER_CTRL	7	///< EvOBJ復帰時の操作
*/
...
#define		TR_TYPE_PYRAMID		9		// バトルピラミッドトレーナー by soga 2004.01.09
#define		TR_TYPE_SET			10		// トレーナーデータのセットのみ by soga 2004.03.16
#define		TR_TYPE_SET2		11		// トレーナーデータのセットのみ by soga 2004.03.16
#define		TR_TYPE_HILL		12		//　トレーナーヒルトレーナー//<<20040510 add
*/
