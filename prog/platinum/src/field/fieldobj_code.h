...
#define MV_CODE_MAX		0x43		///<コード最大（プログラム判定専用
...
#define ACMD_MAX				0x91		///<アニメーションコマンド最大数
...
/*
#define SAVEHERORT		0x0102
#define SAVEHEROINERT	0x0103
#define POKEHERORT		0x0108
#define POKEHEROINERT	0x0109
*/
...
#define BLACT_MDLID_32x32HEROONLY	0x0009	///<32x32 ゴーストジム自機専用
