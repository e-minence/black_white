...
// BG 設定
...

	{
		...
		hdl = ArchiveDataHandleOpen( ARC_POKETCH_IMG, HEAPID_POKETCH_APP );

		ArcUtil_HDL_BgCharSet(hdl, NARC_poketch_before_lz_ncgr, bgl, GF_BGL_FRAME0_S,
			0, 0, TRUE, HEAPID_POKETCH_APP);
		ArcUtil_HDL_ScrnSet(hdl, NARC_poketch_before_lz_nscr, bgl, GF_BGL_FRAME0_S,
			0, 0, TRUE, HEAPID_POKETCH_APP);
