...
//==============================================================================
/**
 *	アニメーション追加　非常駐アニメのみ対応
 * 
 * @param		inObjID				OBJID
 * @param		inObjectModel		リソースモデル
 * @param		inTex				テクスチャ
 * @param		inAnimeNum			アニメ数
 * @param		inLoopCount			ループ数
 * @param		inReverse			逆再生フラグ
 * @param		field_3d_anime_ptr	3Dアニメーションマネージャへのポインタ
 * @param		outData				アニメデータ
 *
 * @retrun		none
 *
 */
 ...
 * 
 *
 * @retrun		ANIME_CONT_MNG_PTR		アニメーション管理マネージャへのポインタ
 *
 */
//==============================================================================
 ...
 * 
 *
 * @param		outAnimeContMng		アニメーション管理マネージャへのポインタ
 *
 * @return		none
 *
 */
 ...
 * @param		inEntryID				エントリーＩＤ
 * @param		inObjID					ＯＢＪＩＤ
 * @param		inRenderObj				レンダーＯＢＪ
 * @param		inObjectModel			ＯＢＪモデル
 * @param		inTex					テクスチャ
 * @param		inAnimeNum				アニメ数
 * @param		inLoop					ループ数
 * @param		inReverse				逆再生フラグ
 ...
 * @param		inAnimeNo				アニメナンバー
 *
 * @return		FLD_3D_ANM_DAT_PTR		アニメポインタ
 *
 */
//==============================================================================
 ...
 * @param		inEntryID				エントリーＩＤ
 *
 * @return		BOOL		TRUE:アニメ終了		FALSE:アニメ継続
 *
 */
//==============================================================================
