...
typedef enum {
	...
	TVTOPIC_WATCH_VILLA,				///<別荘★
	TVTOPIC_WATCH_RECONSTRUCTION,		///<改築★
...
typedef enum {
	...
	TVTOPIC_RECORD_BP,				///<バトルポイント名人★
	TVTOPIC_RECORD_GTS,				///<GTS名人★
...
typedef enum {
	...
	TVTOPIC_INTERVIEW_STAGE,		///<バトルステージ★
	TVTOPIC_INTERVIEW_STRANGE1,		///<へんなアンケート★
	TVTOPIC_INTERVIEW_STRANGE2,		///<へんなアンケート★
	TVTOPIC_INTERVIEW_STRANGE3,		///<へんなアンケート★
	TVTOPIC_INTERVIEW_STRANGE4,		///<へんなアンケート★
	TVTOPIC_INTERVIEW_FRIEND,		///<フロンティアで仲良し★
...
//----------------------------------------------------------
/**
 * @brief	TVトピック：バラエティ型タイプ定義★
 */
//----------------------------------------------------------
typedef enum {
	TVTOPIC_VARIETY_SEARCH_PARTY = 1,	///<ポケモン捜索隊★
	TVTOPIC_VARIETY_LEADER,				///<マキシマム試合中継★
	TVTOPIC_VARIETY_DORAMA1,			///<連続テレビドラマ★
	TVTOPIC_VARIETY_DORAMA2,			///<連続テレビドラマ★
	TVTOPIC_VARIETY_DORAMA3,			///<連続テレビドラマ★
	TVTOPIC_VARIETY_DORAMA4,			///<連続テレビドラマ★
	TVTOPIC_VARIETY_DORAMA5,			///<連続テレビドラマ★
	TVTOPIC_VARIETY_DORAMA6,			///<連続テレビドラマ★
...
typedef enum {
	...
	CM_TYPE_CONTEST,			///<美容室	
	CM_TYPE_NATURE_PARK,		///<コンテストＣＭ	ハクタイ到着					//10
	...
	CM_TYPE_SHIP_C09,			///<キッサキシティの船	シンオウ図鑑コンプ			//20
	...
	CM_TYPE_STAGE,				///<バトルステージ		c11到着から★				//30
	CM_TYPE_CASTLE,				///<バトルキャッスル	c11到着から★
	CM_TYPE_ROULETTE,			///<バトルルーレット	c11到着から★
	CM_TYPE_FACTORY,			///<バトルファクトリー	c11到着から★
	CM_TYPE_GLOBAL_TOWER,		///<グローバルタワー最初から★
	CM_TYPE_WIFI_HIROBA,		///<WIFI広場		最初から★						//35
