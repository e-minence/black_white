...
extern WORLD_MAP_PTR WorldMapInitHeap( u32 heap_id );
extern void WorldMapRelease(const WORLD_MAP_PTR world);
extern void WorldMapRemove( WORLD_MAP_PTR re_world, WORLD_MAP_PTR world );
extern void WorldMapSetOrigin( WORLD_MAP_PTR world, u8 w, u8 h );
