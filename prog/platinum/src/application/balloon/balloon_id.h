...
//--------------------------------------------------------------
enum{
	PALOFS_SUB_AIR_D = 1,			///<空気：下
	PALOFS_SUB_AIR_L = 2,			///<空気：左
	PALOFS_SUB_AIR_U = 2,			///<空気：上
	PALOFS_SUB_AIR_R = 1,			///<空気：右

	PALOFS_SUB_EXPLODED = 0,			///<空気：下
	PALOFS_SUB_EXPLODED_CHIP_BLUE =1,		///<破片:青
	PALOFS_SUB_EXPLODED_CHIP_RED =2,		///<破片:赤
	PALOFS_SUB_EXPLODED_CHIP_YELLOW =3,		///<破片:黄
	...
	BALLOON_SUB_COMMON_PAL_NUM = 5,	///<サブ画面の常駐OBJパレットの本数
};
