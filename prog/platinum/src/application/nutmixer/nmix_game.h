...
typedef struct {
	...
	u8 main_seq_req;	///<通信コールバックからのシーケンス変更お願い
	u8 ex_mainseq_chg_req;	///<強制シーケンス変更
	u8 ex_mainseq_req;		///<強制シーケンス変更
	u8 pad;
...
extern void NMIX_EXSetMainSeq( NMIX_GAMEWORK* p_work, int seq );
