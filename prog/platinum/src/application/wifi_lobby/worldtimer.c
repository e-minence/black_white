...
enum{	// メイン
	...
	WLDTIMER_PALMAIN_NONE00,
	WLDTIMER_PALMAIN_NONE01,
...
// メイン画面のシステムウィンドウ
#define WLDTIMER_MAIN_SYSTEMWIN_CGX		(1)
...
static void WLDTIMER_PokeBaloon_Start( WLDTIMER_POKEBALLOON* p_wk, u32 drawtype, WLDTIMER_VWND* p_wnd );
...
static u32 WLDTIMER_EarthControl( WLDTIMER_WK* p_wk )
{
	...
	//終了判定
	if((sys.trg & PAD_BUTTON_B)||(p_wk->touch.tp_result & PAD_BUTTON_B))
	{
