...
///	マップ配置人物のプレイヤーNO
//=====================================
#define WFLBY_MAPPERSON_ID	( 0xff )
...
//=====================================
typedef struct {
	u8  plidx[ WFLBY_MINIGAME_MAX ];	// 全プレイヤー分のVIPフラグ
...
extern int WFLBY_ERR_GetStrID( int errno );
extern WFLBY_ERR_TYPE WFLBY_ERR_GetErrType( int errno );
