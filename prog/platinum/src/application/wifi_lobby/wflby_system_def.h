...
extern const WFLBY_USER_PROFILE* WFLBY_SYSTEM_GetMyProfile( const WFLBY_SYSTEM* cp_wk );
extern WFLBY_USER_PROFILE* WFLBY_SYSTEM_GetMyProfileLocal( WFLBY_SYSTEM* p_wk );
...
extern void WFLBY_SYSTEM_SetLastAction( WFLBY_SYSTEM* p_wk, WFLBY_GAMETYPE action );
...
extern u32 WFLBY_SYSTEM_GetProfileLastAction( const WFLBY_USER_PROFILE* cp_profile );
...
// plidxはプレイヤーインデックス
// floatはプレイヤーインデックス
extern BOOL WFLBY_SYSTEM_GetFloatMove( const WFLBY_SYSTEM* cp_wk, u32 floatidx );
...
#ifdef PM_DEBUG
extern void WFLBY_SYSTEM_SetProfileItemDEBUG( WFLBY_USER_PROFILE* p_profile, WFLBY_ITEMTYPE item );
#endif
