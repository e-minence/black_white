...
//
//			入り口
static const u32 sc_WFLBY_FIRE_CONT_KOUGO_FIRE_IDX[] = {
	6, 13, 5, 11,
	7, 14, 8, 12,
	1,  0, 2, 10,
	16, 9, 4, 3, 
...
// 波用花火発射データ
// [花火配置図]参照
static const u32 sc_WFLBY_FIRE_CONT_NAMI_00_IDX[] = {
	5,  13, 6, 7, 14, 8,
};
static const u32 sc_WFLBY_FIRE_CONT_NAMI_01_IDX[] = {
	11, 12,
};
static const u32 sc_WFLBY_FIRE_CONT_NAMI_02_IDX[] = {
	15, 16,	
};
static const u32 sc_WFLBY_FIRE_CONT_NAMI_03_IDX[] = {
	4,	
};
static const u32 sc_WFLBY_FIRE_CONT_NAMI_04_IDX[] = {
	3,
};
static const u32 sc_WFLBY_FIRE_CONT_NAMI_05_IDX[] = {
	9, 10,
};
static const u32 sc_WFLBY_FIRE_CONT_NAMI_06_IDX[] = {
	1, 2, 0,
};
// 波シーケンスごとの　発射　停止　フラグ
static const u32 sc_WFLBY_FIRE_CONT_NAMI_ONOFF_FLAG[ WFLBY_FIRE_CONT_NAMI_SEQ_NUM ][ WFLBY_FIRE_CONT_NAMI_FLAG_NUM ] = {
	{ 0, 5 },
	{ 1, 6 },
	{ 2, 0 },
	{ 3, 1 },
...
WFLBY_FIRE_CONT* WFLBY_FIRECONT_Init( const WFLBY_SYSTEM* cp_system, WFLBY_3DMAPOBJ_CONT* p_mapobjcont, u32 heapID )
{
	...
	if( WFLBY_EVENT_HANABI_PLAY == p_wk->last_hanabi_st ){
