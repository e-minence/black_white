...
void BB_disp_Light_Add( BB_CLIENT* wk )
{
	...
	for ( i = 0; i < BB_LIGHT_MAX; i++ ){
		BB_disp_COAP_SimpleInit( &coap, 128, 128, CATS_D_AREA_MAIN, eBB_OAM_PAL_BD_LIGHT, eBB_ID_LIGHT_M );
		coap.bg_pri = 2;
		coap.pri	= 20;
		...
		BB_disp_COAP_SimpleInit( &coap, 128, 128, CATS_D_AREA_SUB, eBB_OAM_PAL_TD_MANENE, eBB_ID_OAM_S );
		coap.bg_pri = 2;
		coap.pri	= 20;
