...
static void LoadHeightY_man( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap );
static void LoadHeightY_girl( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap );
static void LoadHeightScale_man( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap );
static void LoadHeightScale_girl( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap );
...
void ZKN_HEIGHTGRAM_Load( ZKN_HEIGHT_GRAM_PTR p_heightgram, int type, int heap )
{
	...
	p_handle = ArchiveDataHandleOpen( ARC_ZUKAN_DATA, heap );
	...
	if( type == ZKN_HEIGHT_GRAM_TYPE_MAN ){
		...
		LoadHeightY_girl( p_handle, &p_heightgram->p_height_y, &p_heightgram->p_height_y_poke, heap );
		LoadHeightScale_girl( p_handle, &p_heightgram->p_height_scale, &p_heightgram->p_height_scale_poke, heap );
	}
...
static int* LoadHeight( ARCHANDLE* p_handle, int heap )
{
	...
	buff = ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_dat, FALSE, heap, ALLOC_TOP );
...
static int* LoadGram( ARCHANDLE* p_handle, int heap )
{
	...
	buff = ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_gram_dat, FALSE, heap, ALLOC_TOP );
...
static void LoadHeightY_man( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap )
{
	...
	*p_hero = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_y_man_dat, FALSE, heap, ALLOC_TOP );
	*p_poke = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_y_man_poke_dat, FALSE, heap, ALLOC_TOP );
}
...
static void LoadHeightY_girl( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap )
{
	*p_hero = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_y_girl_dat, FALSE, heap, ALLOC_TOP );
	*p_poke = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_y_girl_poke_dat, FALSE, heap, ALLOC_TOP );
}
...
static void LoadHeightScale_man( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap )
{
	*p_hero = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_scale_man_dat, FALSE, heap, ALLOC_TOP );
	*p_poke = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_scale_man_poke_dat, FALSE, heap, ALLOC_TOP );
}
...
static void LoadHeightScale_girl( ARCHANDLE* p_handle, short** p_hero, short** p_poke, int heap )
{
	*p_hero = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_scale_girl_dat, FALSE, heap, ALLOC_TOP );
	*p_poke = (short*)ArcUtil_HDL_Load( p_handle, NARC_zukan_data_zkn_height_scale_girl_poke_dat, FALSE, heap, ALLOC_TOP );
}	
