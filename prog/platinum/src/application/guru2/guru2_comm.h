...
///	通信ワーク
//--------------------------------------------------------------
#define GURU2_WIDEUSE_SENDWORK_SIZE (16)	///汎用送信データ最大
...
extern BOOL Guru2Comm_PokeSelCancelCheck( GURU2COMM_WORK *g2c );
