...
static void initAcceIconWork( IMC_SUBWIN_ACCEICON* p_data, CLACT_SET_PTR clact_set, CLACT_U_RES_MANAGER_PTR* p_res_man, int acce_max, ARCHANDLE* p_handle );
...
static void InitCounterWork( IMC_SUBWIN_TIMECOUNT* p_data, CLACT_SET_PTR clact_set, CLACT_U_RES_MANAGER_PTR* p_res_man, int count_max, GF_BGL_INI* p_bgini,  CON_IMC_LOCAL* p_comm_data, ARCHANDLE* p_handle );
