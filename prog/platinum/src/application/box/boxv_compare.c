...
static void SetupActors( COMPARE_VIEW_WORK* wk, ARCHANDLE* p_boxgra_handle );
 ...
 */
//------------------------------------------------------------------
BOOL BoxAppView_CompareInit( COMPARE_VIEW_WORK** wk_ptr_adrs, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, GF_BGL_INI* bgl, CLACT_SET_PTR actsys, MSGDATA_MANAGER* msgman, ARCHANDLE* p_boxgra_handle )
{
	...
	else
	{
		...
		if( wk )
		{
			...
			wk->arrowScrnLoadPtrL = ArcUtil_HDL_ScrnDataGet(p_boxgra_handle, NARC_box_bg1_compare_L_lz_nscr, TRUE, &(wk->arrowScrnDataL), HEAPID_BOX_VIEW );
			wk->arrowScrnLoadPtrR = ArcUtil_HDL_ScrnDataGet(p_boxgra_handle, NARC_box_bg1_compare_R_lz_nscr, TRUE, &(wk->arrowScrnDataR), HEAPID_BOX_VIEW );
 ...
 */
//------------------------------------------------------------------
void BoxAppView_SetupCompare( COMPARE_VIEW_WORK* wk, ARCHANDLE* p_boxgra_handle )
{
	if( wk )
	{
		UpdateArrowBgScreen( wk );

		ArcUtil_HDL_BgCharSet( p_boxgra_handle, NARC_box_compare_bg_sub_lz_ncgr, wk->bgl, FRM_SUB_COMPARE_PAGE1, 0, 0, TRUE, HEAPID_BOX_VIEW);
		ArcUtil_HDL_ScrnSet(p_boxgra_handle, NARC_box_compare_bg_sub_page1_lz_nscr, wk->bgl, FRM_SUB_COMPARE_PAGE1, 0, 0, TRUE, HEAPID_BOX_VIEW);
		ArcUtil_HDL_ScrnSet(p_boxgra_handle, NARC_box_compare_bg_sub_page2_lz_nscr, wk->bgl, FRM_SUB_COMPARE_PAGE2, 0, 0, TRUE, HEAPID_BOX_VIEW);
		ArcUtil_HDL_ScrnSet(p_boxgra_handle, NARC_box_compare_bg_sub_page3_lz_nscr, wk->bgl, FRM_SUB_COMPARE_PAGE3, 0, 0, TRUE, HEAPID_BOX_VIEW);
		ArcUtil_HDL_PalSet(p_boxgra_handle, NARC_box_compare_bg_nclr, PALTYPE_SUB_BG, 0, 0x20*4, HEAPID_BOX_VIEW);
		...
		SetupActors(wk, p_boxgra_handle);
	}
}
...
static void SetupActors( COMPARE_VIEW_WORK* wk, ARCHANDLE* p_boxgra_handle )
{
	...
	wk->cellBuf = ArcUtil_HDL_CellBankDataGet(p_boxgra_handle, NARC_box_compare_button_lz_ncer, TRUE, &(wk->cellData), HEAPID_BOX_VIEW );
	wk->animBuf = ArcUtil_HDL_AnimBankDataGet(p_boxgra_handle, NARC_box_compare_button_lz_nanr, TRUE, &(wk->animData), HEAPID_BOX_VIEW );
	ArcUtil_HDL_PalSet(p_boxgra_handle, NARC_box_compare_button_nclr, PALTYPE_SUB_OBJ, 0, 0x20*3, HEAPID_BOX_VIEW);

	NNS_G2dInitImageProxy( &imgProxy );
	charpos = ArcUtil_HDL_CharSysLoad(p_boxgra_handle, NARC_box_compare_button_lz_ncgr, TRUE, CHAR_MAP_1D, 0, NNS_G2D_VRAM_TYPE_2DSUB,
