...
void Recoder_ColorChange( BR_WORK* wk, int color )
{
	if ( color == 0 ){
		PaletteWorkSet_Arc( wk->sys.pfd, ARC_BR_GRA, NARC_batt_rec_gra_batt_rec_gds_bg_NCLR, HEAPID_BR, FADE_MAIN_BG, 0x20 * BG_PAL_BASE_END, eBG_PAL_BASE_0 );
		PaletteWorkSet_Arc( wk->sys.pfd, ARC_BR_GRA, NARC_batt_rec_gra_batt_rec_gds_bg_NCLR, HEAPID_BR, FADE_SUB_BG,	 0x20 * BG_PAL_BASE_END, eBG_PAL_BASE_0 );
		CATS_ChangeResourcePlttArcH_PlttWork( wk->sys.csp, wk->sys.crp, wk->sys.pfd, FADE_MAIN_OBJ, wk->sys.p_handle, NARC_batt_rec_gra_batt_rec_gds_obj_NCLR, FALSE, eID_OAM_SIDE_BAR_M, OAM_TAG_PAL_MAX, NNS_G2D_VRAM_TYPE_2DMAIN );
		CATS_ChangeResourcePlttArcH_PlttWork( wk->sys.csp, wk->sys.crp, wk->sys.pfd, FADE_SUB_OBJ, wk->sys.p_handle, NARC_batt_rec_gra_batt_rec_gds_obj_NCLR, FALSE, eID_OAM_SIDE_BAR_S, OAM_TAG_PAL_MAX, NNS_G2D_VRAM_TYPE_2DSUB );
	}
	else {
		PaletteWorkSet_Arc( wk->sys.pfd, ARC_BR_GRA, NARC_batt_rec_gra_batt_rec_browse_bg2_NCLR, HEAPID_BR, FADE_MAIN_BG, 0x20 * BG_PAL_BASE_END, eBG_PAL_BASE_0 );
		PaletteWorkSet_Arc( wk->sys.pfd, ARC_BR_GRA, NARC_batt_rec_gra_batt_rec_browse_bg2_NCLR, HEAPID_BR, FADE_SUB_BG,	 0x20 * BG_PAL_BASE_END, eBG_PAL_BASE_0 );
		CATS_ChangeResourcePlttArcH_PlttWork( wk->sys.csp, wk->sys.crp, wk->sys.pfd, FADE_MAIN_OBJ, wk->sys.p_handle, NARC_batt_rec_gra_batt_rec_browse_obj2_NCLR, FALSE, eID_OAM_SIDE_BAR_M, OAM_TAG_PAL_MAX, NNS_G2D_VRAM_TYPE_2DMAIN );
		CATS_ChangeResourcePlttArcH_PlttWork( wk->sys.csp, wk->sys.crp, wk->sys.pfd, FADE_SUB_OBJ, wk->sys.p_handle, NARC_batt_rec_gra_batt_rec_browse_obj2_NCLR, FALSE, eID_OAM_SIDE_BAR_S, OAM_TAG_PAL_MAX, NNS_G2D_VRAM_TYPE_2DSUB );
	}
}
...
//			wk->bar[ n ].tcb = TCB_Add( BR_SideBar_TCB, &wk->bar[ n ], 0x1000 );
			wk->bar[ n ].tcb = VIntrTCB_Add( BR_SideBar_TCB, &wk->bar[ n ], 0x1000 );
		}
