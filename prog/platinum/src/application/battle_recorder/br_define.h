...
///< 自分のデータを0番2番にコピーします。(セーブの中身ではなく、テンポラリに)
//#define BR_DEBUG_MYREC_COPY_0and2
#define BR_DEBUG_EXPARA2_NOT_SET
...
#define LOGO_COLOR_B4			( 0x67ff )
#define LOGO_COLOR_B5			( 0x4ebf )
#define LOGO_COLOR_B6			( 0x575e )
#define LOGO_COLOR_B7			( 0x5b9f )
#define LOGO_COLOR_B8			( 0x677f )
#define LOGO_COLOR_B9			( 0x677f )
...
#define LINE_COLOR_B8			( 0x677f )
#define LINE_COLOR_B9			( 0x677f )
...
#define MENU_OUT_SPEED			( 2 )					///< メニューが戻るスピード ( 初期 = x2 )
...
#define BR_EX_DATA_BATTLE_RANK		( 0 )
#define BR_EX_DATA_FRONTIER_RANK	( 1 )
