...
static void BRV_Word_Shisetu( BR_WORK* wk, int no )
{
	...
	if ( no == GT_BATTLE_REC_SEARCH_BATTLE_MODE_NONE ){
		...
		str1 = MSGMAN_AllocString( wk->sys.man, msg_rule_000 + no - 1 );
	}
	GF_STR_PrintColor( win, FONT_SYSTEM, str1, 0, 0, MSG_NO_PUT, PRINT_COL_VIDEO, NULL );
	GF_BGL_BmpWinOnVReq( win );
	STRBUF_Delete( str1 );
...
static const TL_INFO tl_info_shisetu_aclear[] = {
	...
	{ msg_rule_no_007, 8, 0 },
	{ msg_rule_no_008, 9, 0 },
	{ msg_rule_no_009, 10, 0 },
	{ msg_rule_no_010, 11, 0 },
	{ msg_rule_no_011, 12, 0 },
	{ msg_rule_no_012, 13, 0 },
	{ msg_rule_no_013, 14, 0 },
	{ msg_rule_no_014, 15, 0 },
	{ msg_rule_no_015, 16, 0 },
	{ msg_rule_no_016, 17, 0 },
	{ msg_rule_no_017, 18, 0 },
	{ msg_rule_no_018, 19, 0 },
	{ msg_rule_no_019, 20, 0 },
	{ msg_rule_no_020, 21, 0 },
};
