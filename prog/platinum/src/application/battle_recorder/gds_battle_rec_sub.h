...
#define GT_CB_DEF_SEAL_MAX				(8)			///< 貼れる枚数
...
typedef enum{
	...
	//	コロシアム
	//--------------------------------------------------------------
	GT_BATTLE_MODE_COLOSSEUM_SINGLE,		//シングルバトル(ミックスバトル含む)
	GT_BATTLE_MODE_COLOSSEUM_DOUBLE,		//ダブルバトル
...
typedef struct {
	...
	GT_CB_SEAL	cb_seal[ GT_CB_DEF_SEAL_MAX ];
...
typedef struct{
	...
	GT_CB_CORE		cb_core;							//54h	カスタムボール
