...
static inline void SoftSpriteAnimeCoreEx( u8* anm_flag, u8* pat, u8* seq, u8* wait, s16* ox, s16* oy, u8* loop_cnt, const SOFT_SPRITE_ANIME* anm_tbl )
{
	if(*anm_flag)
	{
		if( (*wait) == 0 )
