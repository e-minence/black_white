...
extern void AT_JudgeAddAll(ACTIN_SYSTEM_PARAM *sys, CONTEST_SYSTEM *consys, ARCHANDLE *hdl_obj);
...
extern void AT_SpecialHeartSet(ACTIN_SYSTEM_PARAM *sys, int judge_no, ARCHANDLE *hdl_obj);
extern void AT_SpecialHeartDel(ACTIN_SYSTEM_PARAM *sys);
extern void AT_AppealPointResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void AT_VoltagePointResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void AT_NextIconResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void AT_JudgeReactionIconResourceLoad(PALETTE_FADE_PTR pfd, CATS_SYS_PTR csp, 
	CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
