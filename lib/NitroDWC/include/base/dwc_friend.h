...
typedef struct DWCstFriendControl
{
    ...
    GPProfile *reverseBuddies; // gpGetReverseBuddiesListの為のポインタ
...
extern void DWCi_GPRecvBuddyAuthCallback(GPConnection* connection,
...
extern void DWCi_BeginCloseStatsConnection  ( void );
extern void DWCi_EndCloseStatsConnection    ( void );
