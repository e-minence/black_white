...
BOOL    DWC_WasBuddyFriendData    ( const DWCAccFriendData* frienddata ); // 友達が友達リストから私を削除していないか確認する。
int     DWC_GetFriendDataType         ( const DWCAccFriendData* frienddata ); // ReverseBuddyとBuddyのフラグを両方見て判定する
