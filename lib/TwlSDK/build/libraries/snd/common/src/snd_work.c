...
/*---------------------------------------------------------------------------*
  ...
  Description:  アドレスの変換を行います。

  Arguments:    p - 変換する元のアドレス
                baseFrom - 元のアドレスの起点アドレス
                baseTo - 変換後のアドレスの起点アドレス
...
/*---------------------------------------------------------------------------*
  ...
  Description:  プレイヤーのステータスを取得します。

  Arguments:    None.

  Returns:      プレイヤーステータスのビットマスク
                ビットが立っていると、アクティブ
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  チャンネルのステータスを取得します。

  Arguments:    None.

  Returns:      チャンネルステータスのビットマスク
                ビットが立っていると、アクティブ
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  キャプチャのステータスを取得します。

  Arguments:    None.

  Returns:      キャプチャステータスのビットマスク
                ビットが立っていると、アクティブ
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  プレイヤーのチックカウンタを取得します。
...
/*---------------------------------------------------------------------------*
  ...
  Description:  チャンネル情報を読みとります。

  Arguments:    driverInfo - ドライバ情報構造体
                chNo - チャンネル番号
                chInfo - 取得した情報を格納するチャンネル情報構造体

  Returns:      読みとりに成功したかどうか
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  プレイヤー情報を読みとります。

  Arguments:    driverInfo - ドライバ情報構造体
                playerNo - プレイヤー番号
                playerInfo - 取得した情報を格納するプレイヤー情報構造体
...
/*---------------------------------------------------------------------------*
  ...
  Description:  トラック情報を読みとります。

  Arguments:    driverInfo - ドライバ情報構造体
                playerNo - プレイヤー番号
                trackNo - トラック番号
                trackInfo - 取得した情報を格納するトラック情報構造体
