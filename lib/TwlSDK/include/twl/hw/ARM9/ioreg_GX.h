...
//
#ifndef TWL_HW_ARM9_IOREG_GX_H_
#define TWL_HW_ARM9_IOREG_GX_H_
...
#define REG_GX_DISPSTAT_INI_SHIFT                          6
#define REG_GX_DISPSTAT_INI_SIZE                           1
#define REG_GX_DISPSTAT_INI_MASK                           0x0040
...
#ifndef SDK_ASM
#define REG_GX_DISPSTAT_FIELD( vcounter, ini, vqi, hbi, vbi, lyc, hblk, vblk ) \
    (u16)( \
    ((u32)(vcounter) << REG_GX_DISPSTAT_VCOUNTER_SHIFT) | \
    ((u32)(ini) << REG_GX_DISPSTAT_INI_SHIFT) | \
