...
#define REG_PXI_INTF_ADDR                REG_SUBPINTF_ADDR
...
#define REG_PXI_INTF_ADDR                REG_MAINPINTF_ADDR
...
#define	REG_PXI_INTF_SEND_MASK           REG_PXI_MAINPINTF_A7STATUS_MASK
#define	REG_PXI_INTF_SEND_SHIFT          REG_PXI_MAINPINTF_A7STATUS_SHIFT
#define	REG_PXI_INTF_RECV_MASK           REG_PXI_MAINPINTF_A9STATUS_MASK
#define	REG_PXI_INTF_RECV_SHIFT          REG_PXI_MAINPINTF_A9STATUS_SHIFT
