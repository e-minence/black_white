/*---------------------------------------------------------------------------*
  ...
  Revision 1.5  2004/10/28 13:07:36  yosizaki
  remove all the sources. (moved to wireless_shared!)

  Revision 1.4  2004/10/28 11:06:38  yosizaki
  add callback for block-transfer.
  merge with ../wireless_shared.

  Revision 1.3  2004/10/19 10:27:02  miya
  Port受信コールバックの使用とプリント文をNITRO画面上に表示するように変更

  Revision 1.2  2004/10/04 05:49:36  miya
