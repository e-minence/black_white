...
// sotoike 追加 IRC の動的切り替え用
#define CARD_BACKUP_TYPE_VENDER_IRC		(0xFF) // 1が使われたので変更
...
typedef enum
{
	...
	CARD_BACKUP_TYPE_FLASH_2MBITS_IRC = CARD_BACKUP_TYPE_DEFINE(FLASH, 18, CARD_BACKUP_TYPE_VENDER_IRC), // sotoike add
    CARD_BACKUP_TYPE_FLASH_4MBITS_IRC = CARD_BACKUP_TYPE_DEFINE(FLASH, 19, CARD_BACKUP_TYPE_VENDER_IRC), // sotoike add
	CARD_BACKUP_TYPE_FLASH_8MBITS_IRC = CARD_BACKUP_TYPE_DEFINE(FLASH, 20, CARD_BACKUP_TYPE_VENDER_IRC), // sotoike add 64M のベンダーコードで１のがあるので注意
