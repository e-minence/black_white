...
#define CARD_BACKUP_TYPE_VENDER_IRC		(1)
...
typedef enum
{
	...
	CARD_BACKUP_TYPE_FLASH_2MBITS_IRC = CARD_BACKUP_TYPE_DEFINE(FLASH, 18, 1), // sotoike add
    CARD_BACKUP_TYPE_FLASH_4MBITS_IRC = CARD_BACKUP_TYPE_DEFINE(FLASH, 19, 1), // sotoike add
	CARD_BACKUP_TYPE_FLASH_8MBITS_IRC = CARD_BACKUP_TYPE_DEFINE(FLASH, 20, 1), // sotoike add 64M のベンダーコードで１のがあるので注意
