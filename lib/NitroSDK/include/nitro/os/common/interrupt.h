/*---------------------------------------------------------------------------*
  ...
  includeするファイルをnitro.hではなく、必要なもののみにした
  ...
  *** empty log message ***
  ...
  OS_ResetRequestIRQMask() の戻り型を u32 から OS_IntrMask に修正
  ...
  マスターイネーブルの扱いを BOOLで行うようにした。

  Revision 1.8  2003/11/10 04:15:12  yasu
  割り込みビットを OS_InterruptBit に
