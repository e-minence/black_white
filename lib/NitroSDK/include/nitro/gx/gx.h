/*---------------------------------------------------------------------------*
  ...
  GX_GetOBJVRamModeBmp関数の戻り値の型誤り修正
  ...
  change GX_DMAID to variable for compativility.
