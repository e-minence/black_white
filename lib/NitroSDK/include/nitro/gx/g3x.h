/*---------------------------------------------------------------------------*
  ...
  move G3X_ClearFifo() to g3x.c as none inline function.

  Revision 1.68  2004/03/15 05:21:07  takano_makoto
  Modify GX_FIFOSTAT_EMPTY from 3 to 6.

  Revision 1.67  2004/03/02 11:28:49  takano_makoto
  change parameter form of G3X_IsMtxStackOverflow()
