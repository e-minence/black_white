/*---------------------------------------------------------------------------*
  ...
  G3_GetDLStart, G3_GetDLLength, G3_GetDLSizeの引数にconst修飾子を追加

  Revision 1.67  2005/03/15 02:42:48  takano_makoto
  G3_GetDLSizeが4大きいサイズを返すケースがある不具合を修正。
  ...
  add GX_COMP4x4_PLTT_IDX and macros for static display lists(GX_PACK_XXXXX_PARAM).
  ...
  fix GX_FX16PAIR(supress sign extend).
...
#define G3OP_DUMMY_COMMAND      0xFF   /* duummy command */
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get a pointer to a display list(command list) buffer
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get the length of a display list(command list) buffer
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get the size of the display list generated
...
/*---------------------------------------------------------------------------*
  ...
  Description:  convert texture palette address to value set register.
