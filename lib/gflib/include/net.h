...
typedef DWCUserData* (*NetGetDWCUserDataCallback)(void* pWork); ///< DWCのユーザデータ（自分のデータ）を得る
typedef DWCFriendData* (*NetGetDWCFriendDataCallback)(void* pWork); ///< DWC形式の友達リスト	
