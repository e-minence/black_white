...
void NitroMain()
{
	...
	while (1)
	{
		...
		case SAMPLE_BT_SETPROFILE:
        	...
        	profile.playerName[0] = 0x30AB;      // カ
        	profile.playerName[1] = 0x30B9;      // ス
        	profile.playerName[2] = 0x30DF;      // ミ
...
static void set_upload_player(void) {
	...
	upload_player.playerName[1] = 0x30B9;      // ス
	upload_player.playerName[2] = 0x30DF;      // ミ
