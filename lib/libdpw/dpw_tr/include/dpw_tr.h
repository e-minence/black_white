...
extern void Dpw_Tr_UploadAsync(const Dpw_Tr_Data* data, const u8 *token, u32 len);
...
extern void Dpw_Tr_TradeAsync(s32 id, const Dpw_Tr_Data* uploadData, Dpw_Tr_Data* downloadData, const u8 *token, u32 len);
