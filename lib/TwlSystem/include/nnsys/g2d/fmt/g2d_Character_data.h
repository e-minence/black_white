...
// -------------------------------------
// 1.0         初版
// 1.1         NNSG2dCharacterPosInfoBlock の追加
//
...
{
    NNS_G2D_CHARACTER_FMT_CHAR,  // 8*8 テクセルごとに整列している
    NNS_G2D_CHARACTER_FMT_BMP,   // 一般的なビットマップ方式
...
typedef struct NNSG2dCharacterData
{
    ...
    u32                             characterFmt;// 31 ..... 10 ...........9 8 ................ 0
                                                 //     予約   VramTransfer   NNSG2dCharacterFmt
    u32                             szByte;
    void*                           pRawData;  // offset addr of the content.
