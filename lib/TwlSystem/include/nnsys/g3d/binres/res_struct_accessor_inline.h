...
NNS_G3D_RES_INLINE const void*
NNS_G3dGetTexData(const NNSG3dResTex* tex)
{
    return (u8*)tex + tex->texInfo.ofsTex;
}

NNS_G3D_RES_INLINE const void*
NNS_G3dGetTex4x4Data(const NNSG3dResTex* tex)
{
    return (u8*)tex + tex->tex4x4Info.ofsTex;
}

NNS_G3D_RES_INLINE const void*
NNS_G3dGetTex4x4PlttIdxData(const NNSG3dResTex* tex)
{
    return (u8*)tex + tex->tex4x4Info.ofsTexPlttIdx;
}

NNS_G3D_RES_INLINE const void*
NNS_G3dGetPlttData(const NNSG3dResTex* tex)
{
    return (u8*)tex + tex->plttInfo.ofsPlttData;
}

NNS_G3D_RES_INLINE const void*
NNS_G3dGetShpDLPtr(const NNSG3dResShpData* shp)
{
    return (u8*)shp + shp->ofsDL;
}

NNS_G3D_RES_INLINE u32
NNS_G3dGetShpDLSize(const NNSG3dResShpData* shp)
{
    return shp->sizeDL;
}
