...
#define POKE_NET_GDS_ADMIN_ILLEGALCHECK_MUSICALTITLELIST_MAXNUM (100)
...
#define POKE_NET_GDS_ADMIN_ILLEGALCHECK_MUSICALDISABLEPOKENO_MAXNUM (100)
...
//// 定義無し
//
//#define MONSNO_MAX		(493)	// ！危険･･･ここは最終的な最大値をGFに吐かせるか、
//								//          動的に確保出来るしくみを考える必要あり。
//
//#define POKE_NET_GDS_ADMIN_ILLEGALCHECK_MEETPLACE_MAXPLACE		(1+32)
//#define POKE_NET_GDS_ADMIN_ILLEGALCHECK_MEETPLACE_MAXPOKEMON	(MONSNO_MAX)
//
//// - レスポンス -
//typedef struct
//{
...
//	long Count;
//
//	// sizeof(s16)*POKE_NET_GDS_ADMIN_ILLEGALCHECK_MEETPLACE_MAXPLACE * HitCount
//	// [0]はポケモン番号
//	s16 Table[POKE_NET_GDS_ADMIN_ILLEGALCHECK_MEETPLACE_MAXPOKEMON * POKE_NET_GDS_ADMIN_ILLEGALCHECK_MEETPLACE_MAXPLACE];
//}
