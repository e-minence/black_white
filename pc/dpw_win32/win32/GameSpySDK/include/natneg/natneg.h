...
*/
typedef enum {ns_initsent, ns_initack, ns_connectping, ns_finished, ns_canceled, ns_addrsent } NegotiateState;
...
typedef void (*NegotiateCompletedFunc)(NegotiateResult result, SOCKET gamesocket, struct sockaddr_in *remoteaddr, void *userdata, int cookie);
...
NNBeginAddressCheck
-------------------
Starts the NAT address/port check process using internal generated socket
*/
