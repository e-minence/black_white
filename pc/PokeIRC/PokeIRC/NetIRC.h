...
namespace PokeIRC {
	...
	typedef enum {
		...
		IRC_COMMAND_CHANGE_BOXPOKE,
		IRC_COMMAND_CHANGE_BOXPOKEEND,
		IRC_COMMAND_CHANGEPOKE_SEND,
		IRC_COMMAND_CHANGEPOKE_SENDEND,
	    IRC_COMMAND_SNDV,
	    IRC_COMMAND_SNDEND,
	    IRC_COMMAND_POKEBOX_MOVE,
	    IRC_COMMAND_POKEBOX_MOVEEND,
	    IRC_COMMAND_MAIN_MOVE,
