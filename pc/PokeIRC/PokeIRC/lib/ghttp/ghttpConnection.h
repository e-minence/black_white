...
typedef struct GHIConnection
{
	...
	GHIBuffer sendBuffer;         // The buffer for outgoing data. (encrypted)
	GHIBuffer recvBuffer;         // The buffer for incoming data. (decrypted)
	...
	int tempDataIndex;            // End of header info.  Marks the start of temporary recvBuffer storage
