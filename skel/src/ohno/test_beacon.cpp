...
static void	g2d_load( SKEL_TEST_BEACON_WORK* pWork )
{
	...
	//パレット作成＆転送
	{
		u16* plt = (u16 *)GFL_HEAP_AllocClearMemoryLo( pWork->heapID, 16*2 );
	...
	//文字表示パラメータワーク作成
	{
		GFL_TEXT_PRINTPARAM* param = (GFL_TEXT_PRINTPARAM*)GFL_HEAP_AllocClearMemoryLo
...
SKEL_TEST_BEACON_WORK* TEST_BEACON_Init(HEAPID heapID)
{
    ...
    SKEL_TEST_BEACON_WORK* pWork = (SKEL_TEST_BEACON_WORK*)GFL_HEAP_AllocMemory(heapID, sizeof(SKEL_TEST_BEACON_WORK));
