...
void DebugTamadaInit(u32 heap_id)
{
	...
	ctrl = (DEBUG_TAMADA_CONTROL*)GFL_HEAP_AllocMemory(heap_id, sizeof(DEBUG_TAMADA_CONTROL));
...
static GFL_PROC_RESULT DebugTamadaMainProcInit(GFL_PROC * proc, int * seq, void * pwk, void * mywk)
{
	...
	ctrl = (DEBUG_TAMADA_CONTROL*)GFL_PROC_AllocWork(proc, sizeof(DEBUG_TAMADA_CONTROL), HEAPID_TAMADA_DEBUG);
	DebugTamadaControl = ctrl;
...
{
	GFL_PROC * subproc;
	DEBUG_TAMADA_CONTROL * ctrl = (DEBUG_TAMADA_CONTROL*)mywk;
