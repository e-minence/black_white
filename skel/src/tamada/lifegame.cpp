...
{
	LIFEGAME_WORK * lfwk = (LIFEGAME_WORK*)GFL_HEAP_AllocMemory(heap_id, sizeof(LIFEGAME_WORK));
	lfwk->sizeX = sizeX;
	lfwk->sizeY = sizeY;
	lfwk->cell = (LG_CELL*)GFL_HEAP_AllocMemory(heap_id, sizeof(u8) * sizeX * sizeY);
