...
extern const GFL_SVLD_PARAM init_param;
...
{
	return (DUMMY_DATA1*)GFL_SAVEDATA_Get(sv, GMDATA_ID_DUMMY_DATA1);
}
...
{
	return (DUMMY_DATA2*)GFL_SAVEDATA_Get(sv, GMDATA_ID_DUMMY_DATA2);
}
...
{
	return (DUMMY_DATA3*)GFL_SAVEDATA_Get(sv, GMDATA_ID_DUMMY_DATA3);
}
...
{
	return (DUMMY_DATA4*)GFL_SAVEDATA_Get(sv, GMDATA_ID_DUMMY_DATA4);
}
