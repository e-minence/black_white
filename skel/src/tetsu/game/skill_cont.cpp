...
extern const SKILL_PROC skillProcTable[4];
...
{
	SKILL_CONTROL* sc = (SKILL_CONTROL*)GFL_HEAP_AllocClearMemory( setup->heapID, sizeof(SKILL_CONTROL) );
...
{
	SKILL_CALLBACK_WORK* scw = (SKILL_CALLBACK_WORK*)GFL_HEAP_AllocClearMemory(sc->heapID, sizeof(SKILL_CALLBACK_WORK));
	int i;
	VecFx32 targetTrans;
	BOOL hitResult;
