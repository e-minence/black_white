...
extern const	MAPDATA mapDataTbl;
extern const	EXOBJ_DATATABLE extraObjectDataTbl[5];
...
SCENE_MAP*	Create3Dmap( GFL_G3D_SCENE* g3Dscene, HEAPID heapID )
{
	...
	SCENE_MAP* sceneMap = (SCENE_MAP*)GFL_HEAP_AllocMemory( heapID, sizeof(SCENE_MAP) );
...
static void MapDataCreate( SCENE_MAP* sceneMap, const MAPDATA* map, HEAPID heapID )
{
	...
	mapAttr = (u16*)GFL_HEAP_AllocMemory( heapID, 2*sizeX*sizeZ );
	pdata = (GFL_G3D_SCENEOBJ_DATA*)GFL_HEAP_AllocMemoryLo( heapID, sizeof(GFL_G3D_SCENEOBJ_DATA)*sizeX*sizeZ+1 );
