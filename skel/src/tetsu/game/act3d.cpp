...
{
	SCENE_ACT* sceneAct = (SCENE_ACT*)GFL_HEAP_AllocMemory( heapID, sizeof(SCENE_ACT) );

	//プレーヤーキャラ作成
	GFL_G3D_SCENEOBJ_DATA*	pdata;
	int	i;

	pdata = (GFL_G3D_SCENEOBJ_DATA*)GFL_HEAP_AllocMemoryLo( heapID, sizeof(GFL_G3D_SCENEOBJ_DATA) * PLAYER_SETUP_NUM );
