...
static const GFL_G3D_UTIL_SCENE_RES g3Dscene1_resTbl[] = {
...
static const GFL_G3D_UTIL_SCENE_OBJ g3Dscene1_objTbl[] = {
...
static const GFL_G3D_UTIL_SCENE_SETUP g3Dscene1_setup = {
	g3Dscene1_resTbl, NELEMS(g3Dscene1_resTbl),
	g3Dscene1_objTbl, NELEMS(g3Dscene1_objTbl),
};
...
{
	{ -FX32_ONE*32, 0, -FX32_ONE*32 }, 
	{ -FX32_ONE*32, 0,  FX32_ONE* 0 },
	{ -FX32_ONE*32, 0,  FX32_ONE*32 },
	{ -FX32_ONE* 0, 0, -FX32_ONE*32 },
...
static void g3d_load( void )
{
	...
	tetsuWork->g3Dscene = GFL_G3D_UtilsysCreate( &g3Dscene1_setup, heapID );
	//描画ステータスワーク設定
	for( i=0; i<NELEMS(g3Dscene1_objTbl); i++ ){
