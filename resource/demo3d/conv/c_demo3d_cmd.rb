...
$h_pm_version = {"ver_all"=>"0xFF","ver_black"=>"VERSION_BLACK","ver_white"=>"VERSION_WHITE","ver_gray"=>"VERSION_WHITE+1"}
...
$psfix_2dgra_ncl = $_psfix_prm.new( "NARC_demo3d_2dgra_", "_NCLR")
$psfix_2dgra_ncg = $_psfix_prm.new( "NARC_demo3d_2dgra_", "_lz_NCGR")
$psfix_2dgra_nsc = $_psfix_prm.new( "NARC_demo3d_2dgra_", "_lz_NSCR")
...
$prm_scr_draw_req = [
  $_cmd_prm.new( P_LIST, P_LIST, $h_pm_version, nil ), #有効バージョン指定
  $_cmd_prm.new( P_FREE, P_FREE, nil, $psfix_2dgra_ncl ), #nclr
...
$cmd_tbl = [
  ...
  CDemo3DCmd::new( "SCR_DRAW_REQ", $prm_scr_draw_req),
