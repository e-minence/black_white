...
//egg_demo_normal.spa内のリソース個数
#define EGG_DEMO_NORMAL_SPAMAX	(4)

//egg_demo_special.hのsprリソース定義
...
//egg_demo_special.spa内のリソース個数
#define EGG_DEMO_SPECIAL_SPAMAX	(4)



//---- egg_demo_setup_tblテーブルのdefine定義 ----
#define SPA_EGG_DEMO_NORMAL		(0)
#define SPA_EGG_DEMO_SPECIAL		(1)

#define SPA_EGG_DEMO_SETUP_MAX		(2)
