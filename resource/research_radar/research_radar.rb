...
fileReader.ReadFile( "answers.txt" )
...
fileReader = TabSeparatedFileReader.new
fileReader.ReadFile( "questions.txt" )
...
fileReader = TabSeparatedFileReader.new
fileReader.ReadFile( "topics.txt" )
...
# 全ての文字列を取得
fileReader = TabSeparatedFileReader.new
fileReader.ReadFile( "hobbies.txt" )
