// コンバータにより生成
#define QUESTION_ID_WB (0) //「・ブラックとホワイト　どっち？」
...
#define QUESTION_ID_PRECIOUS (11) //「・じぶんにとって　だいじなのは？」
...
#define QUESTION_ID_HOBBY (25) //「・どんな　しゅみを　もってる？」
#define QUESTION_ID_JOB (26) //「・どんな　しごとを　してる？」
