...
COLUMN_ANSWER_STRING_ID_LAVEL = 1  # gmm内ラベル名
COLUMN_ANSWER_JPN             = 2  # 回答文字列
COLUMN_ANSWER_JPN_KANJI       = 3  # 回答文字列
COLUMN_COLOR                  = 4  # 色
# 行インデックス
...
COLUMN_QUESTION_STRING_ID_LAVEL = 2   # gmm内ラベル名
COLUMN_QUESTION_ANSWER_NUM      = 3   # 選択数
COLUMN_QUESTION_BIT_COUNT       = 4   # bit数
COLUMN_QUESTION_JPN             = 5   # 回答文字列 (かな)
COLUMN_QUESTION_JPN_KANJI       = 6   # 回答文字列 (漢字)
COLUMN_QUESTION_ANSWER_ID_0     = 7   # 回答0
COLUMN_QUESTION_ANSWER_ID_1     = 9   # 回答1
COLUMN_QUESTION_ANSWER_ID_2     = 12  # 回答2 
COLUMN_QUESTION_ANSWER_ID_3     = 14  # 回答3 
COLUMN_QUESTION_ANSWER_ID_4     = 16  # 回答4 
COLUMN_QUESTION_ANSWER_ID_5     = 18  # 回答5 
COLUMN_QUESTION_ANSWER_ID_6     = 20  # 回答6 
COLUMN_QUESTION_ANSWER_ID_7     = 22  # 回答7 
COLUMN_QUESTION_ANSWER_ID_8     = 24  # 回答8 
COLUMN_QUESTION_ANSWER_ID_9     = 26  # 回答9 
COLUMN_QUESTION_ANSWER_ID_10    = 28  # 回答10
COLUMN_QUESTION_ANSWER_ID_11    = 30  # 回答11
COLUMN_QUESTION_ANSWER_ID_12    = 32  # 回答12
COLUMN_QUESTION_ANSWER_ID_13    = 34  # 回答13
COLUMN_QUESTION_ANSWER_ID_14    = 36  # 回答14
COLUMN_QUESTION_ANSWER_ID_15    = 38  # 回答15
COLUMN_QUESTION_ANSWER_ID_16    = 40  # 回答16
COLUMN_QUESTION_ANSWER_ID_17    = 42  # 回答17
# 行インデックス
...
ROW_FIRST_QUESTION.upto( fileReader.GetRowNum - 1 ) do |rowIdx|
  ...
  stringIDLavel   = fileReader.GetCell( rowIdx, COLUMN_QUESTION_STRING_ID_LAVEL )
  ...
  question.SetStringIDLavel( stringIDLavel )
...
questions.each do |question|
  stringLavel     << question.stringID_lavel
...
outData << "{"
questions.each do |question|
  outData << "  #{question.stringID_lavel},  // [#{question.ID_lavel}]"
end
outData << "};"
