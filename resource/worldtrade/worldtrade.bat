...
g2dcvtr mypoke.nsc
g2dcvtr search.nsc
g2dcvtr search_sub.nsc
g2dcvtr search_seibetsu.nsc
g2dcvtr search_name1.nsc
g2dcvtr search_name2.nsc
g2dcvtr search_name3.nsc
g2dcvtr search__level.nsc
...
ntrcomp -l 2 -o input_lz.ncgr input.ncgr
ntrcomp -l 2 -o title_lz.ncgr title.ncgr
ntrcomp -l 2 -o traderoom_lz.ncgr traderoom.ncgr
ntrcomp -l 2 -o traderoom_win_lz.ncgr traderoom_win.ncgr
...
ntrcomp -l 2 -o search_sub_lz.nscr search_sub.nscr
ntrcomp -l 2 -o search_seibetsu_lz.nscr search_seibetsu.nscr
ntrcomp -l 2 -o search_name1_lz.nscr search_name1.nscr
ntrcomp -l 2 -o search_name2_lz.nscr search_name2.nscr
ntrcomp -l 2 -o search_name3_lz.nscr search_name3.nscr
ntrcomp -l 2 -o search_level_lz.nscr search__level.nscr
...
ntrcomp -l 2 -o traderoom_win_lz.nscr traderoom_win.nscr
ntrcomp -l 2 -o traderoom_win2_lz.nscr traderoom_win2.nscr
