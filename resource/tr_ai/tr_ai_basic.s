...
BasicAI_DmgEnd:
	...
	IF_WAZANO	WAZANO_DONARITUKERU,AI_DEC10		//2010.2.9
...
BasicAI_109://のろい
	...
	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_DEF,8,AI_DEC8
	AIEND
...
BasicAI_206://コスモパワー
	...
	IF_PARA_OVER	CHECK_ATTACK,PARA_DEF,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_SPEDEF,8,AI_DEC8
	AIEND
...
BasicAI_212://りゅうのまい
	...
	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_AGI,8,AI_DEC8
	AIEND
...
BasicAI_284:			//	ボディパージ 	
	CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_284_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_AGI,8,AI_DEC10

BasicAI_284_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_AGI,12,AI_DEC10
	AIEND
...
BasicAI_290:			// 	ちょうのまい
	CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_290_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_DEF,8,AI_DEC8
	IF_PARA_OVER	CHECK_ATTACK,PARA_AGI,8,AI_DEC6

BasicAI_290_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_POW,12,AI_DEC10
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_DEF,12,AI_DEC8
...
BasicAI_308:			// 	からをやぶる
	CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_308_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_SPEPOW,8,AI_DEC8
	IF_PARA_OVER	CHECK_ATTACK,PARA_AGI,8,AI_DEC6

BasicAI_308_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_POW,12,AI_DEC10
...
BasicAI_312:			// 	ギアチェンジ
	CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_312_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_AGI,8,AI_DEC8

BasicAI_312_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_POW,12,AI_DEC10
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_AGI,12,AI_DEC8
	AIEND
...
BasicAI_316:			// 	せいちょう
  CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_316_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_SPEPOW,8,AI_DEC8

BasicAI_316_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_POW,12,AI_DEC10
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_SPEPOW,12,AI_DEC8
	AIEND
...
BasicAI_322:			// 	とぐろをまく
	CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_322_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_DEF,8,AI_DEC8
	IF_PARA_OVER	CHECK_ATTACK,PARA_HIT,8,AI_DEC6

BasicAI_322_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_POW,12,AI_DEC10
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_DEF,12,AI_DEC8
...
BasicAI_327:			// 	ふるいたてる
  CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_327_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_POW,8,AI_DEC10
	IF_PARA_OVER	CHECK_ATTACK,PARA_SPEPOW,8,AI_DEC8

BasicAI_327_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_POW,12,AI_DEC10
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_SPEPOW,12,AI_DEC8
	AIEND
...
BasicAI_328:			// 	コットンガード
  CHECK_TOKUSEI	CHECK_ATTACK				//たんじゅんなら段階数９でやめ2006.6.6  ←見直し予定
	IFN_EQUAL	TOKUSYU_TANZYUN,BasicAI_328_tanzyun_no

	IF_PARA_OVER	CHECK_ATTACK,PARA_DEF,8,AI_DEC10

BasicAI_328_tanzyun_no:
	IF_PARA_EQUAL	CHECK_ATTACK,PARA_DEF,12,AI_DEC10
	AIEND
