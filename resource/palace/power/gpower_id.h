...
typedef enum{
	...
	GPOWER_ID_CAPTURE_A,	//30 : ポケモンの捕獲率が＋１０％される。（具体的な数値は言わない）
	GPOWER_ID_CAPTURE_B,	//31 : ポケモンの捕獲率が＋２０％される。（具体的な数値は言わない）
	GPOWER_ID_CAPTURE_C,	//32 : ポケモンの捕獲率が＋３０％される。（具体的な数値は言わない）
	...
	GPOWER_ID_EXP_INC_S,	//36 : バトル後の経験値が1.5倍になる。（具体的な数値は言わない）（配布：パレス用に効果時間１０倍））
	GPOWER_ID_MONEY_S,	//37 : バトル後のおこづかいが３倍になる。（具体的な数値は言わない）（配布：パレス用に効果時間１０倍）
	GPOWER_ID_CAPTURE_S,	//38 : ポケモンの捕獲率が＋３０％される。（具体的な数値は言わない）（配布：パレス用に効果時間１０倍）
	...
	GPOWER_ID_EXP_INC_MAX,	//43 : バトル後の経験値が1.5倍になる。（具体的な数値は言わない）（パレス用に効果時間１時間）
	GPOWER_ID_MONEY_MAX,	//44 : バトル後のおこづかいが３倍になる。（具体的な数値は言わない）（パレス用に効果時間１時間）
	GPOWER_ID_CAPTURE_MAX,	//45 : ポケモンの捕獲率が＋３０％される。（具体的な数値は言わない）（パレス用に効果時間１時間）
