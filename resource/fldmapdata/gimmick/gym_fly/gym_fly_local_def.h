...
#define CAM10_TRACE_START_FRM (50)
#define CAM11_TRACE_START_FRM (50)
#define CAM12_TRACE_START_FRM (50)
#define CAM13_TRACE_START_FRM (50)
#define CAM14_TRACE_START_FRM (47)
//カメラが自機に追いつくフレーム数
...
#define CAM10_TRACE_COST_FRM (25)
#define CAM11_TRACE_COST_FRM (25)
#define CAM12_TRACE_COST_FRM (25)
#define CAM13_TRACE_COST_FRM (25)
#define CAM14_TRACE_COST_FRM (1)
//着地フレームオフセット（最終フレームからどれくらい前か）
#define CAM1_STAND_FRM (10)
#define CAM2_STAND_FRM (10)
#define CAM3_STAND_FRM (10)
#define CAM4_STAND_FRM (22)
#define CAM5_STAND_FRM (10)
#define CAM6_STAND_FRM (10)
#define CAM7_STAND_FRM (10)
#define CAM8_STAND_FRM (10)
#define CAM9_STAND_FRM (10)
#define CAM10_STAND_FRM (10)
#define CAM11_STAND_FRM (15)
#define CAM12_STAND_FRM (-10)
#define CAM13_STAND_FRM (10)
#define CAM14_STAND_FRM (15)
//壁当たりフレーム
