...
$SCRIPT_DATA_IDX_SCRIPT04 = 5;
$SCRIPT_DATA_IDX_SCRIPT05 = 6;
$SCRIPT_DATA_IDX_NUM = 7;
...
for( $i=0; $i<$SCRIPT_DATA_NUM; $i++ )
{
  ...
  print( FILEOUT pack( "S", &getSCRIPT_H($SCRIPT_DATA[ ($i*$SCRIPT_DATA_IDX_NUM) + $SCRIPT_DATA_IDX_SCRIPT04 ]) ) );
  print( FILEOUT pack( "S", &getSCRIPT_H($SCRIPT_DATA[ ($i*$SCRIPT_DATA_IDX_NUM) + $SCRIPT_DATA_IDX_SCRIPT05 ]) ) );
}
close( FILEOUT );
