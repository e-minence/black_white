...
//======================================================================
//======================================================================
#define ID_START_SCR_OFFSET                (1) //マップ個別スクリプト
...
#define ID_WIFI_COUNTER_SCR_OFFSET       (10105) //WI-FI受付用スクリプト
#define ID_WIFI_COUNTER_SCR_OFFSET_END   (10109)
...
#define ID_CROWD_PEOPLE_SCR_OFFSET_END   (10369)

#define ID_HYOUKA_SCR_OFFSET             (10370) //ずかん評価スクリプト
#define ID_HYOUKA_SCR_OFFSET_END         (10379)
