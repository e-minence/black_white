...
#define MUSICAL_VALUE_CHECK_HAVE_GOODS (15)    //指定グッズを持っているか？
...
//タイミングシンク用番号
//mus_comm_funcにもタイミング定義あるので注意
#define MUSICAL_COMM_SYNC_FIRST (10)
#define MUSICAL_COMM_SYNC_DRESSUP_START (11)
#define MUSICAL_COMM_SYNC_GRADE_START (12)

#define MUSICAL_COMM_SYNC_MSG11 (111)
#define MUSICAL_COMM_SYNC_MSG12 (112)
#define MUSICAL_COMM_SYNC_MSG13 (113)
#define MUSICAL_COMM_SYNC_MSG14 (114)
#define MUSICAL_COMM_SYNC_MSG15 (115)

#define MUSICAL_COMM_SYNC_MSG_OWNER1 (120) //個人評価の時１個ずつ増やす(+8
#define MUSICAL_COMM_SYNC_MSG21 (141)
