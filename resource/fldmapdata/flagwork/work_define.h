...
#define WK_OTHER_T05_TRAIN               16658 /* 0x4112 T05カナワタウン：転車台に配置される車両の状態を保存するワーク 00 レトロトレイン（専用） 01 シングルトレイン 02 ダブルトレイン 03 マルチトレイン 04 スーパーダブルトレイン 05 スーパーシングルトレイン 06 スーパーマルチトレイン 07 ＴＴトレイン 08 なし 09 Wi-Fiトレイン 10 最新車両（専用）※特別な日に出現 */
