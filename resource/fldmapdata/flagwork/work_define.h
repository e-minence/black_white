...
#define WK_SYS_N01R0502_ITEMUSE          16450 /* 0x4042 00 なし（Ｎ城謁見の間で&#xff5e;&#xff5e;ストーンを使うと01） 01 Ｎイベント起動（イベント後に02） 02 なし バッグ画面でライト/ダークストーンを使用する事でこのWKの値を01にし、シーンチェンジイベントを起動しています。イベント後、値を２にして終了します。 */
